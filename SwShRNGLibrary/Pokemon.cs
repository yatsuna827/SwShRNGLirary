...
namespace SwShRNGLibrary
{
    ...
    public class Pokemon
    {
        ...
        static Pokemon()
        {
            ...
            DexData.Add(new AnotherForm(3, -1, "フシギバナ", "キョダイ", new uint[] { 80, 82, 83, 100, 100, 80 }, (PokeType.Grass, PokeType.Poison), new string[] { "しんりょく", "しんりょく", "ようりょくそ" }, GenderRatio.M7F1));
            ...
            DexData.Add(new AnotherForm(9, -1, "カメックス", "キョダイ", new uint[] { 79, 83, 100, 85, 105, 78 }, (PokeType.Water, PokeType.Non), new string[] { "げきりゅう", "げきりゅう", "あめうけざら" }, GenderRatio.M7F1));
            ...
            DexData.Add(new AnotherForm(809, -1, "メルメタル", "キョダイ", new uint[] { 135, 143, 143, 80, 65, 34 }, (PokeType.Steel, PokeType.Non), new string[] { "てつのこぶし", "てつのこぶし", "てつのこぶし" }, GenderRatio.Genderless));
            ...
            DexData.Add(new AnotherForm(812, 3, "ゴリランダー", "キョダイ", new uint[] { 100, 125, 90, 60, 70, 85 }, (PokeType.Grass, PokeType.Non), new string[] { "しんりょく", "しんりょく", "グラスメイカー" }, GenderRatio.M7F1));
            ...
            DexData.Add(new AnotherForm(815, 6, "エースバーン", "キョダイ", new uint[] { 80, 116, 75, 65, 75, 119 }, (PokeType.Fire, PokeType.Non), new string[] { "もうか", "もうか", "リベロ" }, GenderRatio.M7F1));
            ...
            DexData.Add(new AnotherForm(818, 9, "インテレオン", "キョダイ", new uint[] { 70, 85, 65, 125, 65, 120 }, (PokeType.Water, PokeType.Non), new string[] { "げきりゅう", "げきりゅう", "スナイパー" }, GenderRatio.M7F1));
            ...
            DexData.Add(new Species(13, -1, "ビードル", "", new uint[] { 40, 35, 30, 20, 20, 50 }, (PokeType.Bug, PokeType.Poison), new string[] { "りんぷん", "りんぷん", "にげあし" }, GenderRatio.M1F1));
            DexData.Add(new Species(14, -1, "コクーン", "", new uint[] { 45, 25, 50, 25, 25, 35 }, (PokeType.Bug, PokeType.Poison), new string[] { "だっぴ", "だっぴ", "だっぴ" }, GenderRatio.M1F1));
            DexData.Add(new Species(15, -1, "スピアー", "", new uint[] { 65, 90, 40, 45, 80, 75 }, (PokeType.Bug, PokeType.Poison), new string[] { "むしのしらせ", "むしのしらせ", "スナイパー" }, GenderRatio.M1F1));
            DexData.Add(new Species(16, -1, "ポッポ", "", new uint[] { 40, 45, 40, 35, 35, 56 }, (PokeType.Normal, PokeType.Flying), new string[] { "するどいめ", "ちどりあし", "はとむね" }, GenderRatio.M1F1));
            DexData.Add(new Species(17, -1, "ピジョン", "", new uint[] { 63, 60, 55, 50, 50, 71 }, (PokeType.Normal, PokeType.Flying), new string[] { "するどいめ", "ちどりあし", "はとむね" }, GenderRatio.M1F1));
            DexData.Add(new Species(18, -1, "ピジョット", "", new uint[] { 83, 80, 75, 70, 70, 101 }, (PokeType.Normal, PokeType.Flying), new string[] { "するどいめ", "ちどりあし", "はとむね" }, GenderRatio.M1F1));
            DexData.Add(new Species(19, -1, "コラッタ", "", new uint[] { 30, 56, 35, 25, 35, 72 }, (PokeType.Normal, PokeType.Non), new string[] { "にげあし", "こんじょう", "はりきり" }, GenderRatio.M1F1));
            DexData.Add(new AnotherForm(19, -1, "コラッタ", "アローラ", new uint[] { 30, 56, 35, 25, 35, 72 }, (PokeType.Dark, PokeType.Normal), new string[] { "くいしんぼう", "はりきり", "あついしぼう" }, GenderRatio.M1F1));
            DexData.Add(new Species(20, -1, "ラッタ", "", new uint[] { 55, 81, 60, 50, 70, 97 }, (PokeType.Normal, PokeType.Non), new string[] { "にげあし", "こんじょう", "はりきり" }, GenderRatio.M1F1));
            DexData.Add(new AnotherForm(20, -1, "ラッタ", "アローラ", new uint[] { 75, 71, 70, 40, 80, 77 }, (PokeType.Dark, PokeType.Normal), new string[] { "くいしんぼう", "はりきり", "あついしぼう" }, GenderRatio.M1F1));
            DexData.Add(new Species(21, -1, "オニスズメ", "", new uint[] { 40, 60, 30, 31, 31, 70 }, (PokeType.Normal, PokeType.Flying), new string[] { "するどいめ", "するどいめ", "スナイパー" }, GenderRatio.M1F1));
            DexData.Add(new Species(22, -1, "オニドリル", "", new uint[] { 65, 90, 65, 61, 61, 100 }, (PokeType.Normal, PokeType.Flying), new string[] { "するどいめ", "するどいめ", "スナイパー" }, GenderRatio.M1F1));
            DexData.Add(new Species(23, -1, "アーボ", "", new uint[] { 35, 60, 44, 40, 54, 55 }, (PokeType.Poison, PokeType.Non), new string[] { "いかく", "だっぴ", "きんちょうかん" }, GenderRatio.M1F1));
            DexData.Add(new Species(24, -1, "アーボック", "", new uint[] { 60, 95, 69, 65, 79, 80 }, (PokeType.Poison, PokeType.Non), new string[] { "いかく", "だっぴ", "きんちょうかん" }, GenderRatio.M1F1));
            DexData.Add(new Species(27, -1, "サンド", "", new uint[] { 50, 75, 85, 20, 30, 40 }, (PokeType.Ground, PokeType.Non), new string[] { "すながくれ", "すながくれ", "すなかき" }, GenderRatio.M1F1));
            DexData.Add(new AnotherForm(27, -1, "サンド", "アローラ", new uint[] { 50, 75, 90, 10, 35, 40 }, (PokeType.Ice, PokeType.Steel), new string[] { "ゆきがくれ", "ゆきがくれ", "ゆきかき" }, GenderRatio.M1F1));
            DexData.Add(new Species(28, -1, "サンドパン", "", new uint[] { 75, 100, 110, 45, 55, 65 }, (PokeType.Ground, PokeType.Non), new string[] { "すながくれ", "すながくれ", "すなかき" }, GenderRatio.M1F1));
            DexData.Add(new AnotherForm(28, -1, "サンドパン", "アローラ", new uint[] { 75, 100, 120, 25, 65, 65 }, (PokeType.Ice, PokeType.Steel), new string[] { "ゆきがくれ", "ゆきがくれ", "ゆきかき" }, GenderRatio.M1F1));
            DexData.Add(new Species(29, -1, "ニドラン♀", "", new uint[] { 55, 47, 52, 40, 40, 41 }, (PokeType.Poison, PokeType.Non), new string[] { "どくのトゲ", "とうそうしん", "はりきり" }, GenderRatio.FemaleOnly));
            DexData.Add(new Species(30, -1, "ニドリーナ", "", new uint[] { 70, 62, 67, 55, 55, 56 }, (PokeType.Poison, PokeType.Non), new string[] { "どくのトゲ", "とうそうしん", "はりきり" }, GenderRatio.FemaleOnly));
            DexData.Add(new Species(31, -1, "ニドクイン", "", new uint[] { 90, 92, 87, 75, 85, 76 }, (PokeType.Poison, PokeType.Ground), new string[] { "どくのトゲ", "とうそうしん", "ちからずく" }, GenderRatio.FemaleOnly));
            DexData.Add(new Species(32, -1, "ニドラン♂", "", new uint[] { 46, 57, 40, 40, 40, 50 }, (PokeType.Poison, PokeType.Non), new string[] { "どくのトゲ", "とうそうしん", "はりきり" }, GenderRatio.MaleOnly));
            DexData.Add(new Species(33, -1, "ニドリーノ", "", new uint[] { 61, 72, 57, 55, 55, 65 }, (PokeType.Poison, PokeType.Non), new string[] { "どくのトゲ", "とうそうしん", "はりきり" }, GenderRatio.MaleOnly));
            DexData.Add(new Species(34, -1, "ニドキング", "", new uint[] { 81, 102, 77, 85, 75, 85 }, (PokeType.Poison, PokeType.Ground), new string[] { "どくのトゲ", "とうそうしん", "ちからずく" }, GenderRatio.MaleOnly));
            DexData.Add(new Species(39, -1, "プリン", "", new uint[] { 115, 45, 20, 45, 25, 20 }, (PokeType.Normal, PokeType.Fairy), new string[] { "メロメロボディ", "かちき", "フレンドガード" }, GenderRatio.M1F3));
            DexData.Add(new Species(40, -1, "プクリン", "", new uint[] { 140, 70, 45, 85, 50, 45 }, (PokeType.Normal, PokeType.Fairy), new string[] { "メロメロボディ", "かちき", "おみとおし" }, GenderRatio.M1F3));
            DexData.Add(new Species(41, -1, "ズバット", "", new uint[] { 40, 45, 35, 30, 40, 55 }, (PokeType.Poison, PokeType.Flying), new string[] { "せいしんりょく", "せいしんりょく", "すりぬけ" }, GenderRatio.M1F1));
            DexData.Add(new Species(42, -1, "ゴルバット", "", new uint[] { 75, 80, 70, 65, 75, 90 }, (PokeType.Poison, PokeType.Flying), new string[] { "せいしんりょく", "せいしんりょく", "すりぬけ" }, GenderRatio.M1F1));
            DexData.Add(new Species(46, -1, "パラス", "", new uint[] { 35, 70, 55, 45, 55, 25 }, (PokeType.Bug, PokeType.Grass), new string[] { "ほうし", "かんそうはだ", "しめりけ" }, GenderRatio.M1F1));
            DexData.Add(new Species(47, -1, "パラセクト", "", new uint[] { 60, 95, 80, 60, 80, 30 }, (PokeType.Bug, PokeType.Grass), new string[] { "ほうし", "かんそうはだ", "しめりけ" }, GenderRatio.M1F1));
            DexData.Add(new Species(48, -1, "コンパン", "", new uint[] { 60, 55, 50, 40, 55, 45 }, (PokeType.Bug, PokeType.Poison), new string[] { "ふくがん", "いろめがね", "にげあし" }, GenderRatio.M1F1));
            DexData.Add(new Species(49, -1, "モルフォン", "", new uint[] { 70, 65, 60, 90, 75, 90 }, (PokeType.Bug, PokeType.Poison), new string[] { "りんぷん", "いろめがね", "ミラクルスキン" }, GenderRatio.M1F1));
            DexData.Add(new Species(54, -1, "コダック", "", new uint[] { 50, 52, 48, 65, 50, 55 }, (PokeType.Water, PokeType.Non), new string[] { "しめりけ", "ノーてんき", "すいすい" }, GenderRatio.M1F1));
            DexData.Add(new Species(55, -1, "ゴルダック", "", new uint[] { 80, 82, 78, 95, 80, 85 }, (PokeType.Water, PokeType.Non), new string[] { "しめりけ", "ノーてんき", "すいすい" }, GenderRatio.M1F1));
            DexData.Add(new Species(56, -1, "マンキー", "", new uint[] { 40, 80, 35, 35, 45, 70 }, (PokeType.Fighting, PokeType.Non), new string[] { "やるき", "いかりのつぼ", "まけんき" }, GenderRatio.M1F1));
            DexData.Add(new Species(57, -1, "オコリザル", "", new uint[] { 65, 105, 60, 60, 70, 95 }, (PokeType.Fighting, PokeType.Non), new string[] { "やるき", "いかりのつぼ", "まけんき" }, GenderRatio.M1F1));
            DexData.Add(new Species(60, -1, "ニョロモ", "", new uint[] { 40, 50, 40, 40, 40, 90 }, (PokeType.Water, PokeType.Non), new string[] { "ちょすい", "しめりけ", "すいすい" }, GenderRatio.M1F1));
            DexData.Add(new Species(61, -1, "ニョロゾ", "", new uint[] { 65, 65, 65, 50, 50, 90 }, (PokeType.Water, PokeType.Non), new string[] { "ちょすい", "しめりけ", "すいすい" }, GenderRatio.M1F1));
            DexData.Add(new Species(62, -1, "ニョロボン", "", new uint[] { 90, 95, 95, 70, 90, 70 }, (PokeType.Water, PokeType.Fighting), new string[] { "ちょすい", "しめりけ", "すいすい" }, GenderRatio.M1F1));
            DexData.Add(new Species(63, -1, "ケーシィ", "", new uint[] { 25, 20, 15, 105, 55, 90 }, (PokeType.Psychic, PokeType.Non), new string[] { "シンクロ", "せいしんりょく", "マジックガード" }, GenderRatio.M1F1));
            DexData.Add(new Species(64, -1, "ユンゲラー", "", new uint[] { 40, 35, 30, 120, 70, 105 }, (PokeType.Psychic, PokeType.Non), new string[] { "シンクロ", "せいしんりょく", "マジックガード" }, GenderRatio.M1F1));
            DexData.Add(new Species(65, -1, "フーディン", "", new uint[] { 55, 50, 45, 135, 95, 120 }, (PokeType.Psychic, PokeType.Non), new string[] { "シンクロ", "せいしんりょく", "マジックガード" }, GenderRatio.M1F1));
            DexData.Add(new Species(69, -1, "マダツボミ", "", new uint[] { 50, 75, 35, 70, 30, 40 }, (PokeType.Grass, PokeType.Poison), new string[] { "ようりょくそ", "ようりょくそ", "くいしんぼう" }, GenderRatio.M1F1));
            DexData.Add(new Species(70, -1, "ウツドン", "", new uint[] { 65, 90, 50, 85, 45, 55 }, (PokeType.Grass, PokeType.Poison), new string[] { "ようりょくそ", "ようりょくそ", "くいしんぼう" }, GenderRatio.M1F1));
            DexData.Add(new Species(71, -1, "ウツボット", "", new uint[] { 80, 105, 65, 100, 70, 70 }, (PokeType.Grass, PokeType.Poison), new string[] { "ようりょくそ", "ようりょくそ", "くいしんぼう" }, GenderRatio.M1F1));
            DexData.Add(new Species(72, -1, "メノクラゲ", "", new uint[] { 40, 40, 35, 50, 100, 70 }, (PokeType.Water, PokeType.Poison), new string[] { "クリアボディ", "ヘドロえき", "あめうけざら" }, GenderRatio.M1F1));
            DexData.Add(new Species(73, -1, "ドククラゲ", "", new uint[] { 80, 70, 65, 80, 120, 100 }, (PokeType.Water, PokeType.Poison), new string[] { "クリアボディ", "ヘドロえき", "あめうけざら" }, GenderRatio.M1F1));
            DexData.Add(new Species(74, -1, "イシツブテ", "", new uint[] { 40, 80, 100, 30, 30, 20 }, (PokeType.Rock, PokeType.Ground), new string[] { "いしあたま", "がんじょう", "すながくれ" }, GenderRatio.M1F1));
            DexData.Add(new AnotherForm(74, -1, "イシツブテ", "アローラ", new uint[] { 40, 80, 100, 30, 30, 20 }, (PokeType.Rock, PokeType.Electric), new string[] { "じりょく", "がんじょう", "エレキスキン" }, GenderRatio.M1F1));
            DexData.Add(new Species(75, -1, "ゴローン", "", new uint[] { 55, 95, 115, 45, 45, 35 }, (PokeType.Rock, PokeType.Ground), new string[] { "いしあたま", "がんじょう", "すながくれ" }, GenderRatio.M1F1));
            DexData.Add(new AnotherForm(75, -1, "ゴローン", "アローラ", new uint[] { 55, 95, 115, 45, 45, 35 }, (PokeType.Rock, PokeType.Electric), new string[] { "じりょく", "がんじょう", "エレキスキン" }, GenderRatio.M1F1));
            DexData.Add(new Species(76, -1, "ゴローニャ", "", new uint[] { 80, 120, 130, 55, 65, 45 }, (PokeType.Rock, PokeType.Ground), new string[] { "いしあたま", "がんじょう", "すながくれ" }, GenderRatio.M1F1));
            DexData.Add(new AnotherForm(76, -1, "ゴローニャ", "アローラ", new uint[] { 80, 120, 130, 55, 65, 45 }, (PokeType.Rock, PokeType.Electric), new string[] { "じりょく", "がんじょう", "エレキスキン" }, GenderRatio.M1F1));
            DexData.Add(new Species(79, -1, "ヤドン", "", new uint[] { 90, 65, 65, 40, 40, 15 }, (PokeType.Water, PokeType.Psychic), new string[] { "どんかん", "マイペース", "さいせいりょく" }, GenderRatio.M1F1));
            DexData.Add(new AnotherForm(79, -1, "ヤドン", "ガラル", new uint[] { 90, 65, 65, 40, 40, 15 }, (PokeType.Psychic, PokeType.Non), new string[] { "くいしんぼう", "マイペース", "さいせいりょく" }, GenderRatio.M1F1));
            DexData.Add(new Species(80, -1, "ヤドラン", "", new uint[] { 95, 75, 110, 100, 80, 30 }, (PokeType.Water, PokeType.Psychic), new string[] { "どんかん", "マイペース", "さいせいりょく" }, GenderRatio.M1F1));
            DexData.Add(new AnotherForm(80, -1, "ヤドラン", "ガラル", new uint[] { 95, 100, 95, 100, 70, 30 }, (PokeType.Poison, PokeType.Psychic), new string[] { "クイックドロウ", "マイペース", "さいせいりょく" }, GenderRatio.M1F1));
            DexData.Add(new Species(81, -1, "コイル", "", new uint[] { 25, 35, 70, 95, 55, 45 }, (PokeType.Electric, PokeType.Steel), new string[] { "じりょく", "がんじょう", "アナライズ" }, GenderRatio.Genderless));
            DexData.Add(new Species(82, -1, "レアコイル", "", new uint[] { 50, 60, 95, 120, 70, 70 }, (PokeType.Electric, PokeType.Steel), new string[] { "じりょく", "がんじょう", "アナライズ" }, GenderRatio.Genderless));
            DexData.Add(new Species(84, -1, "ドードー", "", new uint[] { 35, 85, 45, 35, 35, 75 }, (PokeType.Normal, PokeType.Flying), new string[] { "にげあし", "はやおき", "ちどりあし" }, GenderRatio.M1F1));
            DexData.Add(new Species(85, -1, "ドードリオ", "", new uint[] { 60, 110, 70, 60, 60, 110 }, (PokeType.Normal, PokeType.Flying), new string[] { "にげあし", "はやおき", "ちどりあし" }, GenderRatio.M1F1));
            DexData.Add(new Species(86, -1, "パウワウ", "", new uint[] { 65, 45, 55, 45, 70, 45 }, (PokeType.Water, PokeType.Non), new string[] { "あついしぼう", "うるおいボディ", "アイスボディ" }, GenderRatio.M1F1));
            DexData.Add(new Species(87, -1, "ジュゴン", "", new uint[] { 90, 70, 80, 70, 95, 70 }, (PokeType.Water, PokeType.Ice), new string[] { "あついしぼう", "うるおいボディ", "アイスボディ" }, GenderRatio.M1F1));
            DexData.Add(new Species(88, -1, "ベトベター", "", new uint[] { 80, 80, 50, 40, 50, 25 }, (PokeType.Poison, PokeType.Non), new string[] { "あくしゅう", "ねんちゃく", "どくしゅ" }, GenderRatio.M1F1));
            DexData.Add(new AnotherForm(88, -1, "ベトベター", "アローラ", new uint[] { 80, 80, 50, 40, 50, 25 }, (PokeType.Poison, PokeType.Dark), new string[] { "どくしゅ", "くいしんぼう", "かがくのちから" }, GenderRatio.M1F1));
            DexData.Add(new Species(89, -1, "ベトベトン", "", new uint[] { 105, 105, 75, 65, 100, 50 }, (PokeType.Poison, PokeType.Non), new string[] { "あくしゅう", "ねんちゃく", "どくしゅ" }, GenderRatio.M1F1));
            DexData.Add(new AnotherForm(89, -1, "ベトベトン", "アローラ", new uint[] { 105, 105, 75, 65, 100, 50 }, (PokeType.Poison, PokeType.Dark), new string[] { "どくしゅ", "くいしんぼう", "かがくのちから" }, GenderRatio.M1F1));
            DexData.Add(new Species(96, -1, "スリープ", "", new uint[] { 60, 48, 45, 43, 90, 42 }, (PokeType.Psychic, PokeType.Non), new string[] { "ふみん", "よちむ", "せいしんりょく" }, GenderRatio.M1F1));
            DexData.Add(new Species(97, -1, "スリーパー", "", new uint[] { 85, 73, 70, 73, 115, 67 }, (PokeType.Psychic, PokeType.Non), new string[] { "ふみん", "よちむ", "せいしんりょく" }, GenderRatio.M1F1));
            DexData.Add(new Species(100, -1, "ビリリダマ", "", new uint[] { 40, 30, 50, 55, 55, 100 }, (PokeType.Electric, PokeType.Non), new string[] { "ぼうおん", "せいでんき", "ゆうばく" }, GenderRatio.Genderless));
            DexData.Add(new Species(101, -1, "マルマイン", "", new uint[] { 60, 50, 70, 80, 80, 150 }, (PokeType.Electric, PokeType.Non), new string[] { "ぼうおん", "せいでんき", "ゆうばく" }, GenderRatio.Genderless));
            DexData.Add(new Species(102, -1, "タマタマ", "", new uint[] { 60, 40, 80, 60, 45, 40 }, (PokeType.Grass, PokeType.Psychic), new string[] { "ようりょくそ", "ようりょくそ", "しゅうかく" }, GenderRatio.M1F1));
            DexData.Add(new Species(103, -1, "ナッシー", "", new uint[] { 95, 95, 85, 125, 75, 55 }, (PokeType.Grass, PokeType.Psychic), new string[] { "ようりょくそ", "ようりょくそ", "しゅうかく" }, GenderRatio.M1F1));
            DexData.Add(new AnotherForm(103, -1, "ナッシー", "アローラ", new uint[] { 95, 105, 85, 125, 75, 45 }, (PokeType.Grass, PokeType.Dragon), new string[] { "おみとおし", "おみとおし", "しゅうかく" }, GenderRatio.M1F1));
            DexData.Add(new Species(104, -1, "カラカラ", "", new uint[] { 50, 50, 95, 40, 50, 35 }, (PokeType.Ground, PokeType.Non), new string[] { "いしあたま", "ひらいしん", "カブトアーマー" }, GenderRatio.M1F1));
            DexData.Add(new Species(105, -1, "ガラガラ", "", new uint[] { 60, 80, 110, 50, 80, 45 }, (PokeType.Ground, PokeType.Non), new string[] { "いしあたま", "ひらいしん", "カブトアーマー" }, GenderRatio.M1F1));
            DexData.Add(new AnotherForm(105, -1, "ガラガラ", "アローラ", new uint[] { 60, 80, 110, 50, 80, 45 }, (PokeType.Fire, PokeType.Ghost), new string[] { "のろわれボディ", "ひらいしん", "いしあたま" }, GenderRatio.M1F1));
            DexData.Add(new Species(108, -1, "ベロリンガ", "", new uint[] { 90, 55, 75, 60, 75, 30 }, (PokeType.Normal, PokeType.Non), new string[] { "マイペース", "どんかん", "ノーてんき" }, GenderRatio.M1F1));
            DexData.Add(new Species(113, -1, "ラッキー", "", new uint[] { 250, 5, 5, 35, 105, 50 }, (PokeType.Normal, PokeType.Non), new string[] { "しぜんかいふく", "てんのめぐみ", "いやしのこころ" }, GenderRatio.FemaleOnly));
            DexData.Add(new Species(114, -1, "モンジャラ", "", new uint[] { 65, 55, 115, 100, 40, 60 }, (PokeType.Grass, PokeType.Non), new string[] { "ようりょくそ", "リーフガード", "さいせいりょく" }, GenderRatio.M1F1));
            DexData.Add(new Species(115, -1, "ガルーラ", "", new uint[] { 105, 95, 80, 40, 80, 90 }, (PokeType.Normal, PokeType.Non), new string[] { "はやおき", "きもったま", "せいしんりょく" }, GenderRatio.FemaleOnly));
            DexData.Add(new Species(116, -1, "タッツー", "", new uint[] { 30, 40, 70, 70, 25, 60 }, (PokeType.Water, PokeType.Non), new string[] { "すいすい", "スナイパー", "しめりけ" }, GenderRatio.M1F1));
            DexData.Add(new Species(117, -1, "シードラ", "", new uint[] { 55, 65, 95, 95, 45, 85 }, (PokeType.Water, PokeType.Non), new string[] { "どくのトゲ", "スナイパー", "しめりけ" }, GenderRatio.M1F1));
            DexData.Add(new Species(120, -1, "ヒトデマン", "", new uint[] { 30, 45, 55, 70, 55, 85 }, (PokeType.Water, PokeType.Non), new string[] { "はっこう", "しぜんかいふく", "アナライズ" }, GenderRatio.Genderless));
            DexData.Add(new Species(121, -1, "スターミー", "", new uint[] { 60, 75, 85, 100, 85, 115 }, (PokeType.Water, PokeType.Psychic), new string[] { "はっこう", "しぜんかいふく", "アナライズ" }, GenderRatio.Genderless));
            DexData.Add(new Species(123, -1, "ストライク", "", new uint[] { 70, 110, 80, 55, 80, 105 }, (PokeType.Bug, PokeType.Flying), new string[] { "むしのしらせ", "テクニシャン", "ふくつのこころ" }, GenderRatio.M1F1));
            DexData.Add(new Species(124, -1, "ルージュラ", "", new uint[] { 65, 50, 35, 115, 95, 95 }, (PokeType.Ice, PokeType.Psychic), new string[] { "どんかん", "よちむ", "かんそうはだ" }, GenderRatio.FemaleOnly));
            DexData.Add(new Species(125, -1, "エレブー", "", new uint[] { 65, 83, 57, 95, 85, 105 }, (PokeType.Electric, PokeType.Non), new string[] { "せいでんき", "せいでんき", "やるき" }, GenderRatio.M3F1));
            DexData.Add(new Species(126, -1, "ブーバー", "", new uint[] { 65, 95, 57, 100, 85, 93 }, (PokeType.Fire, PokeType.Non), new string[] { "ほのおのからだ", "ほのおのからだ", "やるき" }, GenderRatio.M3F1));
            DexData.Add(new Species(127, -1, "カイロス", "", new uint[] { 65, 125, 100, 55, 70, 85 }, (PokeType.Bug, PokeType.Non), new string[] { "かいりきバサミ", "かたやぶり", "じしんかじょう" }, GenderRatio.M1F1));
            DexData.Add(new Species(128, -1, "ケンタロス", "", new uint[] { 75, 100, 95, 40, 70, 110 }, (PokeType.Normal, PokeType.Non), new string[] { "いかく", "いかりのつぼ", "ちからずく" }, GenderRatio.MaleOnly));
            DexData.Add(new Species(137, -1, "ポリゴン", "", new uint[] { 65, 60, 70, 85, 75, 40 }, (PokeType.Normal, PokeType.Non), new string[] { "トレース", "ダウンロード", "アナライズ" }, GenderRatio.Genderless));
            DexData.Add(new Species(138, -1, "オムナイト", "", new uint[] { 35, 40, 100, 90, 55, 35 }, (PokeType.Rock, PokeType.Water), new string[] { "すいすい", "シェルアーマー", "くだけるよろい" }, GenderRatio.M7F1));
            DexData.Add(new Species(139, -1, "オムスター", "", new uint[] { 70, 60, 125, 115, 70, 55 }, (PokeType.Rock, PokeType.Water), new string[] { "すいすい", "シェルアーマー", "くだけるよろい" }, GenderRatio.M7F1));
            DexData.Add(new Species(140, -1, "カブト", "", new uint[] { 30, 80, 90, 55, 45, 55 }, (PokeType.Rock, PokeType.Water), new string[] { "すいすい", "カブトアーマー", "くだけるよろい" }, GenderRatio.M7F1));
            DexData.Add(new Species(141, -1, "カブトプス", "", new uint[] { 60, 115, 105, 65, 70, 80 }, (PokeType.Rock, PokeType.Water), new string[] { "すいすい", "カブトアーマー", "くだけるよろい" }, GenderRatio.M7F1));
            DexData.Add(new Species(142, -1, "プテラ", "", new uint[] { 80, 105, 65, 60, 75, 130 }, (PokeType.Rock, PokeType.Flying), new string[] { "いしあたま", "プレッシャー", "きんちょうかん" }, GenderRatio.M7F1));
            DexData.Add(new Species(144, -1, "フリーザー", "", new uint[] { 90, 85, 100, 95, 125, 85 }, (PokeType.Ice, PokeType.Flying), new string[] { "プレッシャー", "プレッシャー", "ゆきがくれ" }, GenderRatio.Genderless));
            // DexData.Add(new AnotherForm(144, -1, "フリーザー", "ガラル", new uint[] { 90, 85, 100, 95, 125, 85 }, (PokeType.Psychic, PokeType.Flying), new string[] { "かちき", "かちき", "ゆきがくれ" }, GenderRatio.Genderless));
            DexData.Add(new Species(145, -1, "サンダー", "", new uint[] { 90, 90, 85, 125, 90, 100 }, (PokeType.Electric, PokeType.Flying), new string[] { "プレッシャー", "プレッシャー", "せいでんき" }, GenderRatio.Genderless));
            // DexData.Add(new AnotherForm(145, -1, "サンダー", "ガラル", new uint[] { 90, 90, 85, 125, 90, 100 }, (PokeType.Fighting, PokeType.Flying), new string[] { "まけんき", "まけんき", "せいでんき" }, GenderRatio.Genderless));
            DexData.Add(new Species(146, -1, "ファイヤー", "", new uint[] { 90, 100, 90, 125, 85, 90 }, (PokeType.Fire, PokeType.Flying), new string[] { "プレッシャー", "プレッシャー", "ほのおのからだ" }, GenderRatio.Genderless));
            // DexData.Add(new AnotherForm(146, -1, "ファイヤー", "ガラル", new uint[] { 90, 100, 90, 125, 85, 90 }, (PokeType.Dark, PokeType.Flying), new string[] { "ぎゃくじょう", "ぎゃくじょう", "ほのおのからだ" }, GenderRatio.Genderless));
            DexData.Add(new Species(147, -1, "ミニリュウ", "", new uint[] { 41, 64, 45, 50, 50, 50 }, (PokeType.Dragon, PokeType.Non), new string[] { "だっぴ", "だっぴ", "ふしぎなうろこ" }, GenderRatio.M1F1));
            DexData.Add(new Species(148, -1, "ハクリュー", "", new uint[] { 61, 84, 65, 70, 70, 70 }, (PokeType.Dragon, PokeType.Non), new string[] { "だっぴ", "だっぴ", "ふしぎなうろこ" }, GenderRatio.M1F1));
            DexData.Add(new Species(149, -1, "カイリュー", "", new uint[] { 91, 134, 95, 100, 100, 80 }, (PokeType.Dragon, PokeType.Flying), new string[] { "せいしんりょく", "せいしんりょく", "マルチスケイル" }, GenderRatio.M1F1));
            DexData.Add(new Species(152, -1, "チコリータ", "", new uint[] { 45, 49, 65, 49, 65, 45 }, (PokeType.Grass, PokeType.Non), new string[] { "しんりょく", "しんりょく", "リーフガード" }, GenderRatio.M7F1));
            DexData.Add(new Species(153, -1, "ベイリーフ", "", new uint[] { 60, 62, 80, 63, 80, 60 }, (PokeType.Grass, PokeType.Non), new string[] { "しんりょく", "しんりょく", "リーフガード" }, GenderRatio.M7F1));
            DexData.Add(new Species(154, -1, "メガニウム", "", new uint[] { 80, 82, 100, 83, 100, 80 }, (PokeType.Grass, PokeType.Non), new string[] { "しんりょく", "しんりょく", "リーフガード" }, GenderRatio.M7F1));
            DexData.Add(new Species(155, -1, "ヒノアラシ", "", new uint[] { 39, 52, 43, 60, 50, 65 }, (PokeType.Fire, PokeType.Non), new string[] { "もうか", "もうか", "もらいび" }, GenderRatio.M7F1));
            DexData.Add(new Species(156, -1, "マグマラシ", "", new uint[] { 58, 64, 58, 80, 65, 80 }, (PokeType.Fire, PokeType.Non), new string[] { "もうか", "もうか", "もらいび" }, GenderRatio.M7F1));
            DexData.Add(new Species(157, -1, "バクフーン", "", new uint[] { 78, 84, 78, 109, 85, 100 }, (PokeType.Fire, PokeType.Non), new string[] { "もうか", "もうか", "もらいび" }, GenderRatio.M7F1));
            DexData.Add(new Species(158, -1, "ワニノコ", "", new uint[] { 50, 65, 64, 44, 48, 43 }, (PokeType.Water, PokeType.Non), new string[] { "げきりゅう", "げきりゅう", "ちからずく" }, GenderRatio.M7F1));
            DexData.Add(new Species(159, -1, "アリゲイツ", "", new uint[] { 65, 80, 80, 59, 63, 58 }, (PokeType.Water, PokeType.Non), new string[] { "げきりゅう", "げきりゅう", "ちからずく" }, GenderRatio.M7F1));
            DexData.Add(new Species(160, -1, "オーダイル", "", new uint[] { 85, 105, 100, 79, 83, 78 }, (PokeType.Water, PokeType.Non), new string[] { "げきりゅう", "げきりゅう", "ちからずく" }, GenderRatio.M7F1));
            DexData.Add(new Species(161, -1, "オタチ", "", new uint[] { 35, 46, 34, 35, 45, 20 }, (PokeType.Normal, PokeType.Non), new string[] { "にげあし", "するどいめ", "おみとおし" }, GenderRatio.M1F1));
            DexData.Add(new Species(162, -1, "オオタチ", "", new uint[] { 85, 76, 64, 45, 55, 90 }, (PokeType.Normal, PokeType.Non), new string[] { "にげあし", "するどいめ", "おみとおし" }, GenderRatio.M1F1));
            DexData.Add(new Species(165, -1, "レディバ", "", new uint[] { 40, 20, 30, 40, 80, 55 }, (PokeType.Bug, PokeType.Flying), new string[] { "むしのしらせ", "はやおき", "びびり" }, GenderRatio.M1F1));
            DexData.Add(new Species(166, -1, "レディアン", "", new uint[] { 55, 35, 50, 55, 110, 85 }, (PokeType.Bug, PokeType.Flying), new string[] { "むしのしらせ", "はやおき", "てつのこぶし" }, GenderRatio.M1F1));
            DexData.Add(new Species(167, -1, "イトマル", "", new uint[] { 40, 60, 40, 40, 40, 30 }, (PokeType.Bug, PokeType.Poison), new string[] { "むしのしらせ", "ふみん", "スナイパー" }, GenderRatio.M1F1));
            DexData.Add(new Species(168, -1, "アリアドス", "", new uint[] { 70, 90, 70, 60, 70, 40 }, (PokeType.Bug, PokeType.Poison), new string[] { "むしのしらせ", "ふみん", "スナイパー" }, GenderRatio.M1F1));
            DexData.Add(new Species(169, -1, "クロバット", "", new uint[] { 85, 90, 80, 70, 80, 130 }, (PokeType.Poison, PokeType.Flying), new string[] { "せいしんりょく", "せいしんりょく", "すりぬけ" }, GenderRatio.M1F1));
            DexData.Add(new Species(174, -1, "ププリン", "", new uint[] { 90, 30, 15, 40, 20, 15 }, (PokeType.Normal, PokeType.Fairy), new string[] { "メロメロボディ", "かちき", "フレンドガード" }, GenderRatio.M1F3));
            DexData.Add(new Species(179, -1, "メリープ", "", new uint[] { 55, 40, 40, 65, 45, 35 }, (PokeType.Electric, PokeType.Non), new string[] { "せいでんき", "せいでんき", "プラス" }, GenderRatio.M1F1));
            DexData.Add(new Species(180, -1, "モココ", "", new uint[] { 70, 55, 55, 80, 60, 45 }, (PokeType.Electric, PokeType.Non), new string[] { "せいでんき", "せいでんき", "プラス" }, GenderRatio.M1F1));
            DexData.Add(new Species(181, -1, "デンリュウ", "", new uint[] { 90, 75, 85, 115, 90, 55 }, (PokeType.Electric, PokeType.Non), new string[] { "せいでんき", "せいでんき", "プラス" }, GenderRatio.M1F1));
            DexData.Add(new Species(183, -1, "マリル", "", new uint[] { 70, 20, 50, 20, 50, 40 }, (PokeType.Water, PokeType.Fairy), new string[] { "あついしぼう", "ちからもち", "そうしょく" }, GenderRatio.M1F1));
            DexData.Add(new Species(184, -1, "マリルリ", "", new uint[] { 100, 50, 80, 60, 80, 50 }, (PokeType.Water, PokeType.Fairy), new string[] { "あついしぼう", "ちからもち", "そうしょく" }, GenderRatio.M1F1));
            DexData.Add(new Species(186, -1, "ニョロトノ", "", new uint[] { 90, 75, 75, 90, 100, 70 }, (PokeType.Water, PokeType.Non), new string[] { "ちょすい", "しめりけ", "あめふらし" }, GenderRatio.M1F1));
            DexData.Add(new Species(187, -1, "ハネッコ", "", new uint[] { 35, 35, 40, 35, 55, 50 }, (PokeType.Grass, PokeType.Flying), new string[] { "ようりょくそ", "リーフガード", "すりぬけ" }, GenderRatio.M1F1));
            DexData.Add(new Species(188, -1, "ポポッコ", "", new uint[] { 55, 45, 50, 45, 65, 80 }, (PokeType.Grass, PokeType.Flying), new string[] { "ようりょくそ", "リーフガード", "すりぬけ" }, GenderRatio.M1F1));
            DexData.Add(new Species(189, -1, "ワタッコ", "", new uint[] { 75, 55, 70, 55, 95, 110 }, (PokeType.Grass, PokeType.Flying), new string[] { "ようりょくそ", "リーフガード", "すりぬけ" }, GenderRatio.M1F1));
            DexData.Add(new Species(190, -1, "エイパム", "", new uint[] { 55, 70, 55, 40, 55, 85 }, (PokeType.Normal, PokeType.Non), new string[] { "にげあし", "ものひろい", "スキルリンク" }, GenderRatio.M1F1));
            DexData.Add(new Species(191, -1, "ヒマナッツ", "", new uint[] { 30, 30, 30, 30, 30, 30 }, (PokeType.Grass, PokeType.Non), new string[] { "ようりょくそ", "サンパワー", "はやおき" }, GenderRatio.M1F1));
            DexData.Add(new Species(192, -1, "キマワリ", "", new uint[] { 75, 75, 55, 105, 85, 30 }, (PokeType.Grass, PokeType.Non), new string[] { "ようりょくそ", "サンパワー", "はやおき" }, GenderRatio.M1F1));
            DexData.Add(new Species(193, -1, "ヤンヤンマ", "", new uint[] { 65, 65, 45, 75, 45, 95 }, (PokeType.Bug, PokeType.Flying), new string[] { "かそく", "ふくがん", "おみとおし" }, GenderRatio.M1F1));
            DexData.Add(new Species(198, -1, "ヤミカラス", "", new uint[] { 60, 85, 42, 85, 42, 91 }, (PokeType.Dark, PokeType.Flying), new string[] { "ふみん", "きょううん", "いたずらごころ" }, GenderRatio.M1F1));
            DexData.Add(new Species(199, -1, "ヤドキング", "", new uint[] { 95, 75, 80, 100, 110, 30 }, (PokeType.Water, PokeType.Psychic), new string[] { "どんかん", "マイペース", "さいせいりょく" }, GenderRatio.M1F1));
            DexData.Add(new Species(200, -1, "ムウマ", "", new uint[] { 60, 60, 60, 85, 85, 85 }, (PokeType.Ghost, PokeType.Non), new string[] { "ふゆう", "ふゆう", "ふゆう" }, GenderRatio.M1F1));
            DexData.Add(new Species(201, -1, "アンノーン", "", new uint[] { 48, 72, 48, 72, 48, 48 }, (PokeType.Psychic, PokeType.Non), new string[] { "ふゆう", "ふゆう", "ふゆう" }, GenderRatio.Genderless));
            DexData.Add(new Species(203, -1, "キリンリキ", "", new uint[] { 70, 80, 65, 90, 65, 85 }, (PokeType.Normal, PokeType.Psychic), new string[] { "せいしんりょく", "はやおき", "そうしょく" }, GenderRatio.M1F1));
            DexData.Add(new Species(204, -1, "クヌギダマ", "", new uint[] { 50, 65, 90, 35, 35, 15 }, (PokeType.Bug, PokeType.Non), new string[] { "がんじょう", "がんじょう", "ぼうじん" }, GenderRatio.M1F1));
            DexData.Add(new Species(205, -1, "フォレトス", "", new uint[] { 75, 90, 140, 60, 60, 40 }, (PokeType.Bug, PokeType.Steel), new string[] { "がんじょう", "がんじょう", "ぼうじん" }, GenderRatio.M1F1));
            DexData.Add(new Species(206, -1, "ノコッチ", "", new uint[] { 100, 70, 70, 65, 65, 45 }, (PokeType.Normal, PokeType.Non), new string[] { "てんのめぐみ", "にげあし", "びびり" }, GenderRatio.M1F1));
            DexData.Add(new Species(207, -1, "グライガー", "", new uint[] { 65, 75, 105, 35, 65, 85 }, (PokeType.Ground, PokeType.Flying), new string[] { "かいりきバサミ", "すながくれ", "めんえき" }, GenderRatio.M1F1));
            DexData.Add(new Species(209, -1, "ブルー", "", new uint[] { 60, 80, 50, 40, 40, 30 }, (PokeType.Fairy, PokeType.Non), new string[] { "いかく", "にげあし", "びびり" }, GenderRatio.M1F1));
            DexData.Add(new Species(210, -1, "グランブル", "", new uint[] { 90, 120, 75, 60, 60, 45 }, (PokeType.Fairy, PokeType.Non), new string[] { "いかく", "にげあし", "びびり" }, GenderRatio.M1F1));
            DexData.Add(new Species(212, -1, "ハッサム", "", new uint[] { 70, 130, 100, 55, 80, 65 }, (PokeType.Bug, PokeType.Steel), new string[] { "むしのしらせ", "テクニシャン", "ライトメタル" }, GenderRatio.M1F1));
            DexData.Add(new Species(214, -1, "ヘラクロス", "", new uint[] { 80, 125, 75, 40, 95, 85 }, (PokeType.Bug, PokeType.Fighting), new string[] { "むしのしらせ", "こんじょう", "じしんかじょう" }, GenderRatio.M1F1));
            DexData.Add(new Species(216, -1, "ヒメグマ", "", new uint[] { 60, 80, 50, 50, 50, 40 }, (PokeType.Normal, PokeType.Non), new string[] { "ものひろい", "はやあし", "みつあつめ" }, GenderRatio.M1F1));
            DexData.Add(new Species(217, -1, "リングマ", "", new uint[] { 90, 130, 75, 75, 75, 55 }, (PokeType.Normal, PokeType.Non), new string[] { "こんじょう", "はやあし", "きんちょうかん" }, GenderRatio.M1F1));
            DexData.Add(new Species(218, -1, "マグマッグ", "", new uint[] { 40, 40, 40, 70, 40, 20 }, (PokeType.Fire, PokeType.Non), new string[] { "マグマのよろい", "ほのおのからだ", "くだけるよろい" }, GenderRatio.M1F1));
            DexData.Add(new Species(219, -1, "マグカルゴ", "", new uint[] { 60, 50, 120, 90, 80, 30 }, (PokeType.Fire, PokeType.Rock), new string[] { "マグマのよろい", "ほのおのからだ", "くだけるよろい" }, GenderRatio.M1F1));
            DexData.Add(new Species(227, -1, "エアームド", "", new uint[] { 65, 80, 140, 40, 70, 70 }, (PokeType.Steel, PokeType.Flying), new string[] { "するどいめ", "がんじょう", "くだけるよろい" }, GenderRatio.M1F1));
            DexData.Add(new Species(228, -1, "デルビル", "", new uint[] { 45, 60, 30, 80, 50, 65 }, (PokeType.Dark, PokeType.Fire), new string[] { "はやおき", "もらいび", "きんちょうかん" }, GenderRatio.M1F1));
            DexData.Add(new Species(229, -1, "ヘルガー", "", new uint[] { 75, 90, 50, 110, 80, 95 }, (PokeType.Dark, PokeType.Fire), new string[] { "はやおき", "もらいび", "きんちょうかん" }, GenderRatio.M1F1));
            DexData.Add(new Species(230, -1, "キングドラ", "", new uint[] { 75, 95, 95, 95, 95, 85 }, (PokeType.Water, PokeType.Dragon), new string[] { "すいすい", "スナイパー", "しめりけ" }, GenderRatio.M1F1));
            DexData.Add(new Species(231, -1, "ゴマゾウ", "", new uint[] { 90, 60, 60, 40, 40, 40 }, (PokeType.Ground, PokeType.Non), new string[] { "ものひろい", "ものひろい", "すながくれ" }, GenderRatio.M1F1));
            DexData.Add(new Species(232, -1, "ドンファン", "", new uint[] { 90, 120, 120, 60, 60, 50 }, (PokeType.Ground, PokeType.Non), new string[] { "ものひろい", "ものひろい", "すながくれ" }, GenderRatio.M1F1));
            DexData.Add(new Species(233, -1, "ポリゴン2", "", new uint[] { 85, 80, 90, 105, 95, 60 }, (PokeType.Normal, PokeType.Non), new string[] { "トレース", "ダウンロード", "アナライズ" }, GenderRatio.Genderless));
            DexData.Add(new Species(234, -1, "オドシシ", "", new uint[] { 73, 95, 62, 85, 65, 85 }, (PokeType.Normal, PokeType.Non), new string[] { "いかく", "おみとおし", "そうしょく" }, GenderRatio.M1F1));
            DexData.Add(new Species(235, -1, "ドーブル", "", new uint[] { 55, 20, 35, 20, 45, 75 }, (PokeType.Normal, PokeType.Non), new string[] { "マイペース", "テクニシャン", "ムラっけ" }, GenderRatio.M1F1));
            DexData.Add(new Species(238, -1, "ムチュール", "", new uint[] { 45, 30, 15, 85, 65, 65 }, (PokeType.Ice, PokeType.Psychic), new string[] { "どんかん", "よちむ", "うるおいボディ" }, GenderRatio.FemaleOnly));
            DexData.Add(new Species(239, -1, "エレキッド", "", new uint[] { 45, 63, 37, 65, 55, 95 }, (PokeType.Electric, PokeType.Non), new string[] { "せいでんき", "せいでんき", "やるき" }, GenderRatio.M3F1));
            DexData.Add(new Species(240, -1, "ブビィ", "", new uint[] { 45, 75, 37, 70, 55, 83 }, (PokeType.Fire, PokeType.Non), new string[] { "ほのおのからだ", "ほのおのからだ", "やるき" }, GenderRatio.M3F1));
            DexData.Add(new Species(241, -1, "ミルタンク", "", new uint[] { 95, 80, 105, 40, 70, 100 }, (PokeType.Normal, PokeType.Non), new string[] { "あついしぼう", "きもったま", "そうしょく" }, GenderRatio.FemaleOnly));
            DexData.Add(new Species(242, -1, "ハピナス", "", new uint[] { 255, 10, 10, 75, 135, 55 }, (PokeType.Normal, PokeType.Non), new string[] { "しぜんかいふく", "てんのめぐみ", "いやしのこころ" }, GenderRatio.FemaleOnly));
            DexData.Add(new Species(243, -1, "ライコウ", "", new uint[] { 90, 85, 75, 115, 100, 115 }, (PokeType.Electric, PokeType.Non), new string[] { "プレッシャー", "プレッシャー", "せいしんりょく" }, GenderRatio.Genderless));
            DexData.Add(new Species(244, -1, "エンテイ", "", new uint[] { 115, 115, 85, 90, 75, 100 }, (PokeType.Fire, PokeType.Non), new string[] { "プレッシャー", "プレッシャー", "せいしんりょく" }, GenderRatio.Genderless));
            DexData.Add(new Species(245, -1, "スイクン", "", new uint[] { 100, 75, 115, 90, 115, 85 }, (PokeType.Water, PokeType.Non), new string[] { "プレッシャー", "プレッシャー", "せいしんりょく" }, GenderRatio.Genderless));
            DexData.Add(new Species(249, -1, "ルギア", "", new uint[] { 106, 90, 130, 90, 154, 110 }, (PokeType.Psychic, PokeType.Flying), new string[] { "プレッシャー", "プレッシャー", "マルチスケイル" }, GenderRatio.Genderless));
            DexData.Add(new Species(250, -1, "ホウオウ", "", new uint[] { 106, 130, 90, 110, 154, 90 }, (PokeType.Fire, PokeType.Flying), new string[] { "プレッシャー", "プレッシャー", "さいせいりょく" }, GenderRatio.Genderless));
            DexData.Add(new Species(252, -1, "キモリ", "", new uint[] { 40, 45, 35, 65, 55, 70 }, (PokeType.Grass, PokeType.Non), new string[] { "しんりょく", "しんりょく", "かるわざ" }, GenderRatio.M7F1));
            DexData.Add(new Species(253, -1, "ジュプトル", "", new uint[] { 50, 65, 45, 85, 65, 95 }, (PokeType.Grass, PokeType.Non), new string[] { "しんりょく", "しんりょく", "かるわざ" }, GenderRatio.M7F1));
            DexData.Add(new Species(254, -1, "ジュカイン", "", new uint[] { 70, 85, 65, 105, 85, 120 }, (PokeType.Grass, PokeType.Non), new string[] { "しんりょく", "しんりょく", "かるわざ" }, GenderRatio.M7F1));
            DexData.Add(new Species(255, -1, "アチャモ", "", new uint[] { 45, 60, 40, 70, 50, 45 }, (PokeType.Fire, PokeType.Non), new string[] { "もうか", "もうか", "かそく" }, GenderRatio.M7F1));
            DexData.Add(new Species(256, -1, "ワカシャモ", "", new uint[] { 60, 85, 60, 85, 60, 55 }, (PokeType.Fire, PokeType.Fighting), new string[] { "もうか", "もうか", "かそく" }, GenderRatio.M7F1));
            DexData.Add(new Species(257, -1, "バシャーモ", "", new uint[] { 80, 120, 70, 110, 70, 80 }, (PokeType.Fire, PokeType.Fighting), new string[] { "もうか", "もうか", "かそく" }, GenderRatio.M7F1));
            DexData.Add(new Species(258, -1, "ミズゴロウ", "", new uint[] { 50, 70, 50, 50, 50, 40 }, (PokeType.Water, PokeType.Non), new string[] { "げきりゅう", "げきりゅう", "しめりけ" }, GenderRatio.M7F1));
            DexData.Add(new Species(259, -1, "ヌマクロー", "", new uint[] { 70, 85, 70, 60, 70, 50 }, (PokeType.Water, PokeType.Ground), new string[] { "げきりゅう", "げきりゅう", "しめりけ" }, GenderRatio.M7F1));
            DexData.Add(new Species(260, -1, "ラグラージ", "", new uint[] { 100, 110, 90, 85, 90, 60 }, (PokeType.Water, PokeType.Ground), new string[] { "げきりゅう", "げきりゅう", "しめりけ" }, GenderRatio.M7F1));
            DexData.Add(new Species(261, -1, "ポチエナ", "", new uint[] { 35, 55, 35, 30, 30, 35 }, (PokeType.Dark, PokeType.Non), new string[] { "にげあし", "はやあし", "びびり" }, GenderRatio.M1F1));
            DexData.Add(new Species(262, -1, "グラエナ", "", new uint[] { 70, 90, 70, 60, 60, 70 }, (PokeType.Dark, PokeType.Non), new string[] { "いかく", "はやあし", "じしんかじょう" }, GenderRatio.M1F1));
            DexData.Add(new Species(265, -1, "ケムッソ", "", new uint[] { 45, 45, 35, 20, 30, 20 }, (PokeType.Bug, PokeType.Non), new string[] { "りんぷん", "りんぷん", "にげあし" }, GenderRatio.M1F1));
            DexData.Add(new Species(266, -1, "カラサリス", "", new uint[] { 50, 35, 55, 25, 25, 15 }, (PokeType.Bug, PokeType.Non), new string[] { "だっぴ", "だっぴ", "だっぴ" }, GenderRatio.M1F1));
            DexData.Add(new Species(267, -1, "アゲハント", "", new uint[] { 60, 70, 50, 100, 50, 65 }, (PokeType.Bug, PokeType.Flying), new string[] { "むしのしらせ", "むしのしらせ", "とうそうしん" }, GenderRatio.M1F1));
            DexData.Add(new Species(268, -1, "マユルド", "", new uint[] { 50, 35, 55, 25, 25, 15 }, (PokeType.Bug, PokeType.Non), new string[] { "だっぴ", "だっぴ", "だっぴ" }, GenderRatio.M1F1));
            DexData.Add(new Species(269, -1, "ドクケイル", "", new uint[] { 60, 50, 70, 50, 90, 65 }, (PokeType.Bug, PokeType.Poison), new string[] { "りんぷん", "りんぷん", "ふくがん" }, GenderRatio.M1F1));
            DexData.Add(new Species(276, -1, "スバメ", "", new uint[] { 40, 55, 30, 30, 30, 85 }, (PokeType.Normal, PokeType.Flying), new string[] { "こんじょう", "こんじょう", "きもったま" }, GenderRatio.M1F1));
            DexData.Add(new Species(277, -1, "オオスバメ", "", new uint[] { 60, 85, 60, 75, 50, 125 }, (PokeType.Normal, PokeType.Flying), new string[] { "こんじょう", "こんじょう", "きもったま" }, GenderRatio.M1F1));
            DexData.Add(new Species(283, -1, "アメタマ", "", new uint[] { 40, 30, 32, 50, 52, 65 }, (PokeType.Bug, PokeType.Water), new string[] { "すいすい", "すいすい", "あめうけざら" }, GenderRatio.M1F1));
            DexData.Add(new Species(284, -1, "アメモース", "", new uint[] { 70, 60, 62, 100, 82, 80 }, (PokeType.Bug, PokeType.Flying), new string[] { "いかく", "いかく", "きんちょうかん" }, GenderRatio.M1F1));
            DexData.Add(new Species(285, -1, "キノココ", "", new uint[] { 60, 40, 60, 40, 60, 35 }, (PokeType.Grass, PokeType.Non), new string[] { "ほうし", "ポイズンヒール", "はやあし" }, GenderRatio.M1F1));
            DexData.Add(new Species(286, -1, "キノガッサ", "", new uint[] { 60, 130, 80, 60, 60, 70 }, (PokeType.Grass, PokeType.Fighting), new string[] { "ほうし", "ポイズンヒール", "テクニシャン" }, GenderRatio.M1F1));
            DexData.Add(new Species(287, -1, "ナマケロ", "", new uint[] { 60, 60, 60, 35, 35, 30 }, (PokeType.Normal, PokeType.Non), new string[] { "なまけ", "なまけ", "なまけ" }, GenderRatio.M1F1));
            DexData.Add(new Species(288, -1, "ヤルキモノ", "", new uint[] { 80, 80, 80, 55, 55, 90 }, (PokeType.Normal, PokeType.Non), new string[] { "やるき", "やるき", "やるき" }, GenderRatio.M1F1));
            DexData.Add(new Species(289, -1, "ケッキング", "", new uint[] { 150, 160, 100, 95, 65, 100 }, (PokeType.Normal, PokeType.Non), new string[] { "なまけ", "なまけ", "なまけ" }, GenderRatio.M1F1));
            DexData.Add(new Species(293, -1, "ゴニョニョ", "", new uint[] { 64, 51, 23, 51, 23, 28 }, (PokeType.Normal, PokeType.Non), new string[] { "ぼうおん", "ぼうおん", "びびり" }, GenderRatio.M1F1));
            DexData.Add(new Species(294, -1, "ドゴーム", "", new uint[] { 84, 71, 43, 71, 43, 48 }, (PokeType.Normal, PokeType.Non), new string[] { "ぼうおん", "ぼうおん", "きもったま" }, GenderRatio.M1F1));
            DexData.Add(new Species(295, -1, "バクオング", "", new uint[] { 104, 91, 63, 91, 73, 68 }, (PokeType.Normal, PokeType.Non), new string[] { "ぼうおん", "ぼうおん", "きもったま" }, GenderRatio.M1F1));
            DexData.Add(new Species(296, -1, "マクノシタ", "", new uint[] { 72, 60, 30, 20, 30, 25 }, (PokeType.Fighting, PokeType.Non), new string[] { "あついしぼう", "こんじょう", "ちからずく" }, GenderRatio.M3F1));
            DexData.Add(new Species(297, -1, "ハリテヤマ", "", new uint[] { 144, 120, 60, 40, 60, 50 }, (PokeType.Fighting, PokeType.Non), new string[] { "あついしぼう", "こんじょう", "ちからずく" }, GenderRatio.M3F1));
            DexData.Add(new Species(298, -1, "ルリリ", "", new uint[] { 50, 20, 40, 20, 40, 20 }, (PokeType.Normal, PokeType.Fairy), new string[] { "あついしぼう", "ちからもち", "そうしょく" }, GenderRatio.M1F3));
            DexData.Add(new Species(299, -1, "ノズパス", "", new uint[] { 30, 45, 135, 45, 90, 30 }, (PokeType.Rock, PokeType.Non), new string[] { "がんじょう", "じりょく", "すなのちから" }, GenderRatio.M1F1));
            DexData.Add(new Species(300, -1, "エネコ", "", new uint[] { 50, 45, 45, 35, 35, 50 }, (PokeType.Normal, PokeType.Non), new string[] { "メロメロボディ", "ノーマルスキン", "ミラクルスキン" }, GenderRatio.M1F3));
            DexData.Add(new Species(301, -1, "エネコロロ", "", new uint[] { 70, 65, 65, 55, 55, 90 }, (PokeType.Normal, PokeType.Non), new string[] { "メロメロボディ", "ノーマルスキン", "ミラクルスキン" }, GenderRatio.M1F3));
            DexData.Add(new Species(304, -1, "ココドラ", "", new uint[] { 50, 70, 100, 40, 40, 30 }, (PokeType.Steel, PokeType.Rock), new string[] { "がんじょう", "いしあたま", "ヘヴィメタル" }, GenderRatio.M1F1));
            DexData.Add(new Species(305, -1, "コドラ", "", new uint[] { 60, 90, 140, 50, 50, 40 }, (PokeType.Steel, PokeType.Rock), new string[] { "がんじょう", "いしあたま", "ヘヴィメタル" }, GenderRatio.M1F1));
            DexData.Add(new Species(306, -1, "ボスゴドラ", "", new uint[] { 70, 110, 180, 60, 60, 50 }, (PokeType.Steel, PokeType.Rock), new string[] { "がんじょう", "いしあたま", "ヘヴィメタル" }, GenderRatio.M1F1));
            DexData.Add(new Species(307, -1, "アサナン", "", new uint[] { 30, 40, 55, 40, 55, 60 }, (PokeType.Fighting, PokeType.Psychic), new string[] { "ヨガパワー", "ヨガパワー", "テレパシー" }, GenderRatio.M1F1));
            DexData.Add(new Species(308, -1, "チャーレム", "", new uint[] { 60, 60, 75, 60, 75, 80 }, (PokeType.Fighting, PokeType.Psychic), new string[] { "ヨガパワー", "ヨガパワー", "テレパシー" }, GenderRatio.M1F1));
            DexData.Add(new Species(311, -1, "プラスル", "", new uint[] { 60, 50, 40, 85, 75, 95 }, (PokeType.Electric, PokeType.Non), new string[] { "プラス", "プラス", "ひらいしん" }, GenderRatio.M1F1));
            DexData.Add(new Species(312, -1, "マイナン", "", new uint[] { 60, 40, 50, 75, 85, 95 }, (PokeType.Electric, PokeType.Non), new string[] { "マイナス", "マイナス", "ちくでん" }, GenderRatio.M1F1));
            DexData.Add(new Species(313, -1, "バルビート", "", new uint[] { 65, 73, 75, 47, 85, 85 }, (PokeType.Bug, PokeType.Non), new string[] { "はっこう", "むしのしらせ", "いたずらごころ" }, GenderRatio.MaleOnly));
            DexData.Add(new Species(314, -1, "イルミーゼ", "", new uint[] { 65, 47, 75, 73, 85, 85 }, (PokeType.Bug, PokeType.Non), new string[] { "どんかん", "いろめがね", "いたずらごころ" }, GenderRatio.FemaleOnly));
            DexData.Add(new Species(316, -1, "ゴクリン", "", new uint[] { 70, 43, 53, 43, 53, 40 }, (PokeType.Poison, PokeType.Non), new string[] { "ヘドロえき", "ねんちゃく", "くいしんぼう" }, GenderRatio.M1F1));
            DexData.Add(new Species(317, -1, "マルノーム", "", new uint[] { 100, 73, 83, 73, 83, 55 }, (PokeType.Poison, PokeType.Non), new string[] { "ヘドロえき", "ねんちゃく", "くいしんぼう" }, GenderRatio.M1F1));
            DexData.Add(new Species(318, -1, "キバニア", "", new uint[] { 45, 90, 20, 65, 20, 65 }, (PokeType.Water, PokeType.Dark), new string[] { "さめはだ", "さめはだ", "かそく" }, GenderRatio.M1F1));
            DexData.Add(new Species(319, -1, "サメハダー", "", new uint[] { 70, 120, 40, 95, 40, 95 }, (PokeType.Water, PokeType.Dark), new string[] { "さめはだ", "さめはだ", "かそく" }, GenderRatio.M1F1));
            DexData.Add(new Species(322, -1, "ドンメル", "", new uint[] { 60, 60, 40, 65, 45, 35 }, (PokeType.Fire, PokeType.Ground), new string[] { "どんかん", "たんじゅん", "マイペース" }, GenderRatio.M1F1));
            DexData.Add(new Species(323, -1, "バクーダ", "", new uint[] { 70, 100, 70, 105, 75, 40 }, (PokeType.Fire, PokeType.Ground), new string[] { "マグマのよろい", "ハードロック", "いかりのつぼ" }, GenderRatio.M1F1));
            DexData.Add(new Species(325, -1, "バネブー", "", new uint[] { 60, 25, 35, 70, 80, 60 }, (PokeType.Psychic, PokeType.Non), new string[] { "あついしぼう", "マイペース", "くいしんぼう" }, GenderRatio.M1F1));
            DexData.Add(new Species(326, -1, "ブーピッグ", "", new uint[] { 80, 45, 65, 90, 110, 80 }, (PokeType.Psychic, PokeType.Non), new string[] { "あついしぼう", "マイペース", "くいしんぼう" }, GenderRatio.M1F1));
            DexData.Add(new Species(327, -1, "パッチール", "", new uint[] { 60, 60, 60, 60, 60, 60 }, (PokeType.Normal, PokeType.Non), new string[] { "マイペース", "ちどりあし", "あまのじゃく" }, GenderRatio.M1F1));
            DexData.Add(new Species(331, -1, "サボネア", "", new uint[] { 50, 85, 40, 85, 40, 35 }, (PokeType.Grass, PokeType.Non), new string[] { "すながくれ", "すながくれ", "ちょすい" }, GenderRatio.M1F1));
            DexData.Add(new Species(332, -1, "ノクタス", "", new uint[] { 70, 115, 60, 115, 60, 55 }, (PokeType.Grass, PokeType.Dark), new string[] { "すながくれ", "すながくれ", "ちょすい" }, GenderRatio.M1F1));
            DexData.Add(new Species(333, -1, "チルット", "", new uint[] { 45, 40, 60, 40, 75, 50 }, (PokeType.Normal, PokeType.Flying), new string[] { "しぜんかいふく", "しぜんかいふく", "ノーてんき" }, GenderRatio.M1F1));
            DexData.Add(new Species(334, -1, "チルタリス", "", new uint[] { 75, 70, 90, 70, 105, 80 }, (PokeType.Dragon, PokeType.Flying), new string[] { "しぜんかいふく", "しぜんかいふく", "ノーてんき" }, GenderRatio.M1F1));
            DexData.Add(new Species(335, -1, "ザングース", "", new uint[] { 73, 115, 60, 60, 60, 90 }, (PokeType.Normal, PokeType.Non), new string[] { "めんえき", "めんえき", "どくぼうそう" }, GenderRatio.M1F1));
            DexData.Add(new Species(336, -1, "ハブネーク", "", new uint[] { 73, 100, 60, 100, 60, 65 }, (PokeType.Poison, PokeType.Non), new string[] { "だっぴ", "だっぴ", "すりぬけ" }, GenderRatio.M1F1));
            DexData.Add(new Species(345, -1, "リリーラ", "", new uint[] { 66, 41, 77, 61, 87, 23 }, (PokeType.Rock, PokeType.Grass), new string[] { "きゅうばん", "きゅうばん", "よびみず" }, GenderRatio.M7F1));
            DexData.Add(new Species(346, -1, "ユレイドル", "", new uint[] { 86, 81, 97, 81, 107, 43 }, (PokeType.Rock, PokeType.Grass), new string[] { "きゅうばん", "きゅうばん", "よびみず" }, GenderRatio.M7F1));
            DexData.Add(new Species(347, -1, "アノプス", "", new uint[] { 45, 95, 50, 40, 50, 75 }, (PokeType.Rock, PokeType.Bug), new string[] { "カブトアーマー", "カブトアーマー", "すいすい" }, GenderRatio.M7F1));
            DexData.Add(new Species(348, -1, "アーマルド", "", new uint[] { 75, 125, 100, 70, 80, 45 }, (PokeType.Rock, PokeType.Bug), new string[] { "カブトアーマー", "カブトアーマー", "すいすい" }, GenderRatio.M7F1));
            DexData.Add(new Species(351, -1, "ポワルン", "", new uint[] { 70, 70, 70, 70, 70, 70 }, (PokeType.Normal, PokeType.Non), new string[] { "てんきや", "てんきや", "てんきや" }, GenderRatio.M1F1));
            DexData.Add(new AnotherForm(351, -1, "ポワルン", "太陽", new uint[] { 70, 70, 70, 70, 70, 70 }, (PokeType.Fire, PokeType.Non), new string[] { "てんきや", "てんきや", "てんきや" }, GenderRatio.M1F1));
            DexData.Add(new AnotherForm(351, -1, "ポワルン", "雨水", new uint[] { 70, 70, 70, 70, 70, 70 }, (PokeType.Water, PokeType.Non), new string[] { "てんきや", "てんきや", "てんきや" }, GenderRatio.M1F1));
            DexData.Add(new AnotherForm(351, -1, "ポワルン", "雪雲", new uint[] { 70, 70, 70, 70, 70, 70 }, (PokeType.Ice, PokeType.Non), new string[] { "てんきや", "てんきや", "てんきや" }, GenderRatio.M1F1));
            DexData.Add(new Species(352, -1, "カクレオン", "", new uint[] { 60, 90, 70, 60, 120, 40 }, (PokeType.Normal, PokeType.Non), new string[] { "へんしょく", "へんしょく", "へんげんじざい" }, GenderRatio.M1F1));
            DexData.Add(new Species(353, -1, "カゲボウズ", "", new uint[] { 44, 75, 35, 63, 33, 45 }, (PokeType.Ghost, PokeType.Non), new string[] { "ふみん", "おみとおし", "のろわれボディ" }, GenderRatio.M1F1));
            DexData.Add(new Species(354, -1, "ジュペッタ", "", new uint[] { 64, 115, 65, 83, 63, 65 }, (PokeType.Ghost, PokeType.Non), new string[] { "ふみん", "おみとおし", "のろわれボディ" }, GenderRatio.M1F1));
            DexData.Add(new Species(357, -1, "トロピウス", "", new uint[] { 99, 68, 83, 72, 87, 51 }, (PokeType.Grass, PokeType.Flying), new string[] { "ようりょくそ", "サンパワー", "しゅうかく" }, GenderRatio.M1F1));
            DexData.Add(new Species(358, -1, "チリーン", "", new uint[] { 75, 50, 80, 95, 90, 65 }, (PokeType.Psychic, PokeType.Non), new string[] { "ふゆう", "ふゆう", "ふゆう" }, GenderRatio.M1F1));
            DexData.Add(new Species(359, -1, "アブソル", "", new uint[] { 65, 130, 60, 75, 60, 75 }, (PokeType.Dark, PokeType.Non), new string[] { "プレッシャー", "きょううん", "せいぎのこころ" }, GenderRatio.M1F1));
            DexData.Add(new Species(363, -1, "タマザラシ", "", new uint[] { 70, 40, 50, 55, 50, 25 }, (PokeType.Ice, PokeType.Water), new string[] { "あついしぼう", "アイスボディ", "どんかん" }, GenderRatio.M1F1));
            DexData.Add(new Species(364, -1, "トドグラー", "", new uint[] { 90, 60, 70, 75, 70, 45 }, (PokeType.Ice, PokeType.Water), new string[] { "あついしぼう", "アイスボディ", "どんかん" }, GenderRatio.M1F1));
            DexData.Add(new Species(365, -1, "トドゼルガ", "", new uint[] { 110, 80, 90, 95, 90, 65 }, (PokeType.Ice, PokeType.Water), new string[] { "あついしぼう", "アイスボディ", "どんかん" }, GenderRatio.M1F1));
            DexData.Add(new Species(366, -1, "パールル", "", new uint[] { 35, 64, 85, 74, 55, 32 }, (PokeType.Water, PokeType.Non), new string[] { "シェルアーマー", "シェルアーマー", "びびり" }, GenderRatio.M1F1));
            DexData.Add(new Species(367, -1, "ハンテール", "", new uint[] { 55, 104, 105, 94, 75, 52 }, (PokeType.Water, PokeType.Non), new string[] { "すいすい", "すいすい", "みずのベール" }, GenderRatio.M1F1));
            DexData.Add(new Species(368, -1, "サクラビス", "", new uint[] { 55, 84, 105, 114, 75, 52 }, (PokeType.Water, PokeType.Non), new string[] { "すいすい", "すいすい", "うるおいボディ" }, GenderRatio.M1F1));
            DexData.Add(new Species(369, -1, "ジーランス", "", new uint[] { 100, 90, 130, 45, 65, 55 }, (PokeType.Water, PokeType.Rock), new string[] { "すいすい", "いしあたま", "がんじょう" }, GenderRatio.M7F1));
            DexData.Add(new Species(370, -1, "ラブカス", "", new uint[] { 43, 30, 55, 40, 65, 97 }, (PokeType.Water, PokeType.Non), new string[] { "すいすい", "すいすい", "うるおいボディ" }, GenderRatio.M1F3));
            DexData.Add(new Species(371, -1, "タツベイ", "", new uint[] { 45, 75, 60, 40, 30, 50 }, (PokeType.Dragon, PokeType.Non), new string[] { "いしあたま", "いしあたま", "ちからずく" }, GenderRatio.M1F1));
            DexData.Add(new Species(372, -1, "コモルー", "", new uint[] { 65, 95, 100, 60, 50, 50 }, (PokeType.Dragon, PokeType.Non), new string[] { "いしあたま", "いしあたま", "ぼうじん" }, GenderRatio.M1F1));
            DexData.Add(new Species(373, -1, "ボーマンダ", "", new uint[] { 95, 135, 80, 110, 80, 100 }, (PokeType.Dragon, PokeType.Flying), new string[] { "いかく", "いかく", "じしんかじょう" }, GenderRatio.M1F1));
            DexData.Add(new Species(374, -1, "ダンバル", "", new uint[] { 40, 55, 80, 35, 60, 30 }, (PokeType.Steel, PokeType.Psychic), new string[] { "クリアボディ", "クリアボディ", "ライトメタル" }, GenderRatio.Genderless));
            DexData.Add(new Species(375, -1, "メタング", "", new uint[] { 60, 75, 100, 55, 80, 50 }, (PokeType.Steel, PokeType.Psychic), new string[] { "クリアボディ", "クリアボディ", "ライトメタル" }, GenderRatio.Genderless));
            DexData.Add(new Species(376, -1, "メタグロス", "", new uint[] { 80, 135, 130, 95, 90, 70 }, (PokeType.Steel, PokeType.Psychic), new string[] { "クリアボディ", "クリアボディ", "ライトメタル" }, GenderRatio.Genderless));
            DexData.Add(new Species(377, -1, "レジロック", "", new uint[] { 80, 100, 200, 50, 100, 50 }, (PokeType.Rock, PokeType.Non), new string[] { "クリアボディ", "クリアボディ", "がんじょう" }, GenderRatio.Genderless));
            DexData.Add(new Species(378, -1, "レジアイス", "", new uint[] { 80, 50, 100, 100, 200, 50 }, (PokeType.Ice, PokeType.Non), new string[] { "クリアボディ", "クリアボディ", "アイスボディ" }, GenderRatio.Genderless));
            DexData.Add(new Species(379, -1, "レジスチル", "", new uint[] { 80, 75, 150, 75, 150, 50 }, (PokeType.Steel, PokeType.Non), new string[] { "クリアボディ", "クリアボディ", "ライトメタル" }, GenderRatio.Genderless));
            DexData.Add(new Species(380, -1, "ラティアス", "", new uint[] { 80, 80, 90, 110, 130, 110 }, (PokeType.Dragon, PokeType.Psychic), new string[] { "ふゆう", "ふゆう", "ふゆう" }, GenderRatio.FemaleOnly));
            DexData.Add(new Species(381, -1, "ラティオス", "", new uint[] { 80, 90, 80, 130, 110, 110 }, (PokeType.Dragon, PokeType.Psychic), new string[] { "ふゆう", "ふゆう", "ふゆう" }, GenderRatio.MaleOnly));
            DexData.Add(new Species(382, -1, "カイオーガ", "", new uint[] { 100, 100, 90, 150, 140, 90 }, (PokeType.Water, PokeType.Non), new string[] { "あめふらし", "あめふらし", "あめふらし" }, GenderRatio.Genderless));
            DexData.Add(new Species(383, -1, "グラードン", "", new uint[] { 100, 150, 140, 100, 90, 90 }, (PokeType.Ground, PokeType.Non), new string[] { "ひでり", "ひでり", "ひでり" }, GenderRatio.Genderless));
            DexData.Add(new Species(384, -1, "レックウザ", "", new uint[] { 105, 150, 90, 150, 90, 95 }, (PokeType.Dragon, PokeType.Flying), new string[] { "エアロック", "エアロック", "エアロック" }, GenderRatio.Genderless));
            DexData.Add(new AnotherForm(386, -1, "デオキシス", "ノーマル", new uint[] { 50, 150, 50, 150, 50, 150 }, (PokeType.Psychic, PokeType.Non), new string[] { "プレッシャー", "プレッシャー", "プレッシャー" }, GenderRatio.Genderless));
            DexData.Add(new AnotherForm(386, -1, "デオキシス", "アタック", new uint[] { 50, 180, 20, 180, 20, 150 }, (PokeType.Psychic, PokeType.Non), new string[] { "プレッシャー", "プレッシャー", "プレッシャー" }, GenderRatio.Genderless));
            DexData.Add(new AnotherForm(386, -1, "デオキシス", "ディフェンス", new uint[] { 50, 70, 160, 70, 160, 90 }, (PokeType.Psychic, PokeType.Non), new string[] { "プレッシャー", "プレッシャー", "プレッシャー" }, GenderRatio.Genderless));
            DexData.Add(new AnotherForm(386, -1, "デオキシス", "スピード", new uint[] { 50, 95, 90, 95, 90, 180 }, (PokeType.Psychic, PokeType.Non), new string[] { "プレッシャー", "プレッシャー", "プレッシャー" }, GenderRatio.Genderless));
            DexData.Add(new Species(387, -1, "ナエトル", "", new uint[] { 55, 68, 64, 45, 55, 31 }, (PokeType.Grass, PokeType.Non), new string[] { "しんりょく", "しんりょく", "シェルアーマー" }, GenderRatio.M7F1));
            DexData.Add(new Species(388, -1, "ハヤシガメ", "", new uint[] { 75, 89, 85, 55, 65, 36 }, (PokeType.Grass, PokeType.Non), new string[] { "しんりょく", "しんりょく", "シェルアーマー" }, GenderRatio.M7F1));
            DexData.Add(new Species(389, -1, "ドダイトス", "", new uint[] { 95, 109, 105, 75, 85, 56 }, (PokeType.Grass, PokeType.Ground), new string[] { "しんりょく", "しんりょく", "シェルアーマー" }, GenderRatio.M7F1));
            DexData.Add(new Species(390, -1, "ヒコザル", "", new uint[] { 44, 58, 44, 58, 44, 61 }, (PokeType.Fire, PokeType.Non), new string[] { "もうか", "もうか", "てつのこぶし" }, GenderRatio.M7F1));
            DexData.Add(new Species(391, -1, "モウカザル", "", new uint[] { 64, 78, 52, 78, 52, 81 }, (PokeType.Fire, PokeType.Fighting), new string[] { "もうか", "もうか", "てつのこぶし" }, GenderRatio.M7F1));
            DexData.Add(new Species(392, -1, "ゴウカザル", "", new uint[] { 76, 104, 71, 104, 71, 108 }, (PokeType.Fire, PokeType.Fighting), new string[] { "もうか", "もうか", "てつのこぶし" }, GenderRatio.M7F1));
            DexData.Add(new Species(393, -1, "ポッチャマ", "", new uint[] { 53, 51, 53, 61, 56, 40 }, (PokeType.Water, PokeType.Non), new string[] { "げきりゅう", "げきりゅう", "まけんき" }, GenderRatio.M7F1));
            DexData.Add(new Species(394, -1, "ポッタイシ", "", new uint[] { 64, 66, 68, 81, 76, 50 }, (PokeType.Water, PokeType.Non), new string[] { "げきりゅう", "げきりゅう", "まけんき" }, GenderRatio.M7F1));
            DexData.Add(new Species(395, -1, "エンペルト", "", new uint[] { 84, 86, 88, 111, 101, 60 }, (PokeType.Water, PokeType.Steel), new string[] { "げきりゅう", "げきりゅう", "まけんき" }, GenderRatio.M7F1));
            DexData.Add(new Species(396, -1, "ムックル", "", new uint[] { 40, 55, 30, 30, 30, 60 }, (PokeType.Normal, PokeType.Flying), new string[] { "するどいめ", "するどいめ", "すてみ" }, GenderRatio.M1F1));
            DexData.Add(new Species(397, -1, "ムクバード", "", new uint[] { 55, 75, 50, 40, 40, 80 }, (PokeType.Normal, PokeType.Flying), new string[] { "いかく", "いかく", "すてみ" }, GenderRatio.M1F1));
            DexData.Add(new Species(398, -1, "ムクホーク", "", new uint[] { 85, 120, 70, 50, 60, 100 }, (PokeType.Normal, PokeType.Flying), new string[] { "いかく", "いかく", "すてみ" }, GenderRatio.M1F1));
            DexData.Add(new Species(399, -1, "ビッパ", "", new uint[] { 59, 45, 40, 35, 40, 31 }, (PokeType.Normal, PokeType.Non), new string[] { "たんじゅん", "てんねん", "ムラっけ" }, GenderRatio.M1F1));
            DexData.Add(new Species(400, -1, "ビーダル", "", new uint[] { 79, 85, 60, 55, 60, 71 }, (PokeType.Normal, PokeType.Non), new string[] { "たんじゅん", "てんねん", "ムラっけ" }, GenderRatio.M1F1));
            DexData.Add(new Species(401, -1, "コロボーシ", "", new uint[] { 37, 25, 41, 25, 41, 25 }, (PokeType.Bug, PokeType.Non), new string[] { "だっぴ", "だっぴ", "にげあし" }, GenderRatio.M1F1));
            DexData.Add(new Species(402, -1, "コロトック", "", new uint[] { 77, 85, 51, 55, 51, 65 }, (PokeType.Bug, PokeType.Non), new string[] { "むしのしらせ", "むしのしらせ", "テクニシャン" }, GenderRatio.M1F1));
            DexData.Add(new Species(403, -1, "コリンク", "", new uint[] { 45, 65, 34, 40, 34, 45 }, (PokeType.Electric, PokeType.Non), new string[] { "とうそうしん", "いかく", "こんじょう" }, GenderRatio.M1F1));
            DexData.Add(new Species(404, -1, "ルクシオ", "", new uint[] { 60, 85, 49, 60, 49, 60 }, (PokeType.Electric, PokeType.Non), new string[] { "とうそうしん", "いかく", "こんじょう" }, GenderRatio.M1F1));
            DexData.Add(new Species(405, -1, "レントラー", "", new uint[] { 80, 120, 79, 95, 79, 70 }, (PokeType.Electric, PokeType.Non), new string[] { "とうそうしん", "いかく", "こんじょう" }, GenderRatio.M1F1));
            DexData.Add(new Species(408, -1, "ズガイドス", "", new uint[] { 67, 125, 40, 30, 30, 58 }, (PokeType.Rock, PokeType.Non), new string[] { "かたやぶり", "かたやぶり", "ちからずく" }, GenderRatio.M7F1));
            DexData.Add(new Species(409, -1, "ラムパルド", "", new uint[] { 97, 165, 60, 65, 50, 58 }, (PokeType.Rock, PokeType.Non), new string[] { "かたやぶり", "かたやぶり", "ちからずく" }, GenderRatio.M7F1));
            DexData.Add(new Species(410, -1, "タテトプス", "", new uint[] { 30, 42, 118, 42, 88, 30 }, (PokeType.Rock, PokeType.Steel), new string[] { "がんじょう", "がんじょう", "ぼうおん" }, GenderRatio.M7F1));
            DexData.Add(new Species(411, -1, "トリデプス", "", new uint[] { 60, 52, 168, 47, 138, 30 }, (PokeType.Rock, PokeType.Steel), new string[] { "がんじょう", "がんじょう", "ぼうおん" }, GenderRatio.M7F1));
            DexData.Add(new Species(412, -1, "ミノムッチ", "", new uint[] { 40, 29, 45, 29, 45, 36 }, (PokeType.Bug, PokeType.Grass), new string[] { "だっぴ", "だっぴ", "ぼうじん" }, GenderRatio.M1F1));
            DexData.Add(new AnotherForm(413, -1, "ミノマダム", "草木", new uint[] { 60, 59, 85, 79, 105, 36 }, (PokeType.Bug, PokeType.Grass), new string[] { "きけんよち", "きけんよち", "ぼうじん" }, GenderRatio.FemaleOnly));
            DexData.Add(new AnotherForm(413, -1, "ミノマダム", "砂地", new uint[] { 60, 79, 105, 59, 85, 36 }, (PokeType.Bug, PokeType.Ground), new string[] { "きけんよち", "きけんよち", "ぼうじん" }, GenderRatio.FemaleOnly));
            DexData.Add(new AnotherForm(413, -1, "ミノマダム", "ゴミ", new uint[] { 60, 69, 95, 69, 95, 36 }, (PokeType.Bug, PokeType.Steel), new string[] { "きけんよち", "きけんよち", "ぼうじん" }, GenderRatio.FemaleOnly));
            DexData.Add(new Species(414, -1, "ガーメイル", "", new uint[] { 70, 94, 50, 94, 50, 66 }, (PokeType.Bug, PokeType.Flying), new string[] { "むしのしらせ", "むしのしらせ", "いろめがね" }, GenderRatio.MaleOnly));
            DexData.Add(new Species(417, -1, "パチリス", "", new uint[] { 60, 45, 70, 45, 90, 95 }, (PokeType.Electric, PokeType.Non), new string[] { "にげあし", "ものひろい", "ちくでん" }, GenderRatio.M1F1));
            DexData.Add(new Species(418, -1, "ブイゼル", "", new uint[] { 55, 65, 35, 60, 30, 85 }, (PokeType.Water, PokeType.Non), new string[] { "すいすい", "すいすい", "みずのベール" }, GenderRatio.M1F1));
            DexData.Add(new Species(419, -1, "フローゼル", "", new uint[] { 85, 105, 55, 85, 50, 115 }, (PokeType.Water, PokeType.Non), new string[] { "すいすい", "すいすい", "みずのベール" }, GenderRatio.M1F1));
            DexData.Add(new Species(424, -1, "エテボース", "", new uint[] { 75, 100, 66, 60, 66, 115 }, (PokeType.Normal, PokeType.Non), new string[] { "テクニシャン", "ものひろい", "スキルリンク" }, GenderRatio.M1F1));
            DexData.Add(new Species(427, -1, "ミミロル", "", new uint[] { 55, 66, 44, 44, 56, 85 }, (PokeType.Normal, PokeType.Non), new string[] { "にげあし", "ぶきよう", "じゅうなん" }, GenderRatio.M1F1));
            DexData.Add(new Species(428, -1, "ミミロップ", "", new uint[] { 65, 76, 84, 54, 96, 105 }, (PokeType.Normal, PokeType.Non), new string[] { "メロメロボディ", "ぶきよう", "じゅうなん" }, GenderRatio.M1F1));
            DexData.Add(new Species(429, -1, "ムウマージ", "", new uint[] { 60, 60, 60, 105, 105, 105 }, (PokeType.Ghost, PokeType.Non), new string[] { "ふゆう", "ふゆう", "ふゆう" }, GenderRatio.M1F1));
            DexData.Add(new Species(430, -1, "ドンカラス", "", new uint[] { 100, 125, 52, 105, 52, 71 }, (PokeType.Dark, PokeType.Flying), new string[] { "ふみん", "きょううん", "じしんかじょう" }, GenderRatio.M1F1));
            DexData.Add(new Species(431, -1, "ニャルマー", "", new uint[] { 49, 55, 42, 42, 37, 85 }, (PokeType.Normal, PokeType.Non), new string[] { "じゅうなん", "マイペース", "するどいめ" }, GenderRatio.M1F3));
            DexData.Add(new Species(432, -1, "ブニャット", "", new uint[] { 71, 82, 64, 64, 59, 112 }, (PokeType.Normal, PokeType.Non), new string[] { "あついしぼう", "マイペース", "まけんき" }, GenderRatio.M1F3));
            DexData.Add(new Species(433, -1, "リーシャン", "", new uint[] { 45, 30, 50, 65, 50, 45 }, (PokeType.Psychic, PokeType.Non), new string[] { "ふゆう", "ふゆう", "ふゆう" }, GenderRatio.M1F1));
            DexData.Add(new Species(440, -1, "ピンプク", "", new uint[] { 100, 5, 5, 15, 65, 30 }, (PokeType.Normal, PokeType.Non), new string[] { "しぜんかいふく", "てんのめぐみ", "フレンドガード" }, GenderRatio.FemaleOnly));
            DexData.Add(new Species(441, -1, "ペラップ", "", new uint[] { 76, 65, 45, 92, 42, 91 }, (PokeType.Normal, PokeType.Flying), new string[] { "するどいめ", "ちどりあし", "はとむね" }, GenderRatio.M1F1));
            DexData.Add(new Species(442, -1, "ミカルゲ", "", new uint[] { 50, 92, 108, 92, 108, 35 }, (PokeType.Ghost, PokeType.Dark), new string[] { "プレッシャー", "プレッシャー", "すりぬけ" }, GenderRatio.M1F1));
            DexData.Add(new Species(443, -1, "フカマル", "", new uint[] { 58, 70, 45, 40, 45, 42 }, (PokeType.Dragon, PokeType.Ground), new string[] { "すながくれ", "すながくれ", "さめはだ" }, GenderRatio.M1F1));
            DexData.Add(new Species(444, -1, "ガバイト", "", new uint[] { 68, 90, 65, 50, 55, 82 }, (PokeType.Dragon, PokeType.Ground), new string[] { "すながくれ", "すながくれ", "さめはだ" }, GenderRatio.M1F1));
            DexData.Add(new Species(445, -1, "ガブリアス", "", new uint[] { 108, 130, 95, 80, 85, 102 }, (PokeType.Dragon, PokeType.Ground), new string[] { "すながくれ", "すながくれ", "さめはだ" }, GenderRatio.M1F1));
            DexData.Add(new Species(455, -1, "マスキッパ", "", new uint[] { 74, 100, 72, 90, 72, 46 }, (PokeType.Grass, PokeType.Non), new string[] { "ふゆう", "ふゆう", "ふゆう" }, GenderRatio.M1F1));
            DexData.Add(new Species(456, -1, "ケイコウオ", "", new uint[] { 49, 49, 56, 49, 61, 66 }, (PokeType.Water, PokeType.Non), new string[] { "すいすい", "よびみず", "みずのベール" }, GenderRatio.M1F1));
            DexData.Add(new Species(457, -1, "ネオラント", "", new uint[] { 69, 69, 76, 69, 86, 91 }, (PokeType.Water, PokeType.Non), new string[] { "すいすい", "よびみず", "みずのベール" }, GenderRatio.M1F1));
            DexData.Add(new Species(462, -1, "ジバコイル", "", new uint[] { 70, 70, 115, 130, 90, 60 }, (PokeType.Electric, PokeType.Steel), new string[] { "じりょく", "がんじょう", "アナライズ" }, GenderRatio.M1F1));
            DexData.Add(new Species(463, -1, "ベロベルト", "", new uint[] { 110, 85, 95, 80, 95, 50 }, (PokeType.Normal, PokeType.Non), new string[] { "マイペース", "どんかん", "ノーてんき" }, GenderRatio.M1F1));
            DexData.Add(new Species(465, -1, "モジャンボ", "", new uint[] { 100, 100, 125, 110, 50, 50 }, (PokeType.Grass, PokeType.Non), new string[] { "ようりょくそ", "リーフガード", "さいせいりょく" }, GenderRatio.M1F1));
            DexData.Add(new Species(466, -1, "エレキブル", "", new uint[] { 75, 123, 67, 95, 85, 95 }, (PokeType.Electric, PokeType.Non), new string[] { "でんきエンジン", "でんきエンジン", "やるき" }, GenderRatio.M3F1));
            DexData.Add(new Species(467, -1, "ブーバーン", "", new uint[] { 75, 95, 67, 125, 95, 83 }, (PokeType.Fire, PokeType.Non), new string[] { "ほのおのからだ", "ほのおのからだ", "やるき" }, GenderRatio.M3F1));
            DexData.Add(new Species(469, -1, "メガヤンマ", "", new uint[] { 86, 76, 86, 116, 56, 95 }, (PokeType.Bug, PokeType.Flying), new string[] { "かそく", "いろめがね", "おみとおし" }, GenderRatio.M1F1));
            DexData.Add(new Species(472, -1, "グライオン", "", new uint[] { 75, 95, 125, 45, 75, 95 }, (PokeType.Ground, PokeType.Flying), new string[] { "かいりきバサミ", "すながくれ", "ポイズンヒール" }, GenderRatio.M1F1));
            DexData.Add(new Species(474, -1, "ポリゴンZ", "", new uint[] { 85, 80, 70, 135, 75, 90 }, (PokeType.Normal, PokeType.Non), new string[] { "てきおうりょく", "ダウンロード", "アナライズ" }, GenderRatio.Genderless));
            DexData.Add(new Species(476, -1, "ダイノーズ", "", new uint[] { 60, 55, 145, 75, 150, 40 }, (PokeType.Rock, PokeType.Steel), new string[] { "がんじょう", "じりょく", "すなのちから" }, GenderRatio.M1F1));
            DexData.Add(new Species(480, -1, "ユクシー", "", new uint[] { 75, 75, 130, 75, 130, 95 }, (PokeType.Psychic, PokeType.Non), new string[] { "ふゆう", "ふゆう", "ふゆう" }, GenderRatio.Genderless));
            DexData.Add(new Species(481, -1, "エムリット", "", new uint[] { 80, 105, 105, 105, 105, 80 }, (PokeType.Psychic, PokeType.Non), new string[] { "ふゆう", "ふゆう", "ふゆう" }, GenderRatio.Genderless));
            DexData.Add(new Species(482, -1, "アグノム", "", new uint[] { 75, 125, 70, 125, 70, 115 }, (PokeType.Psychic, PokeType.Non), new string[] { "ふゆう", "ふゆう", "ふゆう" }, GenderRatio.Genderless));
            DexData.Add(new Species(483, -1, "ディアルガ", "", new uint[] { 100, 120, 120, 150, 100, 90 }, (PokeType.Steel, PokeType.Dragon), new string[] { "プレッシャー", "プレッシャー", "テレパシー" }, GenderRatio.Genderless));
            DexData.Add(new Species(484, -1, "パルキア", "", new uint[] { 90, 120, 100, 150, 120, 100 }, (PokeType.Water, PokeType.Dragon), new string[] { "プレッシャー", "プレッシャー", "テレパシー" }, GenderRatio.Genderless));
            DexData.Add(new Species(485, -1, "ヒードラン", "", new uint[] { 91, 90, 106, 130, 106, 77 }, (PokeType.Fire, PokeType.Steel), new string[] { "もらいび", "もらいび", "ほのおのからだ" }, GenderRatio.M1F1));
            DexData.Add(new Species(486, -1, "レジギガス", "", new uint[] { 110, 160, 110, 80, 110, 100 }, (PokeType.Normal, PokeType.Non), new string[] { "スロースタート", "スロースタート", "スロースタート" }, GenderRatio.Genderless));
            DexData.Add(new AnotherForm(487, -1, "ギラティナ", "アナザー", new uint[] { 150, 100, 120, 100, 120, 90 }, (PokeType.Ghost, PokeType.Dragon), new string[] { "プレッシャー", "プレッシャー", "テレパシー" }, GenderRatio.Genderless));
            DexData.Add(new AnotherForm(487, -1, "ギラティナ", "オリジン", new uint[] { 150, 120, 100, 120, 100, 90 }, (PokeType.Ghost, PokeType.Dragon), new string[] { "ふゆう", "ふゆう", "ふゆう" }, GenderRatio.Genderless));
            DexData.Add(new Species(488, -1, "クレセリア", "", new uint[] { 120, 70, 120, 75, 130, 85 }, (PokeType.Psychic, PokeType.Non), new string[] { "ふゆう", "ふゆう", "ふゆう" }, GenderRatio.FemaleOnly));
            DexData.Add(new Species(489, -1, "フィオネ", "", new uint[] { 80, 80, 80, 80, 80, 80 }, (PokeType.Water, PokeType.Non), new string[] { "うるおいボディ", "うるおいボディ", "うるおいボディ" }, GenderRatio.Genderless));
            DexData.Add(new Species(490, -1, "マナフィ", "", new uint[] { 100, 100, 100, 100, 100, 100 }, (PokeType.Water, PokeType.Non), new string[] { "うるおいボディ", "うるおいボディ", "うるおいボディ" }, GenderRatio.Genderless));
            DexData.Add(new Species(491, -1, "ダークライ", "", new uint[] { 70, 90, 90, 135, 90, 125 }, (PokeType.Dark, PokeType.Non), new string[] { "ナイトメア", "ナイトメア", "ナイトメア" }, GenderRatio.Genderless));
            DexData.Add(new AnotherForm(492, -1, "シェイミ", "ランド", new uint[] { 100, 100, 100, 100, 100, 100 }, (PokeType.Grass, PokeType.Non), new string[] { "しぜんかいふく", "しぜんかいふく", "しぜんかいふく" }, GenderRatio.Genderless));
            DexData.Add(new AnotherForm(492, -1, "シェイミ", "スカイ", new uint[] { 100, 103, 75, 120, 75, 127 }, (PokeType.Grass, PokeType.Flying), new string[] { "てんのめぐみ", "てんのめぐみ", "てんのめぐみ" }, GenderRatio.Genderless));
            DexData.Add(new Species(493, -1, "アルセウス", "", new uint[] { 120, 120, 120, 120, 120, 120 }, (PokeType.Normal, PokeType.Non), new string[] { "マルチタイプ", "マルチタイプ", "マルチタイプ" }, GenderRatio.Genderless));
            DexData.Add(new Species(494, -1, "ビクティニ", "", new uint[] { 100, 100, 100, 100, 100, 100 }, (PokeType.Psychic, PokeType.Fire), new string[] { "しょうりのほし", "しょうりのほし", "しょうりのほし" }, GenderRatio.Genderless));
            DexData.Add(new Species(495, -1, "ツタージャ", "", new uint[] { 45, 45, 55, 45, 55, 63 }, (PokeType.Grass, PokeType.Non), new string[] { "しんりょく", "しんりょく", "あまのじゃく" }, GenderRatio.M7F1));
            DexData.Add(new Species(496, -1, "ジャノビー", "", new uint[] { 60, 60, 75, 60, 75, 83 }, (PokeType.Grass, PokeType.Non), new string[] { "しんりょく", "しんりょく", "あまのじゃく" }, GenderRatio.M7F1));
            DexData.Add(new Species(497, -1, "ジャローダ", "", new uint[] { 75, 75, 95, 75, 95, 113 }, (PokeType.Grass, PokeType.Non), new string[] { "しんりょく", "しんりょく", "あまのじゃく" }, GenderRatio.M7F1));
            DexData.Add(new Species(498, -1, "ポカブ", "", new uint[] { 65, 63, 45, 45, 45, 45 }, (PokeType.Fire, PokeType.Non), new string[] { "もうか", "もうか", "あついしぼう" }, GenderRatio.M7F1));
            DexData.Add(new Species(499, -1, "チャオブー", "", new uint[] { 90, 93, 55, 70, 55, 55 }, (PokeType.Fire, PokeType.Fighting), new string[] { "もうか", "もうか", "あついしぼう" }, GenderRatio.M7F1));
            DexData.Add(new Species(500, -1, "エンブオー", "", new uint[] { 110, 123, 65, 100, 65, 65 }, (PokeType.Fire, PokeType.Fighting), new string[] { "もうか", "もうか", "すてみ" }, GenderRatio.M7F1));
            DexData.Add(new Species(501, -1, "ミジュマル", "", new uint[] { 55, 55, 45, 63, 45, 45 }, (PokeType.Water, PokeType.Non), new string[] { "げきりゅう", "げきりゅう", "シェルアーマー" }, GenderRatio.M7F1));
            DexData.Add(new Species(502, -1, "フタチマル", "", new uint[] { 75, 75, 60, 83, 60, 60 }, (PokeType.Water, PokeType.Non), new string[] { "げきりゅう", "げきりゅう", "シェルアーマー" }, GenderRatio.M7F1));
            DexData.Add(new Species(503, -1, "ダイケンキ", "", new uint[] { 95, 100, 85, 108, 70, 70 }, (PokeType.Water, PokeType.Non), new string[] { "げきりゅう", "げきりゅう", "シェルアーマー" }, GenderRatio.M7F1));
            DexData.Add(new Species(504, -1, "ミネズミ", "", new uint[] { 45, 55, 39, 35, 39, 42 }, (PokeType.Normal, PokeType.Non), new string[] { "にげあし", "するどいめ", "アナライズ" }, GenderRatio.M1F1));
            DexData.Add(new Species(505, -1, "ミルホッグ", "", new uint[] { 60, 85, 69, 60, 69, 77 }, (PokeType.Normal, PokeType.Non), new string[] { "はっこう", "するどいめ", "アナライズ" }, GenderRatio.M1F1));
            DexData.Add(new Species(506, -1, "ヨーテリー", "", new uint[] { 45, 60, 45, 25, 45, 55 }, (PokeType.Normal, PokeType.Non), new string[] { "やるき", "ものひろい", "にげあし" }, GenderRatio.M1F1));
            DexData.Add(new Species(507, -1, "ハーデリア", "", new uint[] { 65, 80, 65, 35, 65, 60 }, (PokeType.Normal, PokeType.Non), new string[] { "いかく", "すなかき", "きもったま" }, GenderRatio.M1F1));
            DexData.Add(new Species(508, -1, "ムーランド", "", new uint[] { 85, 110, 90, 45, 90, 80 }, (PokeType.Normal, PokeType.Non), new string[] { "いかく", "すなかき", "きもったま" }, GenderRatio.M1F1));
            DexData.Add(new Species(511, -1, "ヤナップ", "", new uint[] { 50, 53, 48, 53, 48, 64 }, (PokeType.Grass, PokeType.Non), new string[] { "くいしんぼう", "くいしんぼう", "しんりょく" }, GenderRatio.M7F1));
            DexData.Add(new Species(512, -1, "ヤナッキー", "", new uint[] { 75, 98, 63, 98, 63, 101 }, (PokeType.Grass, PokeType.Non), new string[] { "くいしんぼう", "くいしんぼう", "しんりょく" }, GenderRatio.M7F1));
            DexData.Add(new Species(513, -1, "バオップ", "", new uint[] { 50, 53, 48, 53, 48, 64 }, (PokeType.Fire, PokeType.Non), new string[] { "くいしんぼう", "くいしんぼう", "もうか" }, GenderRatio.M7F1));
            DexData.Add(new Species(514, -1, "バオッキー", "", new uint[] { 75, 98, 63, 98, 63, 101 }, (PokeType.Fire, PokeType.Non), new string[] { "くいしんぼう", "くいしんぼう", "もうか" }, GenderRatio.M7F1));
            DexData.Add(new Species(515, -1, "ヒヤップ", "", new uint[] { 50, 53, 48, 53, 48, 64 }, (PokeType.Water, PokeType.Non), new string[] { "くいしんぼう", "くいしんぼう", "げきりゅう" }, GenderRatio.M7F1));
            DexData.Add(new Species(516, -1, "ヒヤッキー", "", new uint[] { 75, 98, 63, 98, 63, 101 }, (PokeType.Water, PokeType.Non), new string[] { "くいしんぼう", "くいしんぼう", "げきりゅう" }, GenderRatio.M7F1));
            DexData.Add(new Species(522, -1, "シママ", "", new uint[] { 45, 60, 32, 50, 32, 76 }, (PokeType.Electric, PokeType.Non), new string[] { "ひらいしん", "でんきエンジン", "そうしょく" }, GenderRatio.M1F1));
            DexData.Add(new Species(523, -1, "ゼブライカ", "", new uint[] { 75, 100, 63, 80, 63, 116 }, (PokeType.Electric, PokeType.Non), new string[] { "ひらいしん", "でんきエンジン", "そうしょく" }, GenderRatio.M1F1));
            DexData.Add(new Species(531, -1, "タブンネ", "", new uint[] { 103, 60, 86, 60, 86, 50 }, (PokeType.Normal, PokeType.Non), new string[] { "いやしのこころ", "さいせいりょく", "ぶきよう" }, GenderRatio.M1F1));
            DexData.Add(new Species(540, -1, "クルミル", "", new uint[] { 45, 53, 70, 40, 60, 42 }, (PokeType.Bug, PokeType.Grass), new string[] { "むしのしらせ", "ようりょくそ", "ぼうじん" }, GenderRatio.M1F1));
            DexData.Add(new Species(541, -1, "クルマユ", "", new uint[] { 55, 63, 90, 50, 80, 42 }, (PokeType.Bug, PokeType.Grass), new string[] { "リーフガード", "ようりょくそ", "ぼうじん" }, GenderRatio.M1F1));
            DexData.Add(new Species(542, -1, "ハハコモリ", "", new uint[] { 75, 103, 80, 70, 80, 92 }, (PokeType.Bug, PokeType.Grass), new string[] { "むしのしらせ", "ようりょくそ", "ぼうじん" }, GenderRatio.M1F1));
            DexData.Add(new Species(543, -1, "フシデ", "", new uint[] { 30, 45, 59, 30, 39, 57 }, (PokeType.Bug, PokeType.Poison), new string[] { "どくのトゲ", "むしのしらせ", "かそく" }, GenderRatio.M1F1));
            DexData.Add(new Species(544, -1, "ホイーガ", "", new uint[] { 40, 55, 99, 40, 79, 47 }, (PokeType.Bug, PokeType.Poison), new string[] { "どくのトゲ", "むしのしらせ", "かそく" }, GenderRatio.M1F1));
            DexData.Add(new Species(545, -1, "ペンドラー", "", new uint[] { 60, 100, 89, 55, 69, 112 }, (PokeType.Bug, PokeType.Poison), new string[] { "どくのトゲ", "むしのしらせ", "かそく" }, GenderRatio.M1F1));
            DexData.Add(new Species(548, -1, "チュリネ", "", new uint[] { 45, 35, 50, 70, 50, 30 }, (PokeType.Grass, PokeType.Non), new string[] { "ようりょくそ", "マイペース", "リーフガード" }, GenderRatio.FemaleOnly));
            DexData.Add(new Species(549, -1, "ドレディア", "", new uint[] { 70, 60, 75, 110, 75, 90 }, (PokeType.Grass, PokeType.Non), new string[] { "ようりょくそ", "マイペース", "リーフガード" }, GenderRatio.FemaleOnly));
            DexData.Add(new Species(551, -1, "メグロコ", "", new uint[] { 50, 72, 35, 35, 35, 65 }, (PokeType.Ground, PokeType.Dark), new string[] { "いかく", "じしんかじょう", "いかりのつぼ" }, GenderRatio.M1F1));
            DexData.Add(new Species(552, -1, "ワルビル", "", new uint[] { 60, 82, 45, 45, 45, 74 }, (PokeType.Ground, PokeType.Dark), new string[] { "いかく", "じしんかじょう", "いかりのつぼ" }, GenderRatio.M1F1));
            DexData.Add(new Species(553, -1, "ワルビアル", "", new uint[] { 95, 117, 80, 65, 70, 92 }, (PokeType.Ground, PokeType.Dark), new string[] { "いかく", "じしんかじょう", "いかりのつぼ" }, GenderRatio.M1F1));
            DexData.Add(new Species(564, -1, "プロトーガ", "", new uint[] { 54, 78, 103, 53, 45, 22 }, (PokeType.Water, PokeType.Rock), new string[] { "ハードロック", "がんじょう", "すいすい" }, GenderRatio.M7F1));
            DexData.Add(new Species(565, -1, "アバゴーラ", "", new uint[] { 74, 108, 133, 83, 65, 32 }, (PokeType.Water, PokeType.Rock), new string[] { "ハードロック", "がんじょう", "すいすい" }, GenderRatio.M7F1));
            DexData.Add(new Species(566, -1, "アーケン", "", new uint[] { 55, 112, 45, 74, 45, 70 }, (PokeType.Rock, PokeType.Flying), new string[] { "よわき", "よわき", "よわき" }, GenderRatio.M7F1));
            DexData.Add(new Species(567, -1, "アーケオス", "", new uint[] { 75, 140, 65, 112, 65, 110 }, (PokeType.Rock, PokeType.Flying), new string[] { "よわき", "よわき", "よわき" }, GenderRatio.M7F1));
            DexData.Add(new Species(570, -1, "ゾロア", "", new uint[] { 40, 65, 40, 80, 40, 65 }, (PokeType.Dark, PokeType.Non), new string[] { "イリュージョン", "イリュージョン", "イリュージョン" }, GenderRatio.M7F1));
            DexData.Add(new Species(571, -1, "ゾロアーク", "", new uint[] { 60, 105, 60, 120, 60, 105 }, (PokeType.Dark, PokeType.Non), new string[] { "イリュージョン", "イリュージョン", "イリュージョン" }, GenderRatio.M7F1));
            DexData.Add(new Species(580, -1, "コアルヒー", "", new uint[] { 62, 44, 50, 44, 50, 55 }, (PokeType.Water, PokeType.Flying), new string[] { "するどいめ", "はとむね", "うるおいボディ" }, GenderRatio.M1F1));
            DexData.Add(new Species(581, -1, "スワンナ", "", new uint[] { 75, 87, 63, 87, 63, 98 }, (PokeType.Water, PokeType.Flying), new string[] { "するどいめ", "はとむね", "うるおいボディ" }, GenderRatio.M1F1));
            DexData.Add(new Species(585, -1, "シキジカ", "", new uint[] { 60, 60, 50, 40, 50, 75 }, (PokeType.Normal, PokeType.Grass), new string[] { "ようりょくそ", "そうしょく", "てんのめぐみ" }, GenderRatio.M1F1));
            DexData.Add(new Species(586, -1, "メブキジカ", "", new uint[] { 80, 100, 70, 60, 70, 95 }, (PokeType.Normal, PokeType.Grass), new string[] { "ようりょくそ", "そうしょく", "てんのめぐみ" }, GenderRatio.M1F1));
            DexData.Add(new Species(587, -1, "エモンガ", "", new uint[] { 55, 75, 60, 75, 60, 103 }, (PokeType.Electric, PokeType.Flying), new string[] { "せいでんき", "せいでんき", "でんきエンジン" }, GenderRatio.M1F1));
            DexData.Add(new Species(590, -1, "タマゲタケ", "", new uint[] { 69, 55, 45, 55, 55, 15 }, (PokeType.Grass, PokeType.Poison), new string[] { "ほうし", "ほうし", "さいせいりょく" }, GenderRatio.M1F1));
            DexData.Add(new Species(591, -1, "モロバレル", "", new uint[] { 114, 85, 70, 85, 80, 30 }, (PokeType.Grass, PokeType.Poison), new string[] { "ほうし", "ほうし", "さいせいりょく" }, GenderRatio.M1F1));
            DexData.Add(new Species(594, -1, "ママンボウ", "", new uint[] { 165, 75, 80, 40, 45, 65 }, (PokeType.Water, PokeType.Non), new string[] { "いやしのこころ", "うるおいボディ", "さいせいりょく" }, GenderRatio.M1F1));
            DexData.Add(new Species(602, -1, "シビシラス", "", new uint[] { 35, 55, 40, 45, 40, 60 }, (PokeType.Electric, PokeType.Non), new string[] { "ふゆう", "ふゆう", "ふゆう" }, GenderRatio.M1F1));
            DexData.Add(new Species(603, -1, "シビビール", "", new uint[] { 65, 85, 70, 75, 70, 40 }, (PokeType.Electric, PokeType.Non), new string[] { "ふゆう", "ふゆう", "ふゆう" }, GenderRatio.M1F1));
            DexData.Add(new Species(604, -1, "シビルドン", "", new uint[] { 85, 115, 80, 105, 80, 50 }, (PokeType.Electric, PokeType.Non), new string[] { "ふゆう", "ふゆう", "ふゆう" }, GenderRatio.M1F1));
            DexData.Add(new Species(615, -1, "フリージオ", "", new uint[] { 80, 50, 50, 95, 135, 105 }, (PokeType.Ice, PokeType.Non), new string[] { "ふゆう", "ふゆう", "ふゆう" }, GenderRatio.Genderless));
            DexData.Add(new Species(619, -1, "コジョフー", "", new uint[] { 45, 85, 50, 55, 50, 65 }, (PokeType.Fighting, PokeType.Non), new string[] { "せいしんりょく", "さいせいりょく", "すてみ" }, GenderRatio.M1F1));
            DexData.Add(new Species(620, -1, "コジョンド", "", new uint[] { 65, 125, 60, 95, 60, 105 }, (PokeType.Fighting, PokeType.Non), new string[] { "せいしんりょく", "さいせいりょく", "すてみ" }, GenderRatio.M1F1));
            DexData.Add(new Species(621, -1, "クリムガン", "", new uint[] { 77, 120, 90, 60, 90, 48 }, (PokeType.Dragon, PokeType.Non), new string[] { "さめはだ", "ちからずく", "かたやぶり" }, GenderRatio.M1F1));
            DexData.Add(new Species(626, -1, "バッフロン", "", new uint[] { 95, 110, 95, 40, 95, 55 }, (PokeType.Normal, PokeType.Non), new string[] { "すてみ", "そうしょく", "ぼうおん" }, GenderRatio.M1F1));
            DexData.Add(new Species(636, -1, "メラルバ", "", new uint[] { 55, 85, 55, 50, 55, 60 }, (PokeType.Bug, PokeType.Fire), new string[] { "ほのおのからだ", "ほのおのからだ", "むしのしらせ" }, GenderRatio.M1F1));
            DexData.Add(new Species(637, -1, "ウルガモス", "", new uint[] { 85, 60, 65, 135, 105, 100 }, (PokeType.Bug, PokeType.Fire), new string[] { "ほのおのからだ", "ほのおのからだ", "むしのしらせ" }, GenderRatio.M1F1));
            DexData.Add(new AnotherForm(641, -1, "トルネロス", "化身", new uint[] { 79, 115, 70, 125, 80, 111 }, (PokeType.Flying, PokeType.Non), new string[] { "いたずらごころ", "いたずらごころ", "まけんき" }, GenderRatio.MaleOnly));
            DexData.Add(new AnotherForm(641, -1, "トルネロス", "霊獣", new uint[] { 79, 100, 80, 110, 90, 121 }, (PokeType.Flying, PokeType.Non), new string[] { "さいせいりょく", "さいせいりょく", "さいせいりょく" }, GenderRatio.MaleOnly));
            DexData.Add(new AnotherForm(642, -1, "ボルトロス", "化身", new uint[] { 79, 115, 70, 125, 80, 111 }, (PokeType.Electric, PokeType.Flying), new string[] { "いたずらごころ", "いたずらごころ", "まけんき" }, GenderRatio.MaleOnly));
            DexData.Add(new AnotherForm(642, -1, "ボルトロス", "霊獣", new uint[] { 79, 105, 70, 145, 80, 101 }, (PokeType.Electric, PokeType.Flying), new string[] { "ちくでん", "ちくでん", "ちくでん" }, GenderRatio.MaleOnly));
            DexData.Add(new AnotherForm(645, -1, "ランドロス", "化身", new uint[] { 89, 125, 90, 115, 80, 101 }, (PokeType.Ground, PokeType.Flying), new string[] { "すなのちから", "すなのちから", "ちからずく" }, GenderRatio.MaleOnly));
            DexData.Add(new AnotherForm(645, -1, "ランドロス", "霊獣", new uint[] { 89, 145, 90, 105, 80, 91 }, (PokeType.Ground, PokeType.Flying), new string[] { "いかく", "いかく", "いかく" }, GenderRatio.MaleOnly));
            DexData.Add(new AnotherForm(648, -1, "メロエッタ", "ボイス", new uint[] { 100, 77, 77, 128, 128, 90 }, (PokeType.Normal, PokeType.Psychic), new string[] { "てんのめぐみ", "てんのめぐみ", "てんのめぐみ" }, GenderRatio.Genderless));
            DexData.Add(new AnotherForm(648, -1, "メロエッタ", "ステップ", new uint[] { 100, 128, 90, 77, 77, 128 }, (PokeType.Normal, PokeType.Fighting), new string[] { "てんのめぐみ", "てんのめぐみ", "てんのめぐみ" }, GenderRatio.Genderless));
            DexData.Add(new Species(649, -1, "ゲノセクト", "", new uint[] { 71, 120, 95, 120, 95, 99 }, (PokeType.Bug, PokeType.Steel), new string[] { "ダウンロード", "ダウンロード", "ダウンロード" }, GenderRatio.Genderless));
            DexData.Add(new Species(650, -1, "ハリマロン", "", new uint[] { 56, 61, 65, 48, 45, 38 }, (PokeType.Grass, PokeType.Non), new string[] { "しんりょく", "しんりょく", "ぼうだん" }, GenderRatio.M7F1));
            DexData.Add(new Species(651, -1, "ハリボーグ", "", new uint[] { 61, 78, 95, 56, 58, 57 }, (PokeType.Grass, PokeType.Non), new string[] { "しんりょく", "しんりょく", "ぼうだん" }, GenderRatio.M7F1));
            DexData.Add(new Species(652, -1, "ブリガロン", "", new uint[] { 88, 107, 122, 74, 75, 64 }, (PokeType.Grass, PokeType.Fighting), new string[] { "しんりょく", "しんりょく", "ぼうだん" }, GenderRatio.M7F1));
            DexData.Add(new Species(653, -1, "フォッコ", "", new uint[] { 40, 45, 40, 62, 60, 60 }, (PokeType.Fire, PokeType.Non), new string[] { "もうか", "もうか", "マジシャン" }, GenderRatio.M7F1));
            DexData.Add(new Species(654, -1, "テールナー", "", new uint[] { 59, 59, 58, 90, 70, 73 }, (PokeType.Fire, PokeType.Non), new string[] { "もうか", "もうか", "マジシャン" }, GenderRatio.M7F1));
            DexData.Add(new Species(655, -1, "マフォクシー", "", new uint[] { 75, 69, 72, 114, 100, 104 }, (PokeType.Fire, PokeType.Psychic), new string[] { "もうか", "もうか", "マジシャン" }, GenderRatio.M7F1));
            ...
            DexData.Add(new Species(664, -1, "コフキムシ", "", new uint[] { 38, 35, 40, 27, 25, 35 }, (PokeType.Bug, PokeType.Non), new string[] { "りんぷん", "ふくがん", "フレンドガード" }, GenderRatio.M1F1));
            DexData.Add(new Species(665, -1, "コフーライ", "", new uint[] { 45, 22, 60, 27, 30, 29 }, (PokeType.Bug, PokeType.Non), new string[] { "だっぴ", "だっぴ", "フレンドガード" }, GenderRatio.M1F1));
            DexData.Add(new Species(666, -1, "ビビヨン", "", new uint[] { 80, 52, 50, 90, 50, 89 }, (PokeType.Bug, PokeType.Flying), new string[] { "りんぷん", "ふくがん", "フレンドガード" }, GenderRatio.M1F1));
            DexData.Add(new Species(667, -1, "シシコ", "", new uint[] { 62, 50, 58, 73, 54, 72 }, (PokeType.Fire, PokeType.Normal), new string[] { "とうそうしん", "きんちょうかん", "じしんかじょう" }, GenderRatio.M1F7));
            DexData.Add(new Species(668, -1, "カエンジシ", "", new uint[] { 86, 68, 72, 109, 66, 106 }, (PokeType.Fire, PokeType.Normal), new string[] { "とうそうしん", "きんちょうかん", "じしんかじょう" }, GenderRatio.M1F7));
            DexData.Add(new Species(669, -1, "フラベベ", "", new uint[] { 44, 38, 39, 61, 79, 42 }, (PokeType.Fairy, PokeType.Non), new string[] { "フラワーベール", "フラワーベール", "きょうせい" }, GenderRatio.FemaleOnly));
            DexData.Add(new Species(670, -1, "フラエッテ", "", new uint[] { 54, 45, 47, 75, 98, 52 }, (PokeType.Fairy, PokeType.Non), new string[] { "フラワーベール", "フラワーベール", "きょうせい" }, GenderRatio.FemaleOnly));
            DexData.Add(new Species(671, -1, "フラージェス", "", new uint[] { 78, 65, 68, 112, 154, 75 }, (PokeType.Fairy, PokeType.Non), new string[] { "フラワーベール", "フラワーベール", "きょうせい" }, GenderRatio.FemaleOnly));
            DexData.Add(new Species(672, -1, "メェークル", "", new uint[] { 66, 65, 48, 62, 57, 52 }, (PokeType.Grass, PokeType.Non), new string[] { "そうしょく", "そうしょく", "くさのけがわ" }, GenderRatio.M1F1));
            DexData.Add(new Species(673, -1, "ゴーゴート", "", new uint[] { 123, 100, 62, 97, 81, 68 }, (PokeType.Grass, PokeType.Non), new string[] { "そうしょく", "そうしょく", "くさのけがわ" }, GenderRatio.M1F1));
            DexData.Add(new Species(676, -1, "トリミアン", "", new uint[] { 75, 80, 60, 65, 90, 102 }, (PokeType.Normal, PokeType.Non), new string[] { "ファーコート", "ファーコート", "ファーコート" }, GenderRatio.M1F1));
            DexData.Add(new Species(690, -1, "クズモー", "", new uint[] { 50, 60, 60, 60, 60, 30 }, (PokeType.Poison, PokeType.Water), new string[] { "どくのトゲ", "どくしゅ", "てきおうりょく" }, GenderRatio.M1F1));
            DexData.Add(new Species(691, -1, "ドラミドロ", "", new uint[] { 65, 75, 90, 97, 123, 44 }, (PokeType.Poison, PokeType.Dragon), new string[] { "どくのトゲ", "どくしゅ", "てきおうりょく" }, GenderRatio.M1F1));
            DexData.Add(new Species(692, -1, "ウデッポウ", "", new uint[] { 50, 53, 62, 58, 63, 44 }, (PokeType.Water, PokeType.Non), new string[] { "メガランチャー", "メガランチャー", "メガランチャー" }, GenderRatio.M1F1));
            DexData.Add(new Species(693, -1, "ブロスター", "", new uint[] { 71, 73, 88, 120, 89, 59 }, (PokeType.Water, PokeType.Non), new string[] { "メガランチャー", "メガランチャー", "メガランチャー" }, GenderRatio.M1F1));
            DexData.Add(new Species(696, -1, "チゴラス", "", new uint[] { 58, 89, 77, 45, 45, 48 }, (PokeType.Rock, PokeType.Dragon), new string[] { "がんじょうあご", "がんじょうあご", "がんじょう" }, GenderRatio.M7F1));
            DexData.Add(new Species(697, -1, "ガチゴラス", "", new uint[] { 82, 121, 119, 69, 59, 71 }, (PokeType.Rock, PokeType.Dragon), new string[] { "がんじょうあご", "がんじょうあご", "がんじょう" }, GenderRatio.M7F1));
            DexData.Add(new Species(698, -1, "アマルス", "", new uint[] { 77, 59, 50, 67, 63, 46 }, (PokeType.Rock, PokeType.Ice), new string[] { "フリーズスキン", "フリーズスキン", "ゆきふらし" }, GenderRatio.M7F1));
            DexData.Add(new Species(699, -1, "アマルルガ", "", new uint[] { 123, 77, 72, 99, 92, 58 }, (PokeType.Rock, PokeType.Ice), new string[] { "フリーズスキン", "フリーズスキン", "ゆきふらし" }, GenderRatio.M7F1));
            DexData.Add(new Species(702, -1, "デデンネ", "", new uint[] { 67, 58, 57, 81, 67, 101 }, (PokeType.Electric, PokeType.Fairy), new string[] { "ほおぶくろ", "ものひろい", "プラス" }, GenderRatio.M1F1));
            DexData.Add(new Species(703, -1, "メレシー", "", new uint[] { 50, 50, 150, 50, 150, 50 }, (PokeType.Rock, PokeType.Fairy), new string[] { "クリアボディ", "クリアボディ", "がんじょう" }, GenderRatio.Genderless));
            DexData.Add(new Species(707, -1, "クレッフィ", "", new uint[] { 57, 80, 91, 80, 87, 75 }, (PokeType.Steel, PokeType.Fairy), new string[] { "いたずらごころ", "いたずらごころ", "マジシャン" }, GenderRatio.M1F1));
            DexData.Add(new Species(716, -1, "ゼルネアス", "", new uint[] { 126, 131, 95, 131, 98, 99 }, (PokeType.Fairy, PokeType.Non), new string[] { "フェアリーオーラ", "フェアリーオーラ", "フェアリーオーラ" }, GenderRatio.Genderless));
            DexData.Add(new Species(717, -1, "イベルタル", "", new uint[] { 126, 131, 95, 131, 98, 99 }, (PokeType.Dark, PokeType.Flying), new string[] { "ダークオーラ", "ダークオーラ", "ダークオーラ" }, GenderRatio.Genderless));
            DexData.Add(new AnotherForm(718, -1, "ジガルデ", "50%", new uint[] { 108, 100, 121, 81, 95, 95 }, (PokeType.Dragon, PokeType.Ground), new string[] { "オーラブレイク", "オーラブレイク", "スワームチェンジ" }, GenderRatio.Genderless));
            DexData.Add(new AnotherForm(718, -1, "ジガルデ", "10%", new uint[] { 54, 100, 71, 61, 85, 115 }, (PokeType.Dragon, PokeType.Ground), new string[] { "オーラブレイク", "オーラブレイク", "スワームチェンジ" }, GenderRatio.Genderless));
            DexData.Add(new AnotherForm(718, -1, "ジガルデ", "パーフェクト", new uint[] { 216, 100, 121, 91, 95, 85 }, (PokeType.Dragon, PokeType.Ground), new string[] { "スワームチェンジ", "スワームチェンジ", "スワームチェンジ" }, GenderRatio.Genderless));
            DexData.Add(new Species(719, -1, "ディアンシー", "", new uint[] { 50, 100, 150, 100, 150, 50 }, (PokeType.Rock, PokeType.Fairy), new string[] { "クリアボディ", "クリアボディ", "クリアボディ" }, GenderRatio.Genderless));
            DexData.Add(new AnotherForm(720, -1, "フーパ", "戒め", new uint[] { 80, 110, 60, 150, 130, 70 }, (PokeType.Psychic, PokeType.Ghost), new string[] { "マジシャン", "マジシャン", "マジシャン" }, GenderRatio.Genderless));
            DexData.Add(new AnotherForm(720, -1, "フーパ", "解放", new uint[] { 80, 160, 60, 170, 130, 80 }, (PokeType.Psychic, PokeType.Dark), new string[] { "マジシャン", "マジシャン", "マジシャン" }, GenderRatio.Genderless));
            DexData.Add(new Species(721, -1, "ボルケニオン", "", new uint[] { 80, 110, 120, 130, 90, 70 }, (PokeType.Fire, PokeType.Water), new string[] { "ちょすい", "ちょすい", "ちょすい" }, GenderRatio.Genderless));
            DexData.Add(new Species(731, -1, "ツツケラ", "", new uint[] { 35, 75, 30, 30, 30, 65 }, (PokeType.Normal, PokeType.Flying), new string[] { "するどいめ", "スキルリンク", "ものひろい" }, GenderRatio.M1F1));
            DexData.Add(new Species(732, -1, "ケララッパ", "", new uint[] { 55, 85, 50, 40, 50, 75 }, (PokeType.Normal, PokeType.Flying), new string[] { "するどいめ", "スキルリンク", "ものひろい" }, GenderRatio.M1F1));
            DexData.Add(new Species(733, -1, "ドデカバシ", "", new uint[] { 80, 120, 75, 75, 75, 60 }, (PokeType.Normal, PokeType.Flying), new string[] { "するどいめ", "スキルリンク", "ちからずく" }, GenderRatio.M1F1));
            DexData.Add(new Species(734, -1, "ヤングース", "", new uint[] { 48, 70, 30, 30, 30, 45 }, (PokeType.Normal, PokeType.Non), new string[] { "はりこみ", "がんじょうあご", "てきおうりょく" }, GenderRatio.M1F1));
            DexData.Add(new Species(735, -1, "デカグース", "", new uint[] { 88, 110, 60, 55, 60, 45 }, (PokeType.Normal, PokeType.Non), new string[] { "はりこみ", "がんじょうあご", "てきおうりょく" }, GenderRatio.M1F1));
            DexData.Add(new Species(739, -1, "マケンカニ", "", new uint[] { 47, 82, 57, 42, 47, 63 }, (PokeType.Fighting, PokeType.Non), new string[] { "かいりきバサミ", "てつのこぶし", "いかりのつぼ" }, GenderRatio.M1F1));
            DexData.Add(new Species(740, -1, "ケケンカニ", "", new uint[] { 97, 132, 77, 62, 67, 43 }, (PokeType.Fighting, PokeType.Ice), new string[] { "かいりきバサミ", "てつのこぶし", "いかりのつぼ" }, GenderRatio.M1F1));
            DexData.Add(new AnotherForm(741, -1, "オドリドリ", "めらめら", new uint[] { 75, 70, 70, 98, 70, 93 }, (PokeType.Fire, PokeType.Flying), new string[] { "おどりこ", "おどりこ", "おどりこ" }, GenderRatio.M1F3));
            DexData.Add(new AnotherForm(741, -1, "オドリドリ", "ぱちぱち", new uint[] { 75, 70, 70, 98, 70, 93 }, (PokeType.Electric, PokeType.Flying), new string[] { "おどりこ", "おどりこ", "おどりこ" }, GenderRatio.M1F3));
            DexData.Add(new AnotherForm(741, -1, "オドリドリ", "ふらふら", new uint[] { 75, 70, 70, 98, 70, 93 }, (PokeType.Psychic, PokeType.Flying), new string[] { "おどりこ", "おどりこ", "おどりこ" }, GenderRatio.M1F3));
            DexData.Add(new AnotherForm(741, -1, "オドリドリ", "まいまい", new uint[] { 75, 70, 70, 98, 70, 93 }, (PokeType.Ghost, PokeType.Flying), new string[] { "おどりこ", "おどりこ", "おどりこ" }, GenderRatio.M1F3));
            DexData.Add(new Species(744, -1, "イワンコ", "", new uint[] { 45, 65, 40, 30, 40, 60 }, (PokeType.Rock, PokeType.Non), new string[] { "するどいめ", "やるき", "ふくつのこころ" }, GenderRatio.M1F1));
            DexData.Add(new AnotherForm(744, -1, "イワンコ", "夕", new uint[] { 45, 65, 40, 30, 40, 60 }, (PokeType.Rock, PokeType.Non), new string[] { "マイペース", "マイペース", "マイペース" }, GenderRatio.M1F1));
            DexData.Add(new AnotherForm(745, -1, "ルガルガン", "昼", new uint[] { 75, 115, 65, 55, 65, 112 }, (PokeType.Rock, PokeType.Non), new string[] { "するどいめ", "すなかき", "ふくつのこころ" }, GenderRatio.M1F1));
            DexData.Add(new AnotherForm(745, -1, "ルガルガン", "夜", new uint[] { 85, 115, 75, 55, 75, 82 }, (PokeType.Rock, PokeType.Non), new string[] { "するどいめ", "やるき", "ノーガード" }, GenderRatio.M1F1));
            DexData.Add(new AnotherForm(745, -1, "ルガルガン", "夕", new uint[] { 75, 117, 65, 55, 65, 110 }, (PokeType.Rock, PokeType.Non), new string[] { "かたいツメ", "かたいツメ", "かたいツメ" }, GenderRatio.M1F1));
            DexData.Add(new Species(753, -1, "カリキリ", "", new uint[] { 40, 55, 35, 50, 35, 35 }, (PokeType.Grass, PokeType.Non), new string[] { "リーフガード", "リーフガード", "あまのじゃく" }, GenderRatio.M1F1));
            DexData.Add(new Species(754, -1, "ラランテス", "", new uint[] { 70, 105, 90, 80, 90, 45 }, (PokeType.Grass, PokeType.Non), new string[] { "リーフガード", "リーフガード", "あまのじゃく" }, GenderRatio.M1F1));
            DexData.Add(new Species(764, -1, "キュワワー", "", new uint[] { 51, 52, 90, 82, 110, 100 }, (PokeType.Fairy, PokeType.Non), new string[] { "フラワーベール", "ヒーリングシフト", "しぜんかいふく" }, GenderRatio.M1F3));
            DexData.Add(new Species(769, -1, "スナバァ", "", new uint[] { 55, 55, 80, 70, 45, 15 }, (PokeType.Ghost, PokeType.Ground), new string[] { "みずがため", "みずがため", "すながくれ" }, GenderRatio.M1F1));
            DexData.Add(new Species(770, -1, "シロデスナ", "", new uint[] { 85, 75, 110, 100, 75, 35 }, (PokeType.Ghost, PokeType.Ground), new string[] { "みずがため", "みずがため", "すながくれ" }, GenderRatio.M1F1));
            DexData.Add(new AnotherForm(774, -1, "メテノ", "流星", new uint[] { 60, 60, 100, 60, 100, 60 }, (PokeType.Rock, PokeType.Flying), new string[] { "リミットシールド", "リミットシールド", "リミットシールド" }, GenderRatio.Genderless));
            DexData.Add(new AnotherForm(774, -1, "メテノ", "コア", new uint[] { 60, 100, 60, 100, 60, 120 }, (PokeType.Rock, PokeType.Flying), new string[] { "リミットシールド", "リミットシールド", "リミットシールド" }, GenderRatio.Genderless));
            DexData.Add(new Species(775, -1, "ネッコアラ", "", new uint[] { 65, 115, 65, 75, 95, 65 }, (PokeType.Normal, PokeType.Non), new string[] { "ぜったいねむり", "ぜったいねむり", "ぜったいねむり" }, GenderRatio.M1F1));
            DexData.Add(new Species(779, -1, "ハギギシリ", "", new uint[] { 68, 105, 70, 70, 70, 92 }, (PokeType.Water, PokeType.Psychic), new string[] { "ビビッドボディ", "がんじょうあご", "ミラクルスキン" }, GenderRatio.M1F1));
            DexData.Add(new Species(785, -1, "カプ・コケコ", "", new uint[] { 70, 115, 85, 95, 75, 130 }, (PokeType.Electric, PokeType.Fairy), new string[] { "エレキメイカー", "エレキメイカー", "テレパシー" }, GenderRatio.Genderless));
            DexData.Add(new Species(786, -1, "カプ・テテフ", "", new uint[] { 70, 85, 75, 130, 115, 95 }, (PokeType.Psychic, PokeType.Fairy), new string[] { "サイコメイカー", "サイコメイカー", "テレパシー" }, GenderRatio.Genderless));
            DexData.Add(new Species(787, -1, "カプ・ブルル", "", new uint[] { 70, 130, 115, 85, 95, 75 }, (PokeType.Grass, PokeType.Fairy), new string[] { "グラスメイカー", "グラスメイカー", "テレパシー" }, GenderRatio.Genderless));
            DexData.Add(new Species(788, -1, "カプ・レヒレ", "", new uint[] { 70, 75, 115, 95, 130, 85 }, (PokeType.Water, PokeType.Fairy), new string[] { "ミストメイカー", "ミストメイカー", "テレパシー" }, GenderRatio.Genderless));
            DexData.Add(new Species(793, -1, "ウツロイド", "", new uint[] { 109, 53, 47, 127, 131, 103 }, (PokeType.Rock, PokeType.Poison), new string[] { "ビーストブースト", "ビーストブースト", "ビーストブースト" }, GenderRatio.Genderless));
            DexData.Add(new Species(794, -1, "マッシブーン", "", new uint[] { 107, 139, 139, 53, 53, 79 }, (PokeType.Bug, PokeType.Fighting), new string[] { "ビーストブースト", "ビーストブースト", "ビーストブースト" }, GenderRatio.Genderless));
            DexData.Add(new Species(795, -1, "フェローチェ", "", new uint[] { 71, 137, 37, 137, 37, 151 }, (PokeType.Bug, PokeType.Fighting), new string[] { "ビーストブースト", "ビーストブースト", "ビーストブースト" }, GenderRatio.Genderless));
            DexData.Add(new Species(796, -1, "デンジュモク", "", new uint[] { 83, 89, 71, 173, 71, 83 }, (PokeType.Electric, PokeType.Non), new string[] { "ビーストブースト", "ビーストブースト", "ビーストブースト" }, GenderRatio.Genderless));
            DexData.Add(new Species(797, -1, "テッカグヤ", "", new uint[] { 97, 101, 103, 107, 101, 61 }, (PokeType.Steel, PokeType.Flying), new string[] { "ビーストブースト", "ビーストブースト", "ビーストブースト" }, GenderRatio.Genderless));
            DexData.Add(new Species(798, -1, "カミツルギ", "", new uint[] { 59, 181, 131, 59, 31, 109 }, (PokeType.Grass, PokeType.Steel), new string[] { "ビーストブースト", "ビーストブースト", "ビーストブースト" }, GenderRatio.Genderless));
            DexData.Add(new Species(799, -1, "アクジキング", "", new uint[] { 223, 101, 53, 97, 53, 43 }, (PokeType.Dark, PokeType.Dragon), new string[] { "ビーストブースト", "ビーストブースト", "ビーストブースト" }, GenderRatio.Genderless));
            DexData.Add(new Species(801, -1, "マギアナ", "", new uint[] { 80, 95, 115, 130, 115, 65 }, (PokeType.Steel, PokeType.Fairy), new string[] { "ソウルハート", "ソウルハート", "ソウルハート" }, GenderRatio.Genderless));
            DexData.Add(new Species(803, -1, "ベベノム", "", new uint[] { 67, 73, 67, 73, 67, 73 }, (PokeType.Poison, PokeType.Non), new string[] { "ビーストブースト", "ビーストブースト", "ビーストブースト" }, GenderRatio.Genderless));
            DexData.Add(new Species(804, -1, "アーゴヨン", "", new uint[] { 73, 73, 73, 127, 73, 121 }, (PokeType.Poison, PokeType.Dragon), new string[] { "ビーストブースト", "ビーストブースト", "ビーストブースト" }, GenderRatio.Genderless));
            DexData.Add(new Species(805, -1, "ツンデツンデ", "", new uint[] { 61, 131, 211, 53, 101, 13 }, (PokeType.Rock, PokeType.Steel), new string[] { "ビーストブースト", "ビーストブースト", "ビーストブースト" }, GenderRatio.Genderless));
            ...
            DexData.Add(new Species(891, -1, "ダクマ", "", new uint[] { 60, 90, 60, 53, 50, 72 }, (PokeType.Fighting, PokeType.Non), new string[] { "せいしんりょく", "せいしんりょく", "せいしんりょく" }, GenderRatio.M1F1));
            DexData.Add(new AnotherForm(892, -1, "ウーラオス", "いちげき", new uint[] { 100, 130, 100, 63, 60, 97 }, (PokeType.Fighting, PokeType.Dark), new string[] { "ふかしのこぶし", "ふかしのこぶし", "ふかしのこぶし" }, GenderRatio.M1F1));
            DexData.Add(new AnotherForm(892, -1, "ウーラオス", "れんげき", new uint[] { 100, 130, 100, 63, 60, 97 }, (PokeType.Fighting, PokeType.Water), new string[] { "ふかしのこぶし", "ふかしのこぶし", "ふかしのこぶし" }, GenderRatio.M1F1));
