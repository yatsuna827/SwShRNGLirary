...
namespace SwShRNGLibrary
{
    ...
    public class Pokemon
    {
        ...
        public static IReadOnlyList<Species> GetGalarDex()
        {
            return galarDex;
        }
        public static IReadOnlyList<Species> GetArmorDex()
        {
            return armorDex;
        }
        static Pokemon()
        {
            ...
            DexData.Add(new Species(35, 255, -1, -1, "ピッピ", "", new uint[] { 70, 45, 48, 60, 65, 35 }, (PokeType.Fairy, PokeType.Non), new string[] { "メロメロボディ", "マジックガード", "フレンドガード" }, GenderRatio.M1F3));
            DexData.Add(new Species(36, 256, -1, -1, "ピクシー", "", new uint[] { 95, 70, 73, 95, 90, 60 }, (PokeType.Fairy, PokeType.Non), new string[] { "メロメロボディ", "マジックガード", "てんねん" }, GenderRatio.M1F3));
            ...
            DexData.Add(new Species(77, 333, -1, -1, "ポニータ", "", new uint[] { 50, 85, 55, 65, 65, 90 }, (PokeType.Fire, PokeType.Non), new string[] { "にげあし", "もらいび", "ほのおのからだ" }, GenderRatio.M1F1));
            DexData.Add(new AnotherForm(77, 333, -1, -1, "ポニータ", "ガラル", new uint[] { 50, 85, 55, 65, 65, 90 }, (PokeType.Psychic, PokeType.Non), new string[] { "にげあし", "パステルベール", "きけんよち" }, GenderRatio.M1F1));
            DexData.Add(new Species(78, 334, -1, -1, "ギャロップ", "", new uint[] { 65, 100, 70, 80, 80, 105 }, (PokeType.Fire, PokeType.Non), new string[] { "にげあし", "もらいび", "ほのおのからだ" }, GenderRatio.M1F1));
            DexData.Add(new AnotherForm(78, 334, -1, -1, "ギャロップ", "ガラル", new uint[] { 65, 100, 70, 80, 80, 105 }, (PokeType.Psychic, PokeType.Fairy), new string[] { "にげあし", "パステルベール", "きけんよち" }, GenderRatio.M1F1));
            ...
            DexData.Add(new Species(122, 365, -1, -1, "バリヤード", "", new uint[] { 40, 45, 65, 100, 120, 90 }, (PokeType.Psychic, PokeType.Fairy), new string[] { "ぼうおん", "フィルター", "テクニシャン" }, GenderRatio.M1F1));
            DexData.Add(new AnotherForm(122, 365, -1, -1, "バリヤード", "ガラル", new uint[] { 50, 65, 65, 90, 90, 100 }, (PokeType.Ice, PokeType.Psychic), new string[] { "ちどりあし", "バリアフリー", "アイスボディ" }, GenderRatio.M1F1));
            DexData.Add(new Species(129, 144, 42, -1, "コイキング", "", new uint[] { 20, 10, 55, 15, 20, 80 }, (PokeType.Water, PokeType.Non), new string[] { "すいすい", "すいすい", "びびり" }, GenderRatio.M1F1));
            DexData.Add(new Species(130, 145, 43, -1, "ギャラドス", "", new uint[] { 95, 125, 79, 60, 100, 81 }, (PokeType.Water, PokeType.Flying), new string[] { "いかく", "いかく", "じしんかじょう" }, GenderRatio.M1F1));
            DexData.Add(new Species(131, 361, -1, -1, "ラプラス", "", new uint[] { 130, 85, 80, 85, 95, 60 }, (PokeType.Water, PokeType.Ice), new string[] { "ちょすい", "シェルアーマー", "うるおいボディ" }, GenderRatio.M1F1));
            DexData.Add(new AnotherForm(131, 361, -1, -1, "ラプラス", "キョダイ", new uint[] { 130, 85, 80, 85, 95, 60 }, (PokeType.Water, PokeType.Ice), new string[] { "ちょすい", "シェルアーマー", "うるおいボディ" }, GenderRatio.M1F1));
            ...
            DexData.Add(new Species(133, 196, -1, -1, "イーブイ", "", new uint[] { 55, 55, 50, 45, 65, 55 }, (PokeType.Normal, PokeType.Non), new string[] { "にげあし", "てきおうりょく", "きけんよち" }, GenderRatio.M7F1));
            DexData.Add(new AnotherForm(133, 196, -1, -1, "イーブイ", "キョダイ", new uint[] { 55, 55, 50, 45, 65, 55 }, (PokeType.Normal, PokeType.Non), new string[] { "にげあし", "てきおうりょく", "きけんよち" }, GenderRatio.M7F1));
            DexData.Add(new Species(134, 197, -1, -1, "シャワーズ", "", new uint[] { 130, 65, 60, 110, 95, 65 }, (PokeType.Water, PokeType.Non), new string[] { "ちょすい", "ちょすい", "うるおいボディ" }, GenderRatio.M7F1));
            DexData.Add(new Species(135, 198, -1, -1, "サンダース", "", new uint[] { 65, 65, 60, 110, 95, 130 }, (PokeType.Electric, PokeType.Non), new string[] { "ちくでん", "ちくでん", "はやあし" }, GenderRatio.M7F1));
            DexData.Add(new Species(136, 199, -1, -1, "ブースター", "", new uint[] { 65, 130, 60, 95, 110, 65 }, (PokeType.Fire, PokeType.Non), new string[] { "もらいび", "もらいび", "こんじょう" }, GenderRatio.M7F1));
            DexData.Add(new Species(143, 261, -1, -1, "カビゴン", "", new uint[] { 160, 110, 65, 65, 110, 30 }, (PokeType.Normal, PokeType.Non), new string[] { "めんえき", "あついしぼう", "くいしんぼう" }, GenderRatio.M7F1));
            DexData.Add(new AnotherForm(143, 261, -1, -1, "カビゴン", "キョダイ", new uint[] { 160, 110, 65, 65, 110, 30 }, (PokeType.Normal, PokeType.Non), new string[] { "めんえき", "あついしぼう", "くいしんぼう" }, GenderRatio.M7F1));
            ...
            DexData.Add(new Species(173, 254, -1, -1, "ピィ", "", new uint[] { 50, 25, 28, 45, 55, 15 }, (PokeType.Fairy, PokeType.Non), new string[] { "メロメロボディ", "マジックガード", "フレンドガード" }, GenderRatio.M1F3));
            ...
            DexData.Add(new Species(196, 200, -1, -1, "エーフィ", "", new uint[] { 65, 65, 60, 130, 95, 110 }, (PokeType.Psychic, PokeType.Non), new string[] { "シンクロ", "シンクロ", "マジックミラー" }, GenderRatio.M7F1));
            DexData.Add(new Species(197, 201, -1, -1, "ブラッキー", "", new uint[] { 95, 65, 110, 60, 130, 65 }, (PokeType.Dark, PokeType.Non), new string[] { "シンクロ", "シンクロ", "せいしんりょく" }, GenderRatio.M7F1));
            ...
            DexData.Add(new Species(213, 227, -1, -1, "ツボツボ", "", new uint[] { 20, 10, 230, 10, 230, 5 }, (PokeType.Bug, PokeType.Rock), new string[] { "がんじょう", "くいしんぼう", "あまのじゃく" }, GenderRatio.M1F1));
            DexData.Add(new Species(215, 292, -1, -1, "ニューラ", "", new uint[] { 55, 95, 55, 35, 75, 115 }, (PokeType.Dark, PokeType.Ice), new string[] { "せいしんりょく", "するどいめ", "わるいてぐせ" }, GenderRatio.M1F1));
            DexData.Add(new Species(220, 75, -1, -1, "ウリムー", "", new uint[] { 50, 50, 40, 30, 30, 50 }, (PokeType.Ice, PokeType.Ground), new string[] { "どんかん", "ゆきがくれ", "あついしぼう" }, GenderRatio.M1F1));
            DexData.Add(new Species(221, 76, -1, -1, "イノムー", "", new uint[] { 100, 100, 80, 60, 60, 50 }, (PokeType.Ice, PokeType.Ground), new string[] { "どんかん", "ゆきがくれ", "あついしぼう" }, GenderRatio.M1F1));
            ...
            DexData.Add(new Species(225, 78, -1, -1, "デリバード", "", new uint[] { 45, 55, 45, 65, 45, 75 }, (PokeType.Ice, PokeType.Flying), new string[] { "やるき", "はりきり", "ふみん" }, GenderRatio.M1F1));
            ...
            DexData.Add(new Species(246, 383, -1, -1, "ヨーギラス", "", new uint[] { 50, 64, 50, 45, 50, 41 }, (PokeType.Rock, PokeType.Ground), new string[] { "こんじょう", "こんじょう", "すながくれ" }, GenderRatio.M1F1));
            DexData.Add(new Species(247, 384, -1, -1, "サナギラス", "", new uint[] { 70, 84, 70, 65, 70, 51 }, (PokeType.Rock, PokeType.Ground), new string[] { "だっぴ", "だっぴ", "だっぴ" }, GenderRatio.M1F1));
            DexData.Add(new Species(248, 385, -1, -1, "バンギラス", "", new uint[] { 100, 134, 110, 95, 100, 61 }, (PokeType.Rock, PokeType.Dark), new string[] { "すなおこし", "すなおこし", "きんちょうかん" }, GenderRatio.M1F1));
            ...
            DexData.Add(new Species(263, 31, -1, -1, "ジグザグマ", "", new uint[] { 38, 30, 41, 30, 41, 60 }, (PokeType.Normal, PokeType.Non), new string[] { "ものひろい", "くいしんぼう", "はやあし" }, GenderRatio.M1F1));
            DexData.Add(new AnotherForm(263, 31, -1, -1, "ジグザグマ", "ガラル", new uint[] { 38, 30, 41, 30, 41, 60 }, (PokeType.Dark, PokeType.Normal), new string[] { "ものひろい", "くいしんぼう", "はやあし" }, GenderRatio.M1F1));
            DexData.Add(new Species(264, 32, -1, -1, "マッスグマ", "", new uint[] { 78, 70, 61, 50, 61, 100 }, (PokeType.Normal, PokeType.Non), new string[] { "ものひろい", "くいしんぼう", "はやあし" }, GenderRatio.M1F1));
            DexData.Add(new AnotherForm(264, 32, -1, -1, "マッスグマ", "ガラル", new uint[] { 78, 70, 61, 50, 61, 100 }, (PokeType.Dark, PokeType.Normal), new string[] { "ものひろい", "くいしんぼう", "はやあし" }, GenderRatio.M1F1));
            ...
            DexData.Add(new Species(302, 294, -1, -1, "ヤミラミ", "", new uint[] { 50, 75, 75, 65, 65, 50 }, (PokeType.Dark, PokeType.Ghost), new string[] { "するどいめ", "あとだし", "いたずらごころ" }, GenderRatio.M1F1));
            DexData.Add(new Species(303, 295, -1, -1, "クチート", "", new uint[] { 50, 85, 85, 55, 55, 50 }, (PokeType.Steel, PokeType.Fairy), new string[] { "かいりきバサミ", "いかく", "ちからずく" }, GenderRatio.M1F1));
            ...
            DexData.Add(new Species(339, 228, 137, -1, "ドジョッチ", "", new uint[] { 50, 48, 43, 46, 41, 60 }, (PokeType.Water, PokeType.Ground), new string[] { "どんかん", "きけんよち", "うるおいボディ" }, GenderRatio.M1F1));
            DexData.Add(new Species(340, 229, 138, -1, "ナマズン", "", new uint[] { 110, 78, 73, 76, 71, 60 }, (PokeType.Water, PokeType.Ground), new string[] { "どんかん", "きけんよち", "うるおいボディ" }, GenderRatio.M1F1));
            ...
            DexData.Add(new Species(343, 82, -1, -1, "ヤジロン", "", new uint[] { 40, 40, 55, 40, 70, 55 }, (PokeType.Ground, PokeType.Psychic), new string[] { "ふゆう", "ふゆう", "ふゆう" }, GenderRatio.Genderless));
            DexData.Add(new Species(344, 83, -1, -1, "ネンドール", "", new uint[] { 60, 70, 105, 70, 120, 75 }, (PokeType.Ground, PokeType.Psychic), new string[] { "ふゆう", "ふゆう", "ふゆう" }, GenderRatio.Genderless));
            DexData.Add(new Species(349, 152, -1, -1, "ヒンバス", "", new uint[] { 20, 15, 20, 10, 55, 80 }, (PokeType.Water, PokeType.Non), new string[] { "すいすい", "どんかん", "てきおうりょく" }, GenderRatio.M1F1));
            DexData.Add(new Species(350, 153, -1, -1, "ミロカロス", "", new uint[] { 95, 60, 79, 100, 125, 81 }, (PokeType.Water, PokeType.Non), new string[] { "ふしぎなうろこ", "かちき", "メロメロボディ" }, GenderRatio.M1F1));
            ...
            DexData.Add(new Species(361, 79, -1, -1, "ユキワラシ", "", new uint[] { 50, 50, 50, 50, 50, 50 }, (PokeType.Ice, PokeType.Non), new string[] { "せいしんりょく", "アイスボディ", "ムラっけ" }, GenderRatio.M1F1));
            DexData.Add(new Species(362, 80, -1, -1, "オニゴーリ", "", new uint[] { 80, 80, 80, 80, 80, 80 }, (PokeType.Ice, PokeType.Non), new string[] { "せいしんりょく", "アイスボディ", "ムラっけ" }, GenderRatio.M1F1));
            ...
            DexData.Add(new Species(436, 118, -1, -1, "ドーミラー", "", new uint[] { 57, 24, 86, 24, 86, 23 }, (PokeType.Steel, PokeType.Psychic), new string[] { "ふゆう", "たいねつ", "ヘヴィメタル" }, GenderRatio.Genderless));
            DexData.Add(new Species(437, 119, -1, -1, "ドータクン", "", new uint[] { 67, 89, 116, 79, 116, 33 }, (PokeType.Steel, PokeType.Psychic), new string[] { "ふゆう", "たいねつ", "ヘヴィメタル" }, GenderRatio.Genderless));
            ...
            DexData.Add(new Species(439, 364, -1, -1, "マネネ", "", new uint[] { 20, 25, 45, 70, 90, 60 }, (PokeType.Psychic, PokeType.Fairy), new string[] { "ぼうおん", "フィルター", "テクニシャン" }, GenderRatio.M1F1));
            DexData.Add(new Species(446, 260, -1, -1, "ゴンベ", "", new uint[] { 135, 85, 40, 40, 85, 5 }, (PokeType.Normal, PokeType.Non), new string[] { "ものひろい", "あついしぼう", "くいしんぼう" }, GenderRatio.M7F1));
            DexData.Add(new Species(447, 298, -1, -1, "リオル", "", new uint[] { 40, 70, 40, 35, 40, 60 }, (PokeType.Fighting, PokeType.Non), new string[] { "ふくつのこころ", "せいしんりょく", "いたずらごころ" }, GenderRatio.M7F1));
            DexData.Add(new Species(448, 299, -1, -1, "ルカリオ", "", new uint[] { 70, 110, 70, 115, 70, 90 }, (PokeType.Fighting, PokeType.Steel), new string[] { "ふくつのこころ", "せいしんりょく", "せいぎのこころ" }, GenderRatio.M7F1));
            ...
            DexData.Add(new Species(459, 96, -1, -1, "ユキカブリ", "", new uint[] { 60, 62, 50, 62, 60, 40 }, (PokeType.Grass, PokeType.Ice), new string[] { "ゆきふらし", "ゆきふらし", "ぼうおん" }, GenderRatio.M1F1));
            DexData.Add(new Species(460, 97, -1, -1, "ユキノオー", "", new uint[] { 90, 92, 75, 92, 85, 60 }, (PokeType.Grass, PokeType.Ice), new string[] { "ゆきふらし", "ゆきふらし", "ぼうおん" }, GenderRatio.M1F1));
            DexData.Add(new Species(461, 293, -1, -1, "マニューラ", "", new uint[] { 70, 120, 65, 45, 85, 125 }, (PokeType.Dark, PokeType.Ice), new string[] { "プレッシャー", "プレッシャー", "わるいてぐせ" }, GenderRatio.M1F1));
            ...
            DexData.Add(new Species(470, 202, -1, -1, "リーフィア", "", new uint[] { 65, 110, 130, 60, 65, 95 }, (PokeType.Grass, PokeType.Non), new string[] { "リーフガード", "リーフガード", "ようりょくそ" }, GenderRatio.M7F1));
            DexData.Add(new Species(471, 203, -1, -1, "グレイシア", "", new uint[] { 65, 60, 110, 130, 95, 65 }, (PokeType.Ice, PokeType.Non), new string[] { "ゆきがくれ", "ゆきがくれ", "アイスボディ" }, GenderRatio.M7F1));
            DexData.Add(new Species(473, 77, -1, -1, "マンムー", "", new uint[] { 110, 130, 80, 70, 60, 80 }, (PokeType.Ice, PokeType.Ground), new string[] { "どんかん", "ゆきがくれ", "あついしぼう" }, GenderRatio.M1F1));
            ...
            DexData.Add(new Species(478, 81, -1, -1, "ユキメノコ", "", new uint[] { 70, 80, 70, 80, 70, 110 }, (PokeType.Ice, PokeType.Ghost), new string[] { "ゆきがくれ", "ゆきがくれ", "のろわれボディ" }, GenderRatio.FemaleOnly));
            ...
            DexData.Add(new Species(532, 171, -1, -1, "ドッコラー", "", new uint[] { 75, 80, 55, 25, 35, 35 }, (PokeType.Fighting, PokeType.Non), new string[] { "こんじょう", "ちからずく", "てつのこぶし" }, GenderRatio.M3F1));
            DexData.Add(new Species(533, 172, -1, -1, "ドテッコツ", "", new uint[] { 85, 105, 85, 40, 50, 40 }, (PokeType.Fighting, PokeType.Non), new string[] { "こんじょう", "ちからずく", "てつのこぶし" }, GenderRatio.M3F1));
            DexData.Add(new Species(534, 173, -1, -1, "ローブシン", "", new uint[] { 105, 140, 95, 55, 65, 45 }, (PokeType.Fighting, PokeType.Non), new string[] { "こんじょう", "ちからずく", "てつのこぶし" }, GenderRatio.M3F1));
            ...
            DexData.Add(new Species(546, 262, -1, -1, "モンメン", "", new uint[] { 40, 27, 60, 37, 50, 66 }, (PokeType.Grass, PokeType.Fairy), new string[] { "いたずらごころ", "すりぬけ", "ようりょくそ" }, GenderRatio.M1F1));
            DexData.Add(new Species(547, 263, -1, -1, "エルフーン", "", new uint[] { 60, 67, 85, 77, 75, 116 }, (PokeType.Grass, PokeType.Fairy), new string[] { "いたずらごころ", "すりぬけ", "ようりょくそ" }, GenderRatio.M1F1));
            DexData.Add(new AnotherForm(550, 154, -1, -1, "バスラオ", "あか", new uint[] { 70, 92, 65, 80, 55, 98 }, (PokeType.Water, PokeType.Non), new string[] { "すてみ", "てきおうりょく", "かたやぶり" }, GenderRatio.M1F1));
            DexData.Add(new AnotherForm(550, 154, -1, -1, "バスラオ", "あお", new uint[] { 70, 92, 65, 80, 55, 98 }, (PokeType.Water, PokeType.Non), new string[] { "いしあたま", "てきおうりょく", "かたやぶり" }, GenderRatio.M1F1));
            DexData.Add(new Species(554, 367, -1, -1, "ダルマッカ", "", new uint[] { 70, 90, 45, 15, 45, 50 }, (PokeType.Fire, PokeType.Non), new string[] { "はりきり", "はりきり", "せいしんりょく" }, GenderRatio.M1F1));
            DexData.Add(new AnotherForm(554, 367, -1, -1, "ダルマッカ", "ガラル", new uint[] { 70, 90, 45, 15, 45, 50 }, (PokeType.Ice, PokeType.Non), new string[] { "はりきり", "はりきり", "せいしんりょく" }, GenderRatio.M1F1));
            DexData.Add(new Species(555, 368, -1, -1, "ヒヒダルマ", "", new uint[] { 105, 140, 55, 30, 55, 95 }, (PokeType.Fire, PokeType.Non), new string[] { "ちからずく", "ちからずく", "ダルマモード" }, GenderRatio.M1F1));
            DexData.Add(new AnotherForm(555, 368, -1, -1, "ヒヒダルマ", "ダルマ", new uint[] { 105, 30, 105, 140, 105, 55 }, (PokeType.Fire, PokeType.Psychic), new string[] { "ちからずく", "ちからずく", "ダルマモード" }, GenderRatio.M1F1));
            DexData.Add(new AnotherForm(555, 368, -1, -1, "ヒヒダルマ", "ガラル", new uint[] { 105, 140, 55, 30, 55, 95 }, (PokeType.Ice, PokeType.Non), new string[] { "ごりむちゅう", "ごりむちゅう", "ダルマモード" }, GenderRatio.M1F1));
            DexData.Add(new AnotherForm(555, 368, -1, -1, "ヒヒダルマ", "ガラルダルマ", new uint[] { 105, 160, 55, 30, 55, 135 }, (PokeType.Ice, PokeType.Fire), new string[] { "ごりむちゅう", "ごりむちゅう", "ダルマモード" }, GenderRatio.M1F1));
            ...
            DexData.Add(new Species(574, 267, -1, -1, "ゴチム", "", new uint[] { 45, 30, 50, 55, 65, 45 }, (PokeType.Psychic, PokeType.Non), new string[] { "おみとおし", "かちき", "かげふみ" }, GenderRatio.M1F3));
            DexData.Add(new Species(575, 268, -1, -1, "ゴチミル", "", new uint[] { 60, 45, 70, 75, 85, 55 }, (PokeType.Psychic, PokeType.Non), new string[] { "おみとおし", "かちき", "かげふみ" }, GenderRatio.M1F3));
            DexData.Add(new Species(576, 269, -1, -1, "ゴチルゼル", "", new uint[] { 70, 55, 95, 95, 110, 65 }, (PokeType.Psychic, PokeType.Non), new string[] { "おみとおし", "かちき", "かげふみ" }, GenderRatio.M1F3));
            DexData.Add(new Species(577, 270, -1, -1, "ユニラン", "", new uint[] { 45, 30, 40, 105, 50, 20 }, (PokeType.Psychic, PokeType.Non), new string[] { "ぼうじん", "マジックガード", "さいせいりょく" }, GenderRatio.M1F1));
            DexData.Add(new Species(578, 271, -1, -1, "ダブラン", "", new uint[] { 65, 40, 50, 125, 60, 30 }, (PokeType.Psychic, PokeType.Non), new string[] { "ぼうじん", "マジックガード", "さいせいりょく" }, GenderRatio.M1F1));
            DexData.Add(new Species(579, 272, -1, -1, "ランクルス", "", new uint[] { 110, 65, 75, 125, 85, 30 }, (PokeType.Psychic, PokeType.Non), new string[] { "ぼうじん", "マジックガード", "さいせいりょく" }, GenderRatio.M1F1));
            DexData.Add(new Species(582, 72, -1, -1, "バニプッチ", "", new uint[] { 36, 50, 50, 65, 60, 44 }, (PokeType.Ice, PokeType.Non), new string[] { "アイスボディ", "ゆきがくれ", "くだけるよろい" }, GenderRatio.M1F1));
            DexData.Add(new Species(583, 73, -1, -1, "バニリッチ", "", new uint[] { 51, 65, 65, 80, 75, 59 }, (PokeType.Ice, PokeType.Non), new string[] { "アイスボディ", "ゆきがくれ", "くだけるよろい" }, GenderRatio.M1F1));
            DexData.Add(new Species(584, 74, -1, -1, "バイバニラ", "", new uint[] { 71, 95, 85, 110, 95, 79 }, (PokeType.Ice, PokeType.Non), new string[] { "アイスボディ", "ゆきふらし", "くだけるよろい" }, GenderRatio.M1F1));
            DexData.Add(new Species(588, 273, 66, -1, "カブルモ", "", new uint[] { 50, 75, 45, 40, 45, 60 }, (PokeType.Bug, PokeType.Non), new string[] { "むしのしらせ", "だっぴ", "ノーガード" }, GenderRatio.M1F1));
            DexData.Add(new Species(589, 274, 67, -1, "シュバルゴ", "", new uint[] { 70, 135, 105, 60, 105, 20 }, (PokeType.Bug, PokeType.Steel), new string[] { "むしのしらせ", "シェルアーマー", "ぼうじん" }, GenderRatio.M1F1));
            ...
            DexData.Add(new Species(595, 64, -1, -1, "バチュル", "", new uint[] { 50, 47, 50, 57, 50, 65 }, (PokeType.Bug, PokeType.Electric), new string[] { "ふくがん", "きんちょうかん", "むしのしらせ" }, GenderRatio.M1F1));
            DexData.Add(new Species(596, 65, -1, -1, "デンチュラ", "", new uint[] { 70, 77, 60, 97, 60, 108 }, (PokeType.Bug, PokeType.Electric), new string[] { "ふくがん", "きんちょうかん", "むしのしらせ" }, GenderRatio.M1F1));
            DexData.Add(new Species(597, 189, -1, -1, "テッシード", "", new uint[] { 44, 50, 91, 24, 86, 10 }, (PokeType.Grass, PokeType.Steel), new string[] { "てつのトゲ", "てつのトゲ", "てつのトゲ" }, GenderRatio.M1F1));
            DexData.Add(new Species(598, 190, -1, -1, "ナットレイ", "", new uint[] { 74, 94, 131, 54, 116, 20 }, (PokeType.Grass, PokeType.Steel), new string[] { "てつのトゲ", "てつのトゲ", "きけんよち" }, GenderRatio.M1F1));
            ...
            DexData.Add(new Species(607, 287, -1, -1, "ヒトモシ", "", new uint[] { 50, 30, 55, 65, 55, 20 }, (PokeType.Ghost, PokeType.Fire), new string[] { "もらいび", "ほのおのからだ", "すりぬけ" }, GenderRatio.M1F1));
            DexData.Add(new Species(608, 288, -1, -1, "ランプラー", "", new uint[] { 60, 40, 60, 95, 60, 55 }, (PokeType.Ghost, PokeType.Fire), new string[] { "もらいび", "ほのおのからだ", "すりぬけ" }, GenderRatio.M1F1));
            DexData.Add(new Species(609, 289, -1, -1, "シャンデラ", "", new uint[] { 60, 55, 90, 145, 90, 80 }, (PokeType.Ghost, PokeType.Fire), new string[] { "もらいび", "ほのおのからだ", "すりぬけ" }, GenderRatio.M1F1));
            ...
            DexData.Add(new Species(613, 279, -1, -1, "クマシュン", "", new uint[] { 55, 70, 40, 60, 40, 40 }, (PokeType.Ice, PokeType.Non), new string[] { "ゆきがくれ", "ゆきかき", "びびり" }, GenderRatio.M1F1));
            DexData.Add(new Species(614, 280, -1, -1, "ツンベアー", "", new uint[] { 95, 130, 80, 70, 80, 50 }, (PokeType.Ice, PokeType.Non), new string[] { "ゆきがくれ", "ゆきかき", "すいすい" }, GenderRatio.M1F1));
            DexData.Add(new Species(616, 275, 64, -1, "チョボマキ", "", new uint[] { 50, 40, 85, 40, 65, 25 }, (PokeType.Bug, PokeType.Non), new string[] { "うるおいボディ", "シェルアーマー", "ぼうじん" }, GenderRatio.M1F1));
            DexData.Add(new Species(617, 276, 65, -1, "アギルダー", "", new uint[] { 80, 70, 40, 100, 60, 145 }, (PokeType.Bug, PokeType.Non), new string[] { "うるおいボディ", "ねんちゃく", "かるわざ" }, GenderRatio.M1F1));
            ...
            DexData.Add(new Species(622, 88, -1, -1, "ゴビット", "", new uint[] { 59, 74, 50, 35, 50, 35 }, (PokeType.Ground, PokeType.Ghost), new string[] { "てつのこぶし", "ぶきよう", "ノーガード" }, GenderRatio.Genderless));
            DexData.Add(new Species(623, 89, -1, -1, "ゴルーグ", "", new uint[] { 89, 124, 80, 55, 80, 55 }, (PokeType.Ground, PokeType.Ghost), new string[] { "てつのこぶし", "ぶきよう", "ノーガード" }, GenderRatio.Genderless));
            ...
            DexData.Add(new Species(631, 317, -1, -1, "クイタラン", "", new uint[] { 85, 97, 66, 105, 66, 65 }, (PokeType.Fire, PokeType.Non), new string[] { "くいしんぼう", "もらいび", "しろいけむり" }, GenderRatio.M1F1));
            DexData.Add(new Species(632, 316, -1, -1, "アイアント", "", new uint[] { 58, 109, 112, 48, 48, 109 }, (PokeType.Bug, PokeType.Steel), new string[] { "むしのしらせ", "はりきり", "なまけ" }, GenderRatio.M1F1));
            DexData.Add(new Species(633, 386, -1, -1, "モノズ", "", new uint[] { 52, 65, 50, 45, 50, 38 }, (PokeType.Dark, PokeType.Dragon), new string[] { "はりきり", "はりきり", "はりきり" }, GenderRatio.M1F1));
            DexData.Add(new Species(634, 387, -1, -1, "ジヘッド", "", new uint[] { 72, 85, 70, 65, 70, 58 }, (PokeType.Dark, PokeType.Dragon), new string[] { "はりきり", "はりきり", "はりきり" }, GenderRatio.M1F1));
            DexData.Add(new Species(635, 388, -1, -1, "サザンドラ", "", new uint[] { 92, 105, 90, 125, 90, 98 }, (PokeType.Dark, PokeType.Dragon), new string[] { "ふゆう", "ふゆう", "ふゆう" }, GenderRatio.M1F1));
            DexData.Add(new Species(638, -1, -1, -1, "コバルオン", "", new uint[] { 91, 90, 129, 90, 72, 108 }, (PokeType.Steel, PokeType.Fighting), new string[] { "せいぎのこころ", "せいぎのこころ", "せいぎのこころ" }, GenderRatio.Genderless));
            DexData.Add(new Species(639, -1, -1, -1, "テラキオン", "", new uint[] { 91, 129, 90, 72, 90, 108 }, (PokeType.Rock, PokeType.Fighting), new string[] { "せいぎのこころ", "せいぎのこころ", "せいぎのこころ" }, GenderRatio.Genderless));
            DexData.Add(new Species(640, -1, -1, -1, "ビリジオン", "", new uint[] { 91, 90, 72, 90, 129, 108 }, (PokeType.Grass, PokeType.Fighting), new string[] { "せいぎのこころ", "せいぎのこころ", "せいぎのこころ" }, GenderRatio.Genderless));
            ...
            DexData.Add(new Species(700, 204, -1, -1, "ニンフィア", "", new uint[] { 95, 65, 65, 110, 130, 60 }, (PokeType.Fairy, PokeType.Non), new string[] { "メロメロボディ", "メロメロボディ", "フェアリースキン" }, GenderRatio.M7F1));
            ...
            DexData.Add(new Species(708, 338, -1, -1, "ボクレー", "", new uint[] { 43, 70, 48, 50, 60, 38 }, (PokeType.Ghost, PokeType.Grass), new string[] { "しぜんかいふく", "おみとおし", "しゅうかく" }, GenderRatio.M1F1));
            DexData.Add(new Species(709, 339, -1, -1, "オーロット", "", new uint[] { 85, 110, 76, 65, 82, 56 }, (PokeType.Ghost, PokeType.Grass), new string[] { "しぜんかいふく", "おみとおし", "しゅうかく" }, GenderRatio.M1F1));
            ...
            DexData.Add(new Species(712, 358, -1, -1, "カチコール", "", new uint[] { 55, 69, 85, 32, 35, 28 }, (PokeType.Ice, PokeType.Non), new string[] { "マイペース", "アイスボディ", "がんじょう" }, GenderRatio.M1F1));
            DexData.Add(new Species(713, 359, -1, -1, "クレベース", "", new uint[] { 95, 117, 184, 44, 46, 28 }, (PokeType.Ice, PokeType.Non), new string[] { "マイペース", "アイスボディ", "がんじょう" }, GenderRatio.M1F1));
            DexData.Add(new Species(714, 176, -1, -1, "オンバット", "", new uint[] { 40, 30, 35, 45, 40, 55 }, (PokeType.Flying, PokeType.Dragon), new string[] { "おみとおし", "すりぬけ", "テレパシー" }, GenderRatio.M1F1));
            DexData.Add(new Species(715, 177, -1, -1, "オンバーン", "", new uint[] { 85, 70, 80, 97, 80, 123 }, (PokeType.Flying, PokeType.Dragon), new string[] { "おみとおし", "すりぬけ", "テレパシー" }, GenderRatio.M1F1));
            ...
            DexData.Add(new Species(751, 214, -1, -1, "シズクモ", "", new uint[] { 38, 40, 52, 40, 72, 27 }, (PokeType.Water, PokeType.Bug), new string[] { "すいほう", "すいほう", "ちょすい" }, GenderRatio.M1F1));
            DexData.Add(new Species(752, 215, -1, -1, "オニシズクモ", "", new uint[] { 68, 70, 92, 50, 132, 42 }, (PokeType.Water, PokeType.Bug), new string[] { "すいほう", "すいほう", "ちょすい" }, GenderRatio.M1F1));
            ...
            DexData.Add(new Species(778, 301, -1, -1, "ミミッキュ", "", new uint[] { 55, 90, 80, 50, 105, 96 }, (PokeType.Ghost, PokeType.Fairy), new string[] { "ばけのかわ", "ばけのかわ", "ばけのかわ" }, GenderRatio.M1F1));
            ...
            DexData.Add(new Species(781, 360, -1, -1, "ダダリン", "", new uint[] { 70, 131, 100, 86, 90, 40 }, (PokeType.Ghost, PokeType.Grass), new string[] { "はがねつかい", "はがねつかい", "はがねつかい" }, GenderRatio.Genderless));
            ...
            DexData.Add(new Species(819, 24, 9, -1, "ホシガリス", "", new uint[] { 70, 55, 55, 35, 35, 25 }, (PokeType.Normal, PokeType.Non), new string[] { "ほおぶくろ", "ほおぶくろ", "くいしんぼう" }, GenderRatio.M1F1));
            DexData.Add(new Species(820, 25, 10, -1, "ヨクバリス", "", new uint[] { 120, 95, 95, 55, 75, 20 }, (PokeType.Normal, PokeType.Non), new string[] { "ほおぶくろ", "ほおぶくろ", "くいしんぼう" }, GenderRatio.M1F1));
            DexData.Add(new Species(821, 21, -1, -1, "ココガラ", "", new uint[] { 38, 47, 35, 33, 35, 57 }, (PokeType.Flying, PokeType.Non), new string[] { "するどいめ", "きんちょうかん", "はとむね" }, GenderRatio.M1F1));
            DexData.Add(new Species(822, 22, -1, -1, "アオガラス", "", new uint[] { 68, 67, 55, 43, 55, 77 }, (PokeType.Flying, PokeType.Non), new string[] { "するどいめ", "きんちょうかん", "はとむね" }, GenderRatio.M1F1));
            DexData.Add(new Species(823, 23, -1, -1, "アーマーガア", "", new uint[] { 98, 87, 105, 53, 85, 67 }, (PokeType.Flying, PokeType.Steel), new string[] { "プレッシャー", "きんちょうかん", "ミラーアーマー" }, GenderRatio.M1F1));
            DexData.Add(new AnotherForm(823, 23, -1, -1, "アーマーガア", "キョダイ", new uint[] { 98, 87, 105, 53, 85, 67 }, (PokeType.Flying, PokeType.Steel), new string[] { "プレッシャー", "きんちょうかん", "ミラーアーマー" }, GenderRatio.M1F1));
            ...
            DexData.Add(new Species(829, 126, -1, -1, "ヒメンカ", "", new uint[] { 40, 40, 60, 40, 60, 10 }, (PokeType.Grass, PokeType.Non), new string[] { "わたげ", "さいせいりょく", "ほうし" }, GenderRatio.M1F1));
            DexData.Add(new Species(830, 127, -1, -1, "ワタシラガ", "", new uint[] { 60, 50, 90, 80, 120, 60 }, (PokeType.Grass, PokeType.Non), new string[] { "わたげ", "さいせいりょく", "ほうし" }, GenderRatio.M1F1));
            DexData.Add(new Species(831, 34, -1, -1, "ウールー", "", new uint[] { 42, 40, 55, 40, 45, 48 }, (PokeType.Normal, PokeType.Non), new string[] { "もふもふ", "にげあし", "ぼうだん" }, GenderRatio.M1F1));
            DexData.Add(new Species(832, 35, -1, -1, "バイウールー", "", new uint[] { 72, 80, 100, 60, 90, 88 }, (PokeType.Normal, PokeType.Non), new string[] { "もふもふ", "ふくつのこころ", "ぼうだん" }, GenderRatio.M1F1));
            ...
            DexData.Add(new Species(835, 46, -1, -1, "ワンパチ", "", new uint[] { 59, 45, 50, 40, 50, 26 }, (PokeType.Electric, PokeType.Non), new string[] { "たまひろい", "たまひろい", "びびり" }, GenderRatio.M1F1));
            DexData.Add(new Species(836, 47, -1, -1, "パルスワン", "", new uint[] { 69, 90, 60, 90, 60, 121 }, (PokeType.Electric, PokeType.Non), new string[] { "がんじょうあご", "がんじょうあご", "かちき" }, GenderRatio.M1F1));
            DexData.Add(new Species(837, 161, -1, -1, "タンドン", "", new uint[] { 30, 40, 50, 40, 50, 30 }, (PokeType.Rock, PokeType.Non), new string[] { "じょうききかん", "たいねつ", "もらいび" }, GenderRatio.M1F1));
            DexData.Add(new Species(838, 162, -1, -1, "トロッゴン", "", new uint[] { 80, 60, 90, 60, 70, 50 }, (PokeType.Rock, PokeType.Fire), new string[] { "じょうききかん", "ほのおのからだ", "もらいび" }, GenderRatio.M1F1));
            DexData.Add(new Species(839, 163, -1, -1, "セキタンザン", "", new uint[] { 110, 80, 120, 80, 90, 30 }, (PokeType.Rock, PokeType.Fire), new string[] { "じょうききかん", "ほのおのからだ", "もらいび" }, GenderRatio.M1F1));
            DexData.Add(new AnotherForm(839, 163, -1, -1, "セキタンザン", "キョダイ", new uint[] { 110, 80, 120, 80, 90, 30 }, (PokeType.Rock, PokeType.Fire), new string[] { "じょうききかん", "ほのおのからだ", "もらいび" }, GenderRatio.M1F1));
            ...
            DexData.Add(new Species(850, 159, -1, -1, "ヤクデ", "", new uint[] { 50, 65, 45, 50, 50, 45 }, (PokeType.Fire, PokeType.Bug), new string[] { "もらいび", "しろいけむり", "ほのおのからだ" }, GenderRatio.M1F1));
            DexData.Add(new Species(851, 160, -1, -1, "マルヤクデ", "", new uint[] { 100, 115, 65, 90, 90, 65 }, (PokeType.Fire, PokeType.Bug), new string[] { "もらいび", "しろいけむり", "ほのおのからだ" }, GenderRatio.M1F1));
            DexData.Add(new AnotherForm(851, 160, -1, -1, "マルヤクデ", "キョダイ", new uint[] { 100, 115, 65, 90, 90, 65 }, (PokeType.Fire, PokeType.Bug), new string[] { "もらいび", "しろいけむり", "ほのおのからだ" }, GenderRatio.M1F1));
            ...
            DexData.Add(new Species(854, 335, -1, -1, "ヤバチャ", "", new uint[] { 40, 45, 45, 74, 54, 50 }, (PokeType.Ghost, PokeType.Non), new string[] { "くだけるよろい", "くだけるよろい", "のろわれボディ" }, GenderRatio.Genderless));
            DexData.Add(new Species(855, 336, -1, -1, "ポットデス", "", new uint[] { 60, 65, 65, 134, 114, 70 }, (PokeType.Ghost, PokeType.Non), new string[] { "くだけるよろい", "くだけるよろい", "のろわれボディ" }, GenderRatio.Genderless));
            DexData.Add(new Species(856, 241, -1, -1, "ミブリム", "", new uint[] { 42, 30, 45, 56, 53, 39 }, (PokeType.Psychic, PokeType.Non), new string[] { "いやしのこころ", "きけんよち", "マジックミラー" }, GenderRatio.FemaleOnly));
            DexData.Add(new Species(857, 242, -1, -1, "テブリム", "", new uint[] { 57, 40, 65, 86, 73, 49 }, (PokeType.Psychic, PokeType.Non), new string[] { "いやしのこころ", "きけんよち", "マジックミラー" }, GenderRatio.FemaleOnly));
            DexData.Add(new Species(858, 243, -1, -1, "ブリムオン", "", new uint[] { 57, 90, 95, 136, 103, 29 }, (PokeType.Psychic, PokeType.Fairy), new string[] { "いやしのこころ", "きけんよち", "マジックミラー" }, GenderRatio.FemaleOnly));
            DexData.Add(new AnotherForm(858, 243, -1, -1, "ブリムオン", "キョダイ", new uint[] { 57, 90, 95, 136, 103, 29 }, (PokeType.Psychic, PokeType.Fairy), new string[] { "いやしのこころ", "きけんよち", "マジックミラー" }, GenderRatio.FemaleOnly));
            DexData.Add(new Species(859, 238, -1, -1, "ベロバー", "", new uint[] { 45, 45, 30, 55, 40, 50 }, (PokeType.Dark, PokeType.Fairy), new string[] { "いたずらごころ", "おみとおし", "わるいてぐせ" }, GenderRatio.MaleOnly));
            DexData.Add(new Species(860, 239, -1, -1, "ギモー", "", new uint[] { 65, 60, 45, 75, 55, 70 }, (PokeType.Dark, PokeType.Fairy), new string[] { "いたずらごころ", "おみとおし", "わるいてぐせ" }, GenderRatio.MaleOnly));
            DexData.Add(new Species(861, 240, -1, -1, "オーロンゲ", "", new uint[] { 95, 120, 65, 95, 75, 60 }, (PokeType.Dark, PokeType.Fairy), new string[] { "いたずらごころ", "おみとおし", "わるいてぐせ" }, GenderRatio.MaleOnly));
            DexData.Add(new AnotherForm(861, 240, -1, -1, "オーロンゲ", "キョダイ", new uint[] { 95, 120, 65, 95, 75, 60 }, (PokeType.Dark, PokeType.Fairy), new string[] { "いたずらごころ", "おみとおし", "わるいてぐせ" }, GenderRatio.MaleOnly));
            DexData.Add(new Species(862, 33, -1, -1, "タチフサグマ", "", new uint[] { 93, 90, 101, 60, 81, 95 }, (PokeType.Dark, PokeType.Normal), new string[] { "すてみ", "こんじょう", "まけんき" }, GenderRatio.M1F1));
            ...
            DexData.Add(new Species(866, 366, -1, -1, "バリコオル", "", new uint[] { 80, 85, 75, 110, 100, 70 }, (PokeType.Ice, PokeType.Psychic), new string[] { "ちどりあし", "バリアフリー", "アイスボディ" }, GenderRatio.M1F1));
            ...
            DexData.Add(new Species(871, 353, 126, -1, "バチンウニ", "", new uint[] { 48, 101, 95, 91, 85, 15 }, (PokeType.Electric, PokeType.Non), new string[] { "ひらいしん", "ひらいしん", "エレキメイカー" }, GenderRatio.M1F1));
            ...
            DexData.Add(new Species(873, 350, -1, -1, "モスノウ", "", new uint[] { 70, 65, 60, 125, 90, 65 }, (PokeType.Ice, PokeType.Bug), new string[] { "りんぷん", "りんぷん", "こおりのりんぷん" }, GenderRatio.M1F1));
            DexData.Add(new Species(874, 369, -1, -1, "イシヘンジン", "", new uint[] { 100, 125, 135, 20, 20, 70 }, (PokeType.Rock, PokeType.Non), new string[] { "パワースポット", "パワースポット", "パワースポット" }, GenderRatio.M1F1));
            DexData.Add(new Species(875, 370, -1, -1, "コオリッポ", "", new uint[] { 75, 80, 110, 65, 90, 50 }, (PokeType.Ice, PokeType.Non), new string[] { "アイスフェイス", "アイスフェイス", "アイスフェイス" }, GenderRatio.M1F1));
            DexData.Add(new AnotherForm(876, 337, -1, -1, "イエッサン", "♂", new uint[] { 60, 65, 55, 105, 95, 95 }, (PokeType.Psychic, PokeType.Normal), new string[] { "せいしんりょく", "シンクロ", "サイコメイカー" }, GenderRatio.MaleOnly));
            DexData.Add(new AnotherForm(876, 337, -1, -1, "イエッサン", "♀", new uint[] { 70, 55, 65, 95, 105, 85 }, (PokeType.Psychic, PokeType.Normal), new string[] { "マイペース", "シンクロ", "サイコメイカー" }, GenderRatio.FemaleOnly));
            DexData.Add(new Species(877, 344, 104, -1, "モルペコ", "", new uint[] { 58, 95, 58, 70, 58, 97 }, (PokeType.Electric, PokeType.Dark), new string[] { "はらぺこスイッチ", "はらぺこスイッチ", "はらぺこスイッチ" }, GenderRatio.M1F1));
            DexData.Add(new Species(878, 302, -1, -1, "ゾウドウ", "", new uint[] { 72, 80, 49, 40, 49, 40 }, (PokeType.Steel, PokeType.Non), new string[] { "ちからずく", "ちからずく", "ヘヴィメタル" }, GenderRatio.M1F1));
            DexData.Add(new Species(879, 303, -1, -1, "ダイオウドウ", "", new uint[] { 122, 130, 69, 80, 69, 30 }, (PokeType.Steel, PokeType.Non), new string[] { "ちからずく", "ちからずく", "ヘヴィメタル" }, GenderRatio.M1F1));
            DexData.Add(new AnotherForm(879, 303, -1, -1, "ダイオウドウ", "キョダイ", new uint[] { 122, 130, 69, 80, 69, 30 }, (PokeType.Steel, PokeType.Non), new string[] { "ちからずく", "ちからずく", "ヘヴィメタル" }, GenderRatio.M1F1));
            ...
            DexData.Add(new Species(885, 395, -1, -1, "ドラメシヤ", "", new uint[] { 28, 60, 30, 40, 30, 82 }, (PokeType.Dragon, PokeType.Ghost), new string[] { "クリアボディ", "すりぬけ", "のろわれボディ" }, GenderRatio.M1F1));
            DexData.Add(new Species(886, 396, -1, -1, "ドロンチ", "", new uint[] { 68, 80, 50, 60, 50, 102 }, (PokeType.Dragon, PokeType.Ghost), new string[] { "クリアボディ", "すりぬけ", "のろわれボディ" }, GenderRatio.M1F1));
            DexData.Add(new Species(887, 397, -1, -1, "ドラパルト", "", new uint[] { 88, 120, 75, 100, 75, 142 }, (PokeType.Dragon, PokeType.Ghost), new string[] { "クリアボディ", "すりぬけ", "のろわれボディ" }, GenderRatio.M1F1));
            ...
            DexData.Add(new Species(28, -1, -1, 169, "サンドパン", "", new uint[] { 75, 100, 110, 45, 55, 65 }, (PokeType.Ground, PokeType.Non), new string[] { "すながくれ", "すながくれ", "すなかき" }, GenderRatio.M1F1));
            ...
            DexData.Add(new Species(29, -1, -1, -1, "ニドラン♀", "", new uint[] { 55, 47, 52, 40, 40, 41 }, (PokeType.Poison, PokeType.Non), new string[] { "どくのトゲ", "とうそうしん", "はりきり" }, GenderRatio.FemaleOnly));
            DexData.Add(new Species(30, -1, -1, -1, "ニドリーナ", "", new uint[] { 70, 62, 67, 55, 55, 56 }, (PokeType.Poison, PokeType.Non), new string[] { "どくのトゲ", "とうそうしん", "はりきり" }, GenderRatio.FemaleOnly));
            DexData.Add(new Species(31, -1, -1, -1, "ニドクイン", "", new uint[] { 90, 92, 87, 75, 85, 76 }, (PokeType.Poison, PokeType.Ground), new string[] { "どくのトゲ", "とうそうしん", "ちからずく" }, GenderRatio.FemaleOnly));
            DexData.Add(new Species(32, -1, -1, -1, "ニドラン♂", "", new uint[] { 46, 57, 40, 40, 40, 50 }, (PokeType.Poison, PokeType.Non), new string[] { "どくのトゲ", "とうそうしん", "はりきり" }, GenderRatio.MaleOnly));
            DexData.Add(new Species(33, -1, -1, -1, "ニドリーノ", "", new uint[] { 61, 72, 57, 55, 55, 65 }, (PokeType.Poison, PokeType.Non), new string[] { "どくのトゲ", "とうそうしん", "はりきり" }, GenderRatio.MaleOnly));
            DexData.Add(new Species(34, -1, -1, -1, "ニドキング", "", new uint[] { 81, 102, 77, 85, 75, 85 }, (PokeType.Poison, PokeType.Ground), new string[] { "どくのトゲ", "とうそうしん", "ちからずく" }, GenderRatio.MaleOnly));
            ...
            DexData.Add(new Species(41, -1, -1, -1, "ズバット", "", new uint[] { 40, 45, 35, 30, 40, 55 }, (PokeType.Poison, PokeType.Flying), new string[] { "せいしんりょく", "せいしんりょく", "すりぬけ" }, GenderRatio.M1F1));
            DexData.Add(new Species(42, -1, -1, -1, "ゴルバット", "", new uint[] { 75, 80, 70, 65, 75, 90 }, (PokeType.Poison, PokeType.Flying), new string[] { "せいしんりょく", "せいしんりょく", "すりぬけ" }, GenderRatio.M1F1));
            ...
            DexData.Add(new Species(124, -1, -1, -1, "ルージュラ", "", new uint[] { 65, 50, 35, 115, 95, 95 }, (PokeType.Ice, PokeType.Psychic), new string[] { "どんかん", "よちむ", "かんそうはだ" }, GenderRatio.FemaleOnly));
            DexData.Add(new Species(125, -1, -1, -1, "エレブー", "", new uint[] { 65, 83, 57, 95, 85, 105 }, (PokeType.Electric, PokeType.Non), new string[] { "せいでんき", "せいでんき", "やるき" }, GenderRatio.M3F1));
            DexData.Add(new Species(126, -1, -1, -1, "ブーバー", "", new uint[] { 65, 95, 57, 100, 85, 93 }, (PokeType.Fire, PokeType.Non), new string[] { "ほのおのからだ", "ほのおのからだ", "やるき" }, GenderRatio.M3F1));
            ...
            DexData.Add(new Species(138, -1, -1, -1, "オムナイト", "", new uint[] { 35, 40, 100, 90, 55, 35 }, (PokeType.Rock, PokeType.Water), new string[] { "すいすい", "シェルアーマー", "くだけるよろい" }, GenderRatio.M7F1));
            DexData.Add(new Species(139, -1, -1, -1, "オムスター", "", new uint[] { 70, 60, 125, 115, 70, 55 }, (PokeType.Rock, PokeType.Water), new string[] { "すいすい", "シェルアーマー", "くだけるよろい" }, GenderRatio.M7F1));
            DexData.Add(new Species(140, -1, -1, -1, "カブト", "", new uint[] { 30, 80, 90, 55, 45, 55 }, (PokeType.Rock, PokeType.Water), new string[] { "すいすい", "カブトアーマー", "くだけるよろい" }, GenderRatio.M7F1));
            ...
            DexData.Add(new Species(169, -1, -1, -1, "クロバット", "", new uint[] { 85, 90, 80, 70, 80, 130 }, (PokeType.Poison, PokeType.Flying), new string[] { "せいしんりょく", "せいしんりょく", "すりぬけ" }, GenderRatio.M1F1));
            ...
            DexData.Add(new Species(238, -1, -1, -1, "ムチュール", "", new uint[] { 45, 30, 15, 85, 65, 65 }, (PokeType.Ice, PokeType.Psychic), new string[] { "どんかん", "よちむ", "うるおいボディ" }, GenderRatio.FemaleOnly));
            DexData.Add(new Species(239, -1, -1, -1, "エレキッド", "", new uint[] { 45, 63, 37, 65, 55, 95 }, (PokeType.Electric, PokeType.Non), new string[] { "せいでんき", "せいでんき", "やるき" }, GenderRatio.M3F1));
            DexData.Add(new Species(240, -1, -1, -1, "ブビィ", "", new uint[] { 45, 75, 37, 70, 55, 83 }, (PokeType.Fire, PokeType.Non), new string[] { "ほのおのからだ", "ほのおのからだ", "やるき" }, GenderRatio.M3F1));
            ...
            DexData.Add(new Species(304, -1, -1, -1, "ココドラ", "", new uint[] { 50, 70, 100, 40, 40, 30 }, (PokeType.Steel, PokeType.Rock), new string[] { "がんじょう", "いしあたま", "ヘヴィメタル" }, GenderRatio.M1F1));
            DexData.Add(new Species(305, -1, -1, -1, "コドラ", "", new uint[] { 60, 90, 140, 50, 50, 40 }, (PokeType.Steel, PokeType.Rock), new string[] { "がんじょう", "いしあたま", "ヘヴィメタル" }, GenderRatio.M1F1));
            DexData.Add(new Species(306, -1, -1, -1, "ボスゴドラ", "", new uint[] { 70, 110, 180, 60, 60, 50 }, (PokeType.Steel, PokeType.Rock), new string[] { "がんじょう", "いしあたま", "ヘヴィメタル" }, GenderRatio.M1F1));
            ...
            DexData.Add(new Species(333, -1, -1, -1, "チルット", "", new uint[] { 45, 40, 60, 40, 75, 50 }, (PokeType.Normal, PokeType.Flying), new string[] { "しぜんかいふく", "しぜんかいふく", "ノーてんき" }, GenderRatio.M1F1));
            DexData.Add(new Species(334, -1, -1, -1, "チルタリス", "", new uint[] { 75, 70, 90, 70, 105, 80 }, (PokeType.Dragon, PokeType.Flying), new string[] { "しぜんかいふく", "しぜんかいふく", "ノーてんき" }, GenderRatio.M1F1));
            ...
            DexData.Add(new Species(345, -1, -1, -1, "リリーラ", "", new uint[] { 66, 41, 77, 61, 87, 23 }, (PokeType.Rock, PokeType.Grass), new string[] { "きゅうばん", "きゅうばん", "よびみず" }, GenderRatio.M7F1));
            DexData.Add(new Species(346, -1, -1, -1, "ユレイドル", "", new uint[] { 86, 81, 97, 81, 107, 43 }, (PokeType.Rock, PokeType.Grass), new string[] { "きゅうばん", "きゅうばん", "よびみず" }, GenderRatio.M7F1));
            DexData.Add(new Species(347, -1, -1, -1, "アノプス", "", new uint[] { 45, 95, 50, 40, 50, 75 }, (PokeType.Rock, PokeType.Bug), new string[] { "カブトアーマー", "カブトアーマー", "すいすい" }, GenderRatio.M7F1));
            DexData.Add(new Species(348, -1, -1, -1, "アーマルド", "", new uint[] { 75, 125, 100, 70, 80, 45 }, (PokeType.Rock, PokeType.Bug), new string[] { "カブトアーマー", "カブトアーマー", "すいすい" }, GenderRatio.M7F1));
            ...
            DexData.Add(new Species(359, -1, -1, -1, "アブソル", "", new uint[] { 65, 130, 60, 75, 60, 75 }, (PokeType.Dark, PokeType.Non), new string[] { "プレッシャー", "きょううん", "せいぎのこころ" }, GenderRatio.M1F1));
            DexData.Add(new Species(363, -1, -1, -1, "タマザラシ", "", new uint[] { 70, 40, 50, 55, 50, 25 }, (PokeType.Ice, PokeType.Water), new string[] { "あついしぼう", "アイスボディ", "どんかん" }, GenderRatio.M1F1));
            DexData.Add(new Species(364, -1, -1, -1, "トドグラー", "", new uint[] { 90, 60, 70, 75, 70, 45 }, (PokeType.Ice, PokeType.Water), new string[] { "あついしぼう", "アイスボディ", "どんかん" }, GenderRatio.M1F1));
            DexData.Add(new Species(365, -1, -1, -1, "トドゼルガ", "", new uint[] { 110, 80, 90, 95, 90, 65 }, (PokeType.Ice, PokeType.Water), new string[] { "あついしぼう", "アイスボディ", "どんかん" }, GenderRatio.M1F1));
            ...
            DexData.Add(new Species(369, -1, -1, -1, "ジーランス", "", new uint[] { 100, 90, 130, 45, 65, 55 }, (PokeType.Water, PokeType.Rock), new string[] { "すいすい", "いしあたま", "がんじょう" }, GenderRatio.M7F1));
            ...
            DexData.Add(new Species(371, -1, -1, -1, "タツベイ", "", new uint[] { 45, 75, 60, 40, 30, 50 }, (PokeType.Dragon, PokeType.Non), new string[] { "いしあたま", "いしあたま", "ちからずく" }, GenderRatio.M1F1));
            DexData.Add(new Species(372, -1, -1, -1, "コモルー", "", new uint[] { 65, 95, 100, 60, 50, 50 }, (PokeType.Dragon, PokeType.Non), new string[] { "いしあたま", "いしあたま", "ぼうじん" }, GenderRatio.M1F1));
            DexData.Add(new Species(373, -1, -1, -1, "ボーマンダ", "", new uint[] { 95, 135, 80, 110, 80, 100 }, (PokeType.Dragon, PokeType.Flying), new string[] { "いかく", "いかく", "じしんかじょう" }, GenderRatio.M1F1));
            DexData.Add(new Species(374, -1, -1, -1, "ダンバル", "", new uint[] { 40, 55, 80, 35, 60, 30 }, (PokeType.Steel, PokeType.Psychic), new string[] { "クリアボディ", "クリアボディ", "ライトメタル" }, GenderRatio.Genderless));
            DexData.Add(new Species(375, -1, -1, -1, "メタング", "", new uint[] { 60, 75, 100, 55, 80, 50 }, (PokeType.Steel, PokeType.Psychic), new string[] { "クリアボディ", "クリアボディ", "ライトメタル" }, GenderRatio.Genderless));
            DexData.Add(new Species(376, -1, -1, -1, "メタグロス", "", new uint[] { 80, 135, 130, 95, 90, 70 }, (PokeType.Steel, PokeType.Psychic), new string[] { "クリアボディ", "クリアボディ", "ライトメタル" }, GenderRatio.Genderless));
            DexData.Add(new Species(377, -1, -1, -1, "レジロック", "", new uint[] { 80, 100, 200, 50, 100, 50 }, (PokeType.Rock, PokeType.Non), new string[] { "クリアボディ", "クリアボディ", "がんじょう" }, GenderRatio.Genderless));
            DexData.Add(new Species(378, -1, -1, -1, "レジアイス", "", new uint[] { 80, 50, 100, 100, 200, 50 }, (PokeType.Ice, PokeType.Non), new string[] { "クリアボディ", "クリアボディ", "アイスボディ" }, GenderRatio.Genderless));
            DexData.Add(new Species(379, -1, -1, -1, "レジスチル", "", new uint[] { 80, 75, 150, 75, 150, 50 }, (PokeType.Steel, PokeType.Non), new string[] { "クリアボディ", "クリアボディ", "ライトメタル" }, GenderRatio.Genderless));
            ...
            DexData.Add(new Species(442, -1, -1, -1, "ミカルゲ", "", new uint[] { 50, 92, 108, 92, 108, 35 }, (PokeType.Ghost, PokeType.Dark), new string[] { "プレッシャー", "プレッシャー", "すりぬけ" }, GenderRatio.M1F1));
            DexData.Add(new Species(443, -1, -1, -1, "フカマル", "", new uint[] { 58, 70, 45, 40, 45, 42 }, (PokeType.Dragon, PokeType.Ground), new string[] { "すながくれ", "すながくれ", "さめはだ" }, GenderRatio.M1F1));
            DexData.Add(new Species(444, -1, -1, -1, "ガバイト", "", new uint[] { 68, 90, 65, 50, 55, 82 }, (PokeType.Dragon, PokeType.Ground), new string[] { "すながくれ", "すながくれ", "さめはだ" }, GenderRatio.M1F1));
            DexData.Add(new Species(445, -1, -1, -1, "ガブリアス", "", new uint[] { 108, 130, 95, 80, 85, 102 }, (PokeType.Dragon, PokeType.Ground), new string[] { "すながくれ", "すながくれ", "さめはだ" }, GenderRatio.M1F1));
            ...
            DexData.Add(new Species(466, -1, -1, -1, "エレキブル", "", new uint[] { 75, 123, 67, 95, 85, 95 }, (PokeType.Electric, PokeType.Non), new string[] { "でんきエンジン", "でんきエンジン", "やるき" }, GenderRatio.M3F1));
            DexData.Add(new Species(467, -1, -1, -1, "ブーバーン", "", new uint[] { 75, 95, 67, 125, 95, 83 }, (PokeType.Fire, PokeType.Non), new string[] { "ほのおのからだ", "ほのおのからだ", "やるき" }, GenderRatio.M3F1));
            ...
            DexData.Add(new Species(531, -1, -1, -1, "タブンネ", "", new uint[] { 103, 60, 86, 60, 86, 50 }, (PokeType.Normal, PokeType.Non), new string[] { "いやしのこころ", "さいせいりょく", "ぶきよう" }, GenderRatio.M1F1));
            ...
            DexData.Add(new Species(564, -1, -1, -1, "プロトーガ", "", new uint[] { 54, 78, 103, 53, 45, 22 }, (PokeType.Water, PokeType.Rock), new string[] { "ハードロック", "がんじょう", "すいすい" }, GenderRatio.M7F1));
            DexData.Add(new Species(565, -1, -1, -1, "アバゴーラ", "", new uint[] { 74, 108, 133, 83, 65, 32 }, (PokeType.Water, PokeType.Rock), new string[] { "ハードロック", "がんじょう", "すいすい" }, GenderRatio.M7F1));
            DexData.Add(new Species(566, -1, -1, -1, "アーケン", "", new uint[] { 55, 112, 45, 74, 45, 70 }, (PokeType.Rock, PokeType.Flying), new string[] { "よわき", "よわき", "よわき" }, GenderRatio.M7F1));
            DexData.Add(new Species(567, -1, -1, -1, "アーケオス", "", new uint[] { 75, 140, 65, 112, 65, 110 }, (PokeType.Rock, PokeType.Flying), new string[] { "よわき", "よわき", "よわき" }, GenderRatio.M7F1));
            ...
            DexData.Add(new Species(615, -1, -1, -1, "フリージオ", "", new uint[] { 80, 50, 50, 95, 135, 105 }, (PokeType.Ice, PokeType.Non), new string[] { "ふゆう", "ふゆう", "ふゆう" }, GenderRatio.Genderless));
            ...
            DexData.Add(new Species(621, -1, 63, -1, "クリムガン", "", new uint[] { 77, 120, 90, 60, 90, 48 }, (PokeType.Dragon, PokeType.Non), new string[] { "さめはだ", "ちからずく", "かたやぶり" }, GenderRatio.M1F1));
            ...
            DexData.Add(new Species(696, -1, -1, -1, "チゴラス", "", new uint[] { 58, 89, 77, 45, 45, 48 }, (PokeType.Rock, PokeType.Dragon), new string[] { "がんじょうあご", "がんじょうあご", "がんじょう" }, GenderRatio.M7F1));
            DexData.Add(new Species(697, -1, -1, -1, "ガチゴラス", "", new uint[] { 82, 121, 119, 69, 59, 71 }, (PokeType.Rock, PokeType.Dragon), new string[] { "がんじょうあご", "がんじょうあご", "がんじょう" }, GenderRatio.M7F1));
            DexData.Add(new Species(698, -1, -1, -1, "アマルス", "", new uint[] { 77, 59, 50, 67, 63, 46 }, (PokeType.Rock, PokeType.Ice), new string[] { "フリーズスキン", "フリーズスキン", "ゆきふらし" }, GenderRatio.M7F1));
            DexData.Add(new Species(699, -1, -1, -1, "アマルルガ", "", new uint[] { 123, 77, 72, 99, 92, 58 }, (PokeType.Rock, PokeType.Ice), new string[] { "フリーズスキン", "フリーズスキン", "ゆきふらし" }, GenderRatio.M7F1));
            ...
            DexData.Add(new Species(703, -1, -1, -1, "メレシー", "", new uint[] { 50, 50, 150, 50, 150, 50 }, (PokeType.Rock, PokeType.Fairy), new string[] { "クリアボディ", "クリアボディ", "がんじょう" }, GenderRatio.Genderless));
            ...
            DexData.Add(new AnotherForm(898, -1, -1, -1, "バドレックス", "こくばじょう", new uint[] { 100, 85, 80, 165, 100, 150 }, (PokeType.Psychic, PokeType.Ghost), new string[] { "じんばいったい", "じんばいったい", "じんばいったい" }, GenderRatio.Genderless));
