...
namespace SwShRNGLibrary
{
    ...
    public class Pokemon
    {
        ...
        static Pokemon()
        {
            ...
            DexData.Add(new AnotherForm(143, 261, "カビゴン", "キョダイ", new uint[] { 160, 110, 65, 65, 110, 30 }, (PokeType.Normal, PokeType.Non), new string[] { "めんえき", "あついしぼう", "くいしんぼう" }, GenderRatio.M1F1));
