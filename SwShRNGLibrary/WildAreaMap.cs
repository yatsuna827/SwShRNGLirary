        ...
        static WildAreaMap()
        {
            ...
            var eventsA = new RaidBattleSlot[][]
            {
                new RaidBattleSlot[]{
                    ...
                    new EventSlot1("スナヘビ", Rom.Sword).BeForceHiddenAbility(),
                    new EventSlot1("カムカメ", Rom.Sword),
                    new EventSlot1("カムカメ", Rom.Sword).BeForceHiddenAbility(),
                    new EventSlot1("ココガラ", Rom.Shield),
                    new EventSlot1("ココガラ", Rom.Shield).BeForceHiddenAbility(),
                    new EventSlot1("ヤクデ", Rom.Shield),
                    new EventSlot1("ヤクデ", Rom.Shield).BeForceHiddenAbility(),
                },
                new RaidBattleSlot[]{
                    new EventSlot2("バタフリー"),
                    new EventSlot2("バタフリー", "キョダイ"),
                    new EventSlot2("スナヘビ", Rom.Sword),
                    new EventSlot2("スナヘビ", Rom.Sword).BeForceHiddenAbility(),
                    new EventSlot2("カジリガメ", Rom.Sword),
                    new EventSlot2("カジリガメ", Rom.Sword).BeForceHiddenAbility(),
                    new EventSlot2("アオガラス", Rom.Shield),
                    new EventSlot2("アオガラス", Rom.Shield).BeForceHiddenAbility(),
                    new EventSlot2("マルヤクデ", Rom.Shield),
                    new EventSlot2("マルヤクデ", Rom.Shield).BeForceHiddenAbility(),
                },
                new RaidBattleSlot[]{
            ...
            var eventsB = new RaidBattleSlot[][]
            {
                new RaidBattleSlot[]{
                    ...
                    new EventSlot1("バタフリー", "キョダイ"),
                    new EventSlot1("ゴンベ"),
                    new EventSlot1("ゴンベ").BeForceHiddenAbility(),
                    new EventSlot1("スナヘビ", Rom.Sword),
                    new EventSlot1("カムカメ", Rom.Sword),
                    new EventSlot1("ココガラ", Rom.Shield),
                    new EventSlot1("ヤクデ", Rom.Shield),
                ...
                new RaidBattleSlot[]{
                    new EventSlot2("バタフリー", "キョダイ"),
                    new EventSlot2("カビゴン"),
                    new EventSlot2("カビゴン").BeForceHiddenAbility(),
                    new EventSlot2("スナヘビ", Rom.Sword),
                    new EventSlot2("カジリガメ", Rom.Sword),
                    new EventSlot2("カジリガメ", Rom.Sword).BeForceHiddenAbility(),
                    new EventSlot2("アオガラス", Rom.Shield),
            ...
            var eventsF = new RaidBattleSlot[][]
            {
                new RaidBattleSlot[]{
                    new EventSlot1("マホミル"),
                    new EventSlot1("マホミル").BeForceHiddenAbility(),
